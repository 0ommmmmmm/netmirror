...
public class SystemSetting extends ReactContextBaseJavaModule implements ActivityEventListener, LifecycleEventListener {
    ...
    class f implements Runnable {
        ...
        final /* synthetic */ WindowManager.LayoutParams f8415c;

        f(Activity activity, WindowManager.LayoutParams layoutParams) {
            this.f8414b = activity;
            this.f8415c = layoutParams;
        }

        @Override // java.lang.Runnable
        public void run() {
            this.f8414b.getWindow().setAttributes(this.f8415c);
        }
    }
    ...
    */
    ...
    private void switchSetting(p035i2.a aVar) {
        ...
        this.mContext.getCurrentActivity().startActivityForResult(new Intent(aVar.f9533b), aVar.f9534c);
    }
    ...
    public void onActivityResult(Activity activity, int i3, int i4, Intent intent) {
        if (p035i2.a.b(i3) != p035i2.a.UNKNOW) {
    ...
    public void openWriteSetting() {
        this.mContext.getCurrentActivity().startActivity(new Intent(p035i2.a.WRITESETTINGS.f9533b, Uri.parse("package:" + this.mContext.getPackageName())));
    }
    ...
    public void setVolume(float f3, ReadableMap readableMap) {
        ...
        try {
            ...
            audioManager.setStreamVolume(volType, (int) (audioManager.getStreamMaxVolume(volType) * f3), i3);
    ...
    public void switchAirplane() {
        switchSetting(p035i2.a.AIRPLANE);
    }

    @ReactMethod
    public void switchBluetooth() {
        switchSetting(p035i2.a.BLUETOOTH);
    }
    ...
    public void switchLocation() {
        switchSetting(p035i2.a.LOCATION);
    }

    @ReactMethod
    public void switchWifi() {
        switchSetting(p035i2.a.WIFI);
    }
