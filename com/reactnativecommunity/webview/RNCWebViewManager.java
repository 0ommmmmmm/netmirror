...
public class RNCWebViewManager extends ViewGroupManager<r> implements U1.p {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        if (exportedCustomDirectEventTypeConstants == null) {
            exportedCustomDirectEventTypeConstants = p018e1.d.b();
        }
        exportedCustomDirectEventTypeConstants.put("topLoadingStart", p018e1.d.d("registrationName", "onLoadingStart"));
        exportedCustomDirectEventTypeConstants.put("topLoadingFinish", p018e1.d.d("registrationName", "onLoadingFinish"));
        exportedCustomDirectEventTypeConstants.put("topLoadingError", p018e1.d.d("registrationName", "onLoadingError"));
        exportedCustomDirectEventTypeConstants.put("topMessage", p018e1.d.d("registrationName", "onMessage"));
        exportedCustomDirectEventTypeConstants.put("topLoadingProgress", p018e1.d.d("registrationName", "onLoadingProgress"));
        exportedCustomDirectEventTypeConstants.put("topShouldStartLoadWithRequest", p018e1.d.d("registrationName", "onShouldStartLoadWithRequest"));
        exportedCustomDirectEventTypeConstants.put(com.facebook.react.views.scroll.l.b(com.facebook.react.views.scroll.l.SCROLL), p018e1.d.d("registrationName", "onScroll"));
        exportedCustomDirectEventTypeConstants.put("topHttpError", p018e1.d.d("registrationName", "onHttpError"));
        exportedCustomDirectEventTypeConstants.put("topRenderProcessGone", p018e1.d.d("registrationName", "onRenderProcessGone"));
        exportedCustomDirectEventTypeConstants.put("topCustomMenuSelection", p018e1.d.d("registrationName", "onCustomMenuSelection"));
        exportedCustomDirectEventTypeConstants.put("topOpenWindow", p018e1.d.d("registrationName", "onOpenWindow"));
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public void addEventEmitters(B0 b4, r rVar) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.facebook.react.uimanager.ViewManager
    public r createViewInstance(B0 b4) {
        return this.mRNCWebViewManagerImpl.d(b4);
    }
