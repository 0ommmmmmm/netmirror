...
public class o implements ActivityEventListener {
    ...
    protected static final d f8550h = new d();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final ReactApplicationContext f8551b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private DownloadManager.Request f8552c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private ValueCallback f8553d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private ValueCallback f8554e;
    ...
    class a implements B1.g {
        ...
        public boolean onRequestPermissionsResult(int i3, String[] strArr, int[] iArr) {
            ...
            if (iArr.length <= 0 || iArr[0] != 0) {
                Toast.makeText(o.this.f8551b, this.f8558c, 1).show();
            } else if (o.this.f8552c != null) {
                o.this.h(this.f8557b);
            }
            return true;
        }
    }
    ...
    protected static class d {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private double f8566a = 1.0d;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final HashMap f8567b = new HashMap();
        ...
        public synchronized AtomicReference a(Double d4) {
            return (AtomicReference) this.f8567b.get(d4);
        }

        public synchronized p064q.d b() {
            double d4;
            AtomicReference atomicReference;
            d4 = this.f8566a;
            this.f8566a = 1.0d + d4;
            atomicReference = new AtomicReference(a.UNDECIDED);
            this.f8567b.put(Double.valueOf(d4), atomicReference);
            return new p064q.d(Double.valueOf(d4), atomicReference);
        }

        public synchronized void c(Double d4) {
            this.f8567b.remove(d4);
        }
    }

    public o(ReactApplicationContext reactApplicationContext) {
        this.f8551b = reactApplicationContext;
    ...
    private Boolean c(String str) {
        ...
        return Boolean.valueOf(str.isEmpty() || str.toLowerCase().contains(c.IMAGE.f8565b));
    }

    private Boolean d(String[] strArr) {
        String[] strArrI = i(strArr);
        return Boolean.valueOf(g(strArrI, c.DEFAULT.f8565b).booleanValue() || g(strArrI, c.IMAGE.f8565b).booleanValue());
    }
    ...
    private Boolean e(String str) {
        ...
        return Boolean.valueOf(str.isEmpty() || str.toLowerCase().contains(c.VIDEO.f8565b));
    }

    private Boolean f(String[] strArr) {
        String[] strArrI = i(strArr);
        return Boolean.valueOf(g(strArrI, c.DEFAULT.f8565b).booleanValue() || g(strArrI, c.VIDEO.f8565b).booleanValue());
    }
    ...
    private String[] i(String[] strArr) {
        if (w(strArr).booleanValue()) {
            return new String[]{c.DEFAULT.f8565b};
        }
    ...
    private Intent k(String str) {
        String strM = str.isEmpty() ? c.DEFAULT.f8565b : str;
        if (str.matches("\\.\\w+")) {
            strM = m(str.replace(".", ""));
        }
    ...
    private Intent l(String[] strArr, boolean z3) {
        Intent intent = new Intent("android.intent.action.GET_CONTENT");
        intent.addCategory("android.intent.category.OPENABLE");
        intent.setType(c.DEFAULT.f8565b);
    ...
    private B1.f o() {
        ComponentCallbacks2 currentActivity = this.f8551b.getCurrentActivity();
    ...
    public boolean A(String[] strArr, boolean z3, ValueCallback valueCallback, boolean z4) {
        Intent intentR;
        this.f8554e = valueCallback;
        Activity currentActivity = this.f8551b.getCurrentActivity();
    ...
    public void h(String str) {
        try {
            ((DownloadManager) this.f8551b.getSystemService("download")).enqueue(this.f8552c);
            Toast.makeText(this.f8551b, str, 1).show();
    ...
    public File j(c cVar) {
        ...
        sb.append(str2);
        return File.createTempFile(str, str2, this.f8551b.getExternalFilesDir(null));
    }

    public Uri n(File file) {
        String packageName = this.f8551b.getPackageName();
        return androidx.core.content.b.h(this.f8551b, packageName + ".fileprovider", file);
    }

    @Override // com.facebook.react.bridge.ActivityEventListener
    public void onActivityResult(Activity activity, int i3, int i4, Intent intent) {
        if (this.f8554e == null && this.f8553d == null) {
            return;
        }
        File file = this.f8555f;
        boolean z3 = false;
        boolean z4 = file != null && file.length() > 0;
        File file2 = this.f8556g;
        ...
        if (i3 != 1) {
            if (i3 == 3) {
                if (i4 != -1) {
                    this.f8553d.onReceiveValue(null);
                } else if (z4) {
                    this.f8553d.onReceiveValue(n(this.f8555f));
                } else if (z3) {
                    this.f8553d.onReceiveValue(n(this.f8556g));
                } else {
                    this.f8553d.onReceiveValue(intent.getData());
                }
            }
        } else if (i4 != -1) {
            ValueCallback valueCallback = this.f8554e;
            if (valueCallback != null) {
                valueCallback.onReceiveValue(null);
            }
        } else if (z4) {
            this.f8554e.onReceiveValue(new Uri[]{n(this.f8555f)});
        } else if (z3) {
            this.f8554e.onReceiveValue(new Uri[]{n(this.f8556g)});
        } else {
            this.f8554e.onReceiveValue(q(intent, i4));
        }
        File file3 = this.f8555f;
        if (file3 != null && !z4) {
            file3.delete();
        }
        File file4 = this.f8556g;
        if (file4 != null && !z3) {
            file4.delete();
        }
        this.f8554e = null;
    ...
    protected boolean v() {
        Activity currentActivity = this.f8551b.getCurrentActivity();
        try {
            return Arrays.asList(currentActivity.getPackageManager().getPackageInfo(currentActivity.getApplicationContext().getPackageName(), 4096).requestedPermissions).contains("android.permission.CAMERA") && androidx.core.content.a.a(currentActivity, "android.permission.CAMERA") != 0;
    ...
    public void y(boolean z3, double d4) {
        AtomicReference atomicReferenceA = f8550h.a(Double.valueOf(d4));
