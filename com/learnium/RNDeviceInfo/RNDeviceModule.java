...
@p086v1.a(name = RNDeviceModule.NAME)
public class RNDeviceModule extends ReactContextBaseJavaModule {
    ...
    private final p031h2.a deviceIdResolver;
    private final p031h2.b deviceTypeResolver;
    ...
    public RNDeviceModule(ReactApplicationContext reactApplicationContext) {
        ...
        this.deviceTypeResolver = new p031h2.b(reactApplicationContext);
        this.deviceIdResolver = new p031h2.a(reactApplicationContext);
    ...
    public String getDeviceNameSync() {
        ...
        try {
            ...
            if (i3 > 31 || (string2 = Settings.Secure.getString(getReactApplicationContext().getContentResolver(), "bluetooth_name")) == null) {
                return (i3 < 25 || (string = Settings.Global.getString(getReactApplicationContext().getContentResolver(), "device_name")) == null) ? "unknown" : string;
            }
            return string2;
        } catch (Exception unused) {
            return "unknown";
