...
public final class HermesExecutor extends JavaScriptExecutor {
    ...
    public static final class a {
        ...
        public final void b() {
            if (HermesExecutor.f5914b == null) {
                SoLoader.t("hermes");
                SoLoader.t("hermes_executor");
                HermesExecutor.f5914b = p026g1.a.f9424b ? "Debug" : "Release";
            }
        }
    ...
    public HermesExecutor(boolean z3, String str) {
        super(f5913a.initHybridDefaultConfig(z3, str));
