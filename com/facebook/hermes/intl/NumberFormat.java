...
public class NumberFormat {
    ...
    private static String[] f5738v = {"acre", "bit", "byte", "celsius", "centimeter", "day", "degree", "fahrenheit", "fluid-ounce", "foot", "gallon", "gigabit", "gigabyte", "gram", "hectare", "hour", "inch", "kilobit", "kilobyte", "kilogram", "kilometer", "liter", "megabit", "megabyte", "meter", "mile", "mile-scandinavian", "milliliter", "millimeter", "millisecond", "minute", "month", "ounce", "percent", "petabyte", "pound", "second", "stone", "terabit", "terabyte", "week", "yard", "year"};
    ...
    private c.EnumC0091c f5741c = c.EnumC0091c.SYMBOL;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private c.d f5742d = c.d.STANDARD;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private String f5743e = null;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private boolean f5745g = true;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private int f5746h = -1;
    ...
    private int f5749k = -1;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    private int f5750l = -1;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    private c.g f5752n = c.g.AUTO;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private String f5755q = null;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    private c.e f5756r = null;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private B0.b f5758t = null;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    private B0.b f5759u = null;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    private c f5753o = new j();

    public NumberFormat(List<String> list, Map<String, Object> map) throws B0.e {
        a(list, map);
        this.f5753o.g(this.f5758t, this.f5754p ? "" : this.f5755q, this.f5739a, this.f5742d, this.f5756r, this.f5757s).j(this.f5740b, this.f5741c).k(this.f5745g).i(this.f5746h).d(this.f5751m, this.f5749k, this.f5750l).l(this.f5751m, this.f5747i, this.f5748j).h(this.f5752n).f(this.f5743e, this.f5744f);
    }
    ...
    private void a(List list, Map map) throws B0.e {
        ...
        if (B0.d.j(objA)) {
            this.f5754p = true;
            this.f5755q = this.f5753o.c(this.f5758t);
        } else {
            this.f5754p = false;
            this.f5755q = B0.d.h(objA);
        }
        h(map);
        if (this.f5739a == c.h.CURRENCY) {
            double dN = j.n(this.f5740b);
            objP = B0.d.p(dN);
            objP2 = B0.d.p(dN);
        } else {
            objP = B0.d.p(0.0d);
            objP2 = this.f5739a == c.h.PERCENT ? B0.d.p(0.0d) : B0.d.p(3.0d);
        }
        this.f5756r = (c.e) g.d(c.e.class, B0.d.h(g.c(map, "notation", aVar, new String[]{"standard", "scientific", "engineering", "compact"}, "standard")));
        g(map, objP, objP2);
        Object objC2 = g.c(map, "compactDisplay", aVar, new String[]{"short", "long"}, "short");
        if (this.f5756r == c.e.COMPACT) {
            this.f5757s = (c.b) g.d(c.b.class, B0.d.h(objC2));
        }
        this.f5745g = B0.d.e(g.c(map, "useGrouping", g.a.BOOLEAN, B0.d.d(), B0.d.o(true)));
        this.f5752n = (c.g) g.d(c.g.class, B0.d.h(g.c(map, "signDisplay", aVar, new String[]{"auto", "never", "always", "exceptZero"}, "auto")));
    }
    ...
    private boolean c(String str) {
        return Arrays.binarySearch(f5738v, str) >= 0;
    }
    ...
    private void g(Map map, Object obj, Object obj2) throws B0.e {
        ...
        this.f5746h = (int) Math.floor(B0.d.f(objB));
        if (!B0.d.n(objA3) || !B0.d.n(objA4)) {
            this.f5751m = c.f.SIGNIFICANT_DIGITS;
            ...
            this.f5749k = (int) Math.floor(B0.d.f(objA5));
            this.f5750l = (int) Math.floor(B0.d.f(objA6));
            return;
        }
        if (B0.d.n(objA) && B0.d.n(objA2)) {
            c.e eVar = this.f5756r;
            if (eVar == c.e.COMPACT) {
                this.f5751m = c.f.COMPACT_ROUNDING;
                return;
            }
            if (eVar == c.e.ENGINEERING) {
                this.f5751m = c.f.FRACTION_DIGITS;
                this.f5748j = 5;
                return;
            } else {
                this.f5751m = c.f.FRACTION_DIGITS;
                this.f5747i = (int) Math.floor(B0.d.f(obj));
                this.f5748j = (int) Math.floor(B0.d.f(obj2));
                return;
            }
        }
        this.f5751m = c.f.FRACTION_DIGITS;
        ...
        this.f5747i = (int) Math.floor(B0.d.f(objA7));
        this.f5748j = (int) Math.floor(B0.d.f(objA8));
    }

    private void h(Map map) throws B0.e {
        g.a aVar = g.a.STRING;
        this.f5739a = (c.h) g.d(c.h.class, B0.d.h(g.c(map, "style", aVar, new String[]{"decimal", "percent", "currency", "unit"}, "decimal")));
        ...
        c.h hVar = this.f5739a;
        if (hVar == c.h.CURRENCY) {
            this.f5740b = f(B0.d.h(objC));
            this.f5741c = (c.EnumC0091c) g.d(c.EnumC0091c.class, B0.d.h(objC2));
            this.f5742d = (c.d) g.d(c.d.class, B0.d.h(objC3));
        } else if (hVar == c.h.UNIT) {
            this.f5743e = B0.d.h(objC4);
            this.f5744f = (c.i) g.d(c.i.class, B0.d.h(objC5));
        }
    }
    ...
    public String format(double d4) {
        return this.f5753o.b(d4);
    }

    public List<Map<String, String>> formatToParts(double d4) {
        ArrayList arrayList = new ArrayList();
        AttributedCharacterIterator attributedCharacterIteratorA = this.f5753o.a(d4);
        ...
        for (char cFirst = attributedCharacterIteratorA.first(); cFirst != 65535; cFirst = attributedCharacterIteratorA.next()) {
            ...
            if (attributedCharacterIteratorA.getIndex() + 1 == attributedCharacterIteratorA.getRunLimit()) {
                ...
                String strE = it.hasNext() ? this.f5753o.e(it.next(), d4) : "literal";
    ...
    public Map<String, Object> resolvedOptions() {
        ...
        linkedHashMap.put("locale", this.f5759u.a());
        linkedHashMap.put("numberingSystem", this.f5755q);
        linkedHashMap.put("style", this.f5739a.toString());
        c.h hVar = this.f5739a;
        if (hVar == c.h.CURRENCY) {
            linkedHashMap.put("currency", this.f5740b);
            linkedHashMap.put("currencyDisplay", this.f5741c.toString());
            linkedHashMap.put("currencySign", this.f5742d.toString());
        } else if (hVar == c.h.UNIT) {
            linkedHashMap.put("unit", this.f5743e);
            linkedHashMap.put("unitDisplay", this.f5744f.toString());
        }
        int i3 = this.f5746h;
        if (i3 != -1) {
            linkedHashMap.put("minimumIntegerDigits", Integer.valueOf(i3));
        }
        c.f fVar = this.f5751m;
        ...
        linkedHashMap.put("useGrouping", Boolean.valueOf(this.f5745g));
        linkedHashMap.put("notation", this.f5756r.toString());
        if (this.f5756r == c.e.COMPACT) {
            linkedHashMap.put("compactDisplay", this.f5757s.toString());
        }
        linkedHashMap.put("signDisplay", this.f5752n.toString());
