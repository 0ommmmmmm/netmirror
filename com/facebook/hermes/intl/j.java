...
public class j implements c {
    ...
    private Format f5907a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private android.icu.text.NumberFormat f5908b;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f5912a[c.g.ALWAYS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f5912a[c.g.EXCEPTZERO.ordinal()] = 3;
    ...
    private void o(android.icu.text.NumberFormat numberFormat, B0.b bVar, c.h hVar) {
        this.f5908b = numberFormat;
        this.f5907a = numberFormat;
        this.f5909c = (B0.g) bVar;
        this.f5910d = hVar;
    ...
    public AttributedCharacterIterator a(double d4) {
        try {
            try {
                Format format = this.f5907a;
                return (!(format instanceof MeasureFormat) || this.f5911e == null) ? format.formatToCharacterIterator(Double.valueOf(d4)) : format.formatToCharacterIterator(new Measure(Double.valueOf(d4), this.f5911e));
    ...
    public String b(double d4) {
        try {
            try {
                Format format = this.f5907a;
                return (!(format instanceof MeasureFormat) || this.f5911e == null) ? format.format(Double.valueOf(d4)) : format.format(new Measure(Double.valueOf(d4), this.f5911e));
    ...
    public String e(AttributedCharacterIterator.Attribute attribute, double d4) {
        if (attribute == android.icu.text.NumberFormat.Field.SIGN) {
            return Double.compare(d4, 0.0d) >= 0 ? "plusSign" : "minusSign";
        }
        if (attribute == android.icu.text.NumberFormat.Field.INTEGER) {
            if (Double.isNaN(d4)) {
                return "nan";
            }
            return Double.isInfinite(d4) ? "infinity" : "integer";
        }
    ...
    public j j(String str, c.EnumC0091c enumC0091c) {
        if (this.f5910d == c.h.CURRENCY) {
            Currency currency = Currency.getInstance(str);
            this.f5908b.setCurrency(currency);
            if (enumC0091c != c.EnumC0091c.CODE) {
                str = currency.getName(this.f5909c.h(), enumC0091c.b(), (boolean[]) null);
            }
            android.icu.text.NumberFormat numberFormat = this.f5908b;
    ...
    public j l(c.f fVar, int i3, int i4) {
        if (fVar == c.f.FRACTION_DIGITS) {
            if (i3 >= 0) {
                this.f5908b.setMinimumFractionDigits(i3);
            }
            if (i4 >= 0) {
                this.f5908b.setMaximumFractionDigits(i4);
            }
            android.icu.text.NumberFormat numberFormat = this.f5908b;
            if (numberFormat instanceof DecimalFormat) {
    ...
    public j k(boolean z3) {
        this.f5908b.setGroupingUsed(z3);
        return this;
    }
    ...
    public j i(int i3) {
        if (i3 != -1) {
            this.f5908b.setMinimumIntegerDigits(i3);
        }
        return this;
    }
    ...
    public j f(String str, c.i iVar) {
        if (this.f5910d == c.h.UNIT) {
            this.f5911e = p(str);
            this.f5907a = MeasureFormat.getInstance(this.f5909c.h(), iVar.b(), this.f5908b);
        }
        return this;
    }
}
