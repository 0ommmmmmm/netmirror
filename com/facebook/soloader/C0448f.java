...
public class C0448f extends E {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    protected final File f8230a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    protected int f8231b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    protected final List f8232c;

    public C0448f(File file, int i3) {
    ...
    public int d(String str, int i3, StrictMode.ThreadPolicy threadPolicy) {
        return g(str, i3, this.f8230a, threadPolicy);
    }

    public File f(String str) {
        File file = new File(this.f8230a, str);
        if (file.exists()) {
            return file;
        }
        return null;
    ...
    protected int g(String str, int i3, File file, StrictMode.ThreadPolicy threadPolicy) throws IOException {
        ...
        try {
            SoLoader.f8205b.a(canonicalPath, i3);
            return 1;
    ...
    public String toString() {
        ...
        return c() + "[root = " + name + " flags = " + this.f8231b + ']';
    }

    public C0448f(File file, int i3, String[] strArr) {
        this.f8230a = file;
        this.f8231b = i3;
        this.f8232c = Arrays.asList(strArr);
    }
}
