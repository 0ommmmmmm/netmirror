...
public class C0446d extends E implements w {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final Map f8224a = new HashMap();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final Map f8225b = new HashMap();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final Set f8226c;

    public C0446d(Context context) {
        this.f8226c = l(context);
    }
    ...
    private void f(String str, String str2, String str3) {
        synchronized (this.f8225b) {
            try {
                ...
                if (!this.f8225b.containsKey(str4)) {
                    this.f8225b.put(str4, new HashSet());
                }
                ((Set) this.f8225b.get(str4)).add(str3);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    private void g(String str, String str2) {
        synchronized (this.f8224a) {
            try {
                if (!this.f8224a.containsKey(str)) {
                    this.f8224a.put(str, new HashSet());
                }
                ((Set) this.f8224a.get(str)).add(str2);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    private Set k(String str, String str2) {
        Set set;
        synchronized (this.f8225b) {
            set = (Set) this.f8225b.get(str + str2);
        }
        return set;
    }
    ...
    public int d(String str, int i3, StrictMode.ThreadPolicy threadPolicy) throws IOException {
        if (SoLoader.f8205b == null) {
            throw new IllegalStateException("SoLoader.init() not yet called");
        }
        for (String str2 : this.f8226c) {
            Set set = (Set) this.f8224a.get(str2);
            if (TextUtils.isEmpty(str2) || set == null || !set.contains(str)) {
                ...
                try {
                    i3 |= 4;
                    SoLoader.f8205b.a(str2 + File.separator + str, i3);
    ...
    public boolean o() {
        return !this.f8226c.isEmpty();
    }

    @Override // com.facebook.soloader.E
    public String toString() {
        return c() + "[root = " + this.f8226c.toString() + ']';
    }

    public C0446d(Set<String> set) {
        this.f8226c = set;
    }
}
