...
public final class i {
    ...
    public static final class a {
        ...
        private final void d(b bVar, Object obj, ReadableArray readableArray) {
            bVar.scrollTo(obj, new c(Math.round(C0392f0.g(readableArray.getDouble(0))), Math.round(C0392f0.g(readableArray.getDouble(1))), readableArray.getBoolean(2)));
        }
