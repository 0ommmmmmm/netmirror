...
@p086v1.a(name = ReactHorizontalScrollViewManager.REACT_CLASS)
public class ReactHorizontalScrollViewManager extends ViewGroupManager<f> implements i.b {
    ...
    public void setBorderRadius(f fVar, int i3, float f3) {
        C0381a.q(fVar, R1.d.values()[i3], Float.isNaN(f3) ? null : new W(f3, X.POINT));
    }

    @L1.a(name = "borderStyle")
    public void setBorderStyle(f fVar, String str) {
        C0381a.r(fVar, str == null ? null : R1.f.b(str));
    }
    ...
    public void setBorderWidth(f fVar, int i3, float f3) {
        C0381a.s(fVar, n.values()[i3], Float.valueOf(f3));
    }
    ...
    public void setContentOffset(f fVar, ReadableMap readableMap) {
        if (readableMap != null) {
            fVar.scrollTo((int) C0392f0.g(readableMap.hasKey("x") ? readableMap.getDouble("x") : 0.0d), (int) C0392f0.g(readableMap.hasKey("y") ? readableMap.getDouble("y") : 0.0d));
        } else {
            fVar.scrollTo(0, 0);
        }
    }
    ...
    public void setPointerEvents(f fVar, String str) {
        fVar.setPointerEvents(EnumC0394g0.d(str));
    }
    ...
    public void setSnapToInterval(f fVar, float f3) {
        fVar.setSnapInterval((int) (f3 * C0392f0.c()));
    }
    ...
    public f createViewInstance(B0 b4) {
        return new f(b4, null);
    }
    ...
    public void scrollTo(f fVar, i.c cVar) {
        fVar.o();
        if (cVar.f7857c) {
            fVar.f(cVar.f7855a, cVar.f7856b);
        } else {
            fVar.scrollTo(cVar.f7855a, cVar.f7856b);
        }
    }
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public Object updateState(f fVar, C0417s0 c0417s0, A0 a4) {
        fVar.setStateWrapper(a4);
        return null;
    }
