...
public final class j {
    ...
    private static final boolean f7861c = false;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static boolean f7865g;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final j f7859a = new j();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final String f7860b = com.facebook.react.views.scroll.g.class.getSimpleName();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final CopyOnWriteArrayList f7862d = new CopyOnWriteArrayList();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final CopyOnWriteArrayList f7863e = new CopyOnWriteArrayList();

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static int f7864f = 250;
    ...
    public static final class g {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final Point f7867a = new Point();

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private final Point f7869c = new Point(-1, -1);

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        private boolean f7871e = true;

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        private float f7872f = 0.985f;
    ...
    public static final class i implements Animator.AnimatorListener {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ ViewGroup f7874a;

        i(ViewGroup viewGroup) {
            this.f7874a = viewGroup;
        }

        @Override // android.animation.Animator.AnimatorListener
        public void onAnimationCancel(Animator animator) {
            D2.h.f(animator, "animator");
            ((c) this.f7874a).getReactScrollViewScrollState().g(true);
        }

        @Override // android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            D2.h.f(animator, "animator");
            ((c) this.f7874a).getReactScrollViewScrollState().j(true);
            j.s(this.f7874a);
        }
        ...
        public void onAnimationStart(Animator animator) {
            D2.h.f(animator, "animator");
            g reactScrollViewScrollState = ((c) this.f7874a).getReactScrollViewScrollState();
    ...
    private final void h(ViewGroup viewGroup, l lVar, float f3, float f4) {
        ...
        Iterator it = AbstractC0492n.e0(f7862d).iterator();
        while (it.hasNext()) {
            androidx.activity.result.d.a(((WeakReference) it.next()).get());
        }
        ...
        if (eventDispatcherC != null) {
            eventDispatcherC.b(k.f7875r.a(iE, viewGroup.getId(), lVar, viewGroup.getScrollX(), viewGroup.getScrollY(), f3, f4, childAt.getWidth(), childAt.getHeight(), viewGroup.getWidth(), viewGroup.getHeight()));
            if (lVar == l.SCROLL) {
    ...
    public static final void i(ViewGroup viewGroup, int i3, int i4) {
        f7859a.h(viewGroup, l.MOMENTUM_BEGIN, i3, i4);
    }

    public static final void j(ViewGroup viewGroup) {
        f7859a.g(viewGroup, l.MOMENTUM_END);
    }
    ...
    public static final void k(ViewGroup viewGroup) {
        ...
        int i4 = pointC.y;
        if (f7861c) {
            Y.a.u(f7860b, "updateFabricScrollState[%d] scrollX %d scrollY %d", Integer.valueOf(viewGroup.getId()), Integer.valueOf(i3), Integer.valueOf(i4));
        }
        A0 stateWrapper = ((e) viewGroup).getStateWrapper();
        if (stateWrapper != null) {
            WritableNativeMap writableNativeMap = new WritableNativeMap();
            writableNativeMap.putDouble("contentOffsetLeft", C0392f0.f(i3));
            writableNativeMap.putDouble("contentOffsetTop", C0392f0.f(i4));
            writableNativeMap.putDouble("scrollAwayPaddingTop", C0392f0.f(iD));
    ...
    public static final void r(ViewGroup viewGroup, int i3, int i4) {
        if (f7861c) {
            Y.a.u(f7860b, "smoothScrollTo[%d] x %d y %d", Integer.valueOf(viewGroup.getId()), Integer.valueOf(i3), Integer.valueOf(i4));
        }
        a aVar = (a) viewGroup;
    ...
    public static final void s(ViewGroup viewGroup) {
        f7859a.t(viewGroup, viewGroup.getScrollX(), viewGroup.getScrollY());
    }
