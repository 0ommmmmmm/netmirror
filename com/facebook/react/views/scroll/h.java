...
public final class h extends C0230a {
    ...
    private final void n(View view, AccessibilityEvent accessibilityEvent) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            Object tag2 = childAt2.getTag(AbstractC0462m.f9231c);
    ...
    private final void o(View view, v vVar) {
        ...
        if (dVarD != null) {
            C0396h0.h0(vVar, dVarD, view.getContext());
        }
        Object tag = view.getTag(AbstractC0462m.f9230b);
        ReadableMap readableMap = tag instanceof ReadableMap ? (ReadableMap) tag : null;
        if (readableMap != null) {
    ...
    public void f(View view, AccessibilityEvent accessibilityEvent) {
        ...
        ReactSoftExceptionLogger.logSoftException(this.f7853d, new AssertionException("ReactScrollViewAccessibilityDelegate should only be used with ReactAccessibleScrollView, not with class: " + view.getClass().getSimpleName()));
    }
