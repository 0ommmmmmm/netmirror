...
@p086v1.a(name = ReactScrollViewManager.REACT_CLASS)
public class ReactScrollViewManager extends ViewGroupManager<g> implements i.b {
    ...
    public static Map<String, Object> createExportedCustomDirectEventTypeConstants() {
        return p018e1.d.a().b(l.b(l.SCROLL), p018e1.d.d("registrationName", "onScroll")).b(l.b(l.BEGIN_DRAG), p018e1.d.d("registrationName", "onScrollBeginDrag")).b(l.b(l.END_DRAG), p018e1.d.d("registrationName", "onScrollEndDrag")).b(l.b(l.MOMENTUM_BEGIN), p018e1.d.d("registrationName", "onMomentumScrollBegin")).b(l.b(l.MOMENTUM_END), p018e1.d.d("registrationName", "onMomentumScrollEnd")).a();
    }
    ...
    public void setBorderRadius(g gVar, int i3, float f3) {
        C0381a.q(gVar, R1.d.values()[i3], Float.isNaN(f3) ? null : new W(f3, X.POINT));
    }

    @L1.a(name = "borderStyle")
    public void setBorderStyle(g gVar, String str) {
        C0381a.r(gVar, str == null ? null : R1.f.b(str));
    }
    ...
    public void setBorderWidth(g gVar, int i3, float f3) {
        C0381a.s(gVar, n.values()[i3], Float.valueOf(f3));
    }
    ...
    public void setPointerEvents(g gVar, String str) {
        gVar.setPointerEvents(EnumC0394g0.d(str));
    }
    ...
    public void setSnapToInterval(g gVar, float f3) {
        gVar.setSnapInterval((int) (f3 * C0392f0.c()));
    }
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public g createViewInstance(B0 b4) {
        return new g(b4, null);
    }
    ...
    public void scrollTo(g gVar, i.c cVar) {
        gVar.o();
        if (cVar.f7857c) {
            gVar.f(cVar.f7855a, cVar.f7856b);
        } else {
            gVar.scrollTo(cVar.f7855a, cVar.f7856b);
        }
    }
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public Object updateState(g gVar, C0417s0 c0417s0, A0 a4) {
        gVar.setStateWrapper(a4);
        return null;
    }
