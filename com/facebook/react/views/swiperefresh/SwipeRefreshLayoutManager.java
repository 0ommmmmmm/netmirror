...
@p086v1.a(name = SwipeRefreshLayoutManager.REACT_CLASS)
public class SwipeRefreshLayoutManager extends ViewGroupManager<com.facebook.react.views.swiperefresh.a> implements h {
    ...
    public static final void addEventEmitters$lambda$0(B0 b4, com.facebook.react.views.swiperefresh.a aVar) {
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public void addEventEmitters(final B0 b4, final com.facebook.react.views.swiperefresh.a aVar) {
        D2.h.f(b4, "reactContext");
        D2.h.f(aVar, "view");
        aVar.setOnRefreshListener(new androidx.swiperefreshlayout.widget.c.j() { // from class: com.facebook.react.views.swiperefresh.c
            @Override // androidx.swiperefreshlayout.widget.c.j
            public final void a() {
                SwipeRefreshLayoutManager.addEventEmitters$lambda$0(b4, aVar);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.facebook.react.uimanager.ViewManager
    public com.facebook.react.views.swiperefresh.a createViewInstance(B0 b4) {
        D2.h.f(b4, "reactContext");
        return new com.facebook.react.views.swiperefresh.a(b4);
    }
