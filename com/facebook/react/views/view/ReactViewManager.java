...
@p086v1.a(name = ReactViewManager.REACT_CLASS)
public class ReactViewManager extends ReactClippingViewManager<g> {
    ...
    private final void handleHotspotUpdate(g gVar, ReadableArray readableArray) {
        ...
        gVar.drawableHotspotChanged(c0392f0.a(readableArray.getDouble(0)), c0392f0.a(readableArray.getDouble(1)));
    }
    ...
    private final int px(ReadableMap readableMap, String str) {
        if (readableMap.hasKey(str)) {
            return (int) C0392f0.f7477a.a(readableMap.getDouble(str));
        }
        return 0;
    }
    ...
    public Map<String, Integer> getCommandsMap() {
        return D.i(p071r2.n.a(HOTSPOT_UPDATE_KEY, 1), p071r2.n.a("setPressed", 2));
    }
    ...
    public void setBorderColor(g gVar, int i3, Integer num) {
        D2.h.f(gVar, "view");
        C0381a.p(gVar, R1.n.f2074b.a(SPACING_TYPES[i3]), num);
    }
    ...
    public void setBorderRadius(g gVar, int i3, Dynamic dynamic) {
        ...
        W wA = W.f7405c.a(dynamic);
        if (M1.a.c(gVar) != 2 && wA != null && wA.a() == X.PERCENT) {
            wA = null;
        }
        C0381a.q(gVar, R1.d.values()[i3], wA);
    }

    @L1.a(name = "borderStyle")
    public void setBorderStyle(g gVar, String str) {
        D2.h.f(gVar, "view");
        C0381a.r(gVar, str == null ? null : R1.f.f2028b.a(str));
    }
    ...
    public void setBorderWidth(g gVar, int i3, float f3) {
        D2.h.f(gVar, "view");
        C0381a.s(gVar, R1.n.values()[i3], Float.valueOf(f3));
    }
    ...
    public void setHitSlop(g gVar, Dynamic dynamic) {
        ...
        int i3 = b.f8160a[dynamic.getType().ordinal()];
        if (i3 == 1) {
        ...
        if (i3 == 2) {
            int iA = (int) C0392f0.f7477a.a(dynamic.asDouble());
    ...
    public void setPointerEvents(g gVar, String str) {
        D2.h.f(gVar, "view");
        gVar.setPointerEvents(EnumC0394g0.f7479b.c(str));
    }
    ...
    public g prepareToRecycleView(B0 b4, g gVar) {
        D2.h.f(b4, "reactContext");
        D2.h.f(gVar, "view");
        g gVar2 = (g) super.prepareToRecycleView(b4, gVar);
        if (gVar2 != null) {
            gVar2.s();
        }
        return gVar;
