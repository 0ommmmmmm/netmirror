...
public final class f {
    ...
    private static final TypedValue f8169b = new TypedValue();
    ...
    public static final Drawable a(Context context, ReadableMap readableMap) {
        ...
        if (context.getTheme().resolveAttribute(iB, f8169b, true)) {
    ...
    private final int b(Context context, String str) {
        if (D2.h.b("selectableItemBackground", str)) {
            return R.attr.selectableItemBackground;
        }
        return D2.h.b("selectableItemBackgroundBorderless", str) ? R.attr.selectableItemBackgroundBorderless : context.getResources().getIdentifier(str, "attr", "android");
    }
    ...
    private final Drawable d(Context context) {
        return context.getResources().getDrawable(f8169b.resourceId, context.getTheme());
    }
    ...
    private final Drawable g(ReadableMap readableMap, Drawable drawable) {
        if (readableMap.hasKey("rippleRadius") && (drawable instanceof RippleDrawable)) {
            ((RippleDrawable) drawable).setRadius((int) C0392f0.g(readableMap.getDouble("rippleRadius")));
        }
        return drawable;
    }
}
