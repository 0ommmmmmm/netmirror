...
@p086v1.a(name = ReactDrawerLayoutManager.REACT_CLASS)
public final class ReactDrawerLayoutManager extends ViewGroupManager<com.facebook.react.views.drawer.a> implements d {
    ...
    public static final class b implements y.a.d {
        ...
        private final p096y.a f7658a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final EventDispatcher f7659b;

        public b(p096y.a aVar, EventDispatcher eventDispatcher) {
            h.f(aVar, "drawerLayout");
            h.f(eventDispatcher, "eventDispatcher");
            this.f7658a = aVar;
            this.f7659b = eventDispatcher;
        }

        @Override // y.a.d
        public void a(int i3) {
            this.f7659b.b(new W1.d(H0.f(this.f7658a), this.f7658a.getId(), i3));
        }

        @Override // y.a.d
        public void b(View view, float f3) {
            h.f(view, "view");
            this.f7659b.b(new W1.c(H0.f(this.f7658a), this.f7658a.getId(), f3));
        }

        @Override // y.a.d
        public void c(View view) {
            h.f(view, "view");
            this.f7659b.b(new W1.b(H0.f(this.f7658a), this.f7658a.getId()));
        }

        @Override // y.a.d
        public void d(View view) {
            h.f(view, "view");
            this.f7659b.b(new W1.a(H0.f(this.f7658a), this.f7658a.getId()));
        }
    }
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.put("topDrawerSlide", DebugProbesKt.probeCoroutineResumed(n.a("registrationName", "onDrawerSlide")));
        exportedCustomDirectEventTypeConstants.put("topDrawerOpen", DebugProbesKt.probeCoroutineResumed(n.a("registrationName", "onDrawerOpen")));
        exportedCustomDirectEventTypeConstants.put("topDrawerClose", DebugProbesKt.probeCoroutineResumed(n.a("registrationName", "onDrawerClose")));
        exportedCustomDirectEventTypeConstants.put("topDrawerStateChanged", DebugProbesKt.probeCoroutineResumed(n.a("registrationName", "onDrawerStateChanged")));
        return exportedCustomDirectEventTypeConstants;
    }

    /* JADX WARN: Type inference failed for: r0v6, types: [java.util.Map<java.lang.String, java.lang.Object>, void] */
    @Override // com.facebook.react.uimanager.ViewManager
    public Map<String, Object> getExportedViewConstants() {
        return DebugProbesKt.probeCoroutineResumed(n.a(DRAWER_POSITION, D.h(n.a(DRAWER_POSITION_LEFT, 8388611), n.a(DRAWER_POSITION_RIGHT, 8388613))));
    }
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public void addEventEmitters(B0 b4, com.facebook.react.views.drawer.a aVar) {
        h.f(b4, "reactContext");
        h.f(aVar, "view");
        EventDispatcher eventDispatcherC = H0.c(b4, aVar.getId());
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.facebook.react.uimanager.ViewManager
    public com.facebook.react.views.drawer.a createViewInstance(B0 b4) {
        h.f(b4, "context");
        return new com.facebook.react.views.drawer.a(b4);
    }
    ...
    */
    ...
    public final void setDrawerWidth(com.facebook.react.views.drawer.a aVar, float f3) {
        h.f(aVar, "view");
        aVar.setDrawerWidth$ReactAndroid_release(Float.isNaN(f3) ? -1 : Math.round(C0392f0.f7477a.b(f3)));
    }

    @Override // com.facebook.react.uimanager.BaseViewManager
    public void setElevation(com.facebook.react.views.drawer.a aVar, float f3) {
        h.f(aVar, "view");
        aVar.setDrawerElevation(C0392f0.f7477a.b(f3));
    }
    ...
    public void setDrawerWidth(com.facebook.react.views.drawer.a aVar, Float f3) {
        ...
        h.f(aVar, "view");
        if (f3 != null) {
            iRound = Math.round(C0392f0.f7477a.b(f3.floatValue()));
        } else {
            iRound = -1;
        }
