...
public final class b extends P1.d {
    ...
    private final WritableMap u() {
        ...
        writableMapCreateMap.putString("uri", this.f7667j);
        writableMapCreateMap.putDouble("width", this.f7668k);
        writableMapCreateMap.putDouble("height", this.f7669l);
    ...
    protected WritableMap j() {
        ...
        int i3 = this.f7665h;
        if (i3 == 1) {
            writableMapCreateMap.putString("error", this.f7666i);
        } else if (i3 == 2) {
            writableMapCreateMap.putMap("source", u());
        } else if (i3 == 5) {
            writableMapCreateMap.putInt("loaded", this.f7670m);
            writableMapCreateMap.putInt("total", this.f7671n);
            writableMapCreateMap.putDouble(ReactProgressBarViewManager.PROP_PROGRESS, ((double) this.f7670m) / ((double) this.f7671n));
        }
        return writableMapCreateMap;
    }
