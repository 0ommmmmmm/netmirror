...
public final class ReactSwitchManager extends BaseViewManager<com.facebook.react.views.switchview.a, d> implements j {
    ...
    public long measure(Context context, ReadableMap readableMap, ReadableMap readableMap2, ReadableMap readableMap3, float f3, p pVar, float f4, p pVar2, float[] fArr) {
        ...
        return q.a(C0392f0.f(aVar.getMeasuredWidth()), C0392f0.f(aVar.getMeasuredHeight()));
    }
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public void addEventEmitters(B0 b4, com.facebook.react.views.switchview.a aVar) {
        h.f(b4, "reactContext");
        h.f(aVar, "view");
        aVar.setOnCheckedChangeListener(ON_CHECKED_CHANGE_LISTENER);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.facebook.react.uimanager.ViewManager
    public com.facebook.react.views.switchview.a createViewInstance(B0 b4) {
        h.f(b4, "context");
        com.facebook.react.views.switchview.a aVar = new com.facebook.react.views.switchview.a(b4);
        aVar.setShowText(false);
        return aVar;
    }
    ...
    @Override // U1.j
    @L1.a(defaultBoolean = false, name = "disabled")
