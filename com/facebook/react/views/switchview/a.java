...
public final class a extends c0 {
    ...
    private Integer f7911W;

    /* JADX INFO: renamed from: a0, reason: collision with root package name */
    private Integer f7912a0;
    ...
    public final void setTrackColorForFalse(Integer num) {
        ...
        setTrackColor(this.f7911W);
    }

    public final void setTrackColorForTrue(Integer num) {
        if (h.b(num, this.f7912a0)) {
            return;
        }
        this.f7912a0 = num;
        if (isChecked()) {
            setTrackColor(this.f7912a0);
        }
    }

    private final void setTrackColor(boolean z3) {
        Integer num = this.f7912a0;
        if (num == null && this.f7911W == null) {
            return;
        }
        if (!z3) {
            num = this.f7911W;
