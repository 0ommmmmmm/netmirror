...
@p086v1.a(name = ReactTextViewManager.REACT_CLASS)
public class ReactTextViewManager extends ReactTextAnchorViewManager<m, h> implements O {
    ...
    private Object getReactTextUpdate(m mVar, C0417s0 c0417s0, com.facebook.react.common.mapbuffer.a aVar) {
        ...
        try {
            ...
            return new i(spannableG, -1, false, t.j(aVarD, spannableG, mVar.getGravityHorizontal()), r.m(aVarD2.getString(2)), r.h(c0417s0, Build.VERSION.SDK_INT >= 26 ? mVar.getJustificationMode() : 0));
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(p018e1.d.e("topTextLayout", p018e1.d.d("registrationName", "onTextLayout"), "topInlineViewLayout", p018e1.d.d("registrationName", "onInlineViewLayout")));
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.facebook.react.uimanager.BaseViewManager, com.facebook.react.uimanager.ViewManager
    public m prepareToRecycleView(B0 b4, m mVar) {
        m mVar2 = (m) super.prepareToRecycleView(b4, mVar);
        if (mVar2 != null) {
            mVar2.w();
    ...
    public void updateExtraData(m mVar, Object obj) {
        p066q1.c cVar = new p066q1.c("ReactTextViewManager.updateExtraData");
        try {
            i iVar = (i) obj;
            ...
            mVar.setTag(AbstractC0462m.f9234f, fVarArr.length > 0 ? new n.a(fVarArr, spannableI) : null);
            n.f8003y.a(mVar, mVar.isFocusable(), mVar.getImportantForAccessibility());
            cVar.close();
        } catch (Throwable th) {
            try {
                cVar.close();
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public Object updateState(m mVar, C0417s0 c0417s0, A0 a4) {
        p066q1.c cVar = new p066q1.c("ReactTextViewManager.updateState");
        try {
            ...
            Object reactTextUpdate = getReactTextUpdate(mVar, c0417s0, readableMapBufferE);
            cVar.close();
    ...
    public void updateViewAccessibility(m mVar) {
        n.f8003y.b(mVar, mVar.isFocusable(), mVar.getImportantForAccessibility());
    }
