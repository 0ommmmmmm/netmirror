...
public final class a {
    ...
    public static final ColorStateList b(Context context) {
        ...
        return f7918a.a(context, R.attr.textColor);
    }

    public static final int c(Context context) {
        D2.h.f(context, "context");
        ColorStateList colorStateListA = f7918a.a(context, R.attr.textColorHighlight);
    ...
    public static final ColorStateList d(Context context) {
        D2.h.f(context, "context");
        return f7918a.a(context, R.attr.textColorHint);
    }
}
