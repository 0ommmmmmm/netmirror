...
public class t {
    ...
    private static final boolean f8050a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final String f8051b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final ThreadLocal f8052c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final ConcurrentHashMap f8053d;
    ...
    static {
        ...
        f8050a = false;
        f8051b = t.class.getSimpleName();
        f8052c = new a();
        f8053d = new ConcurrentHashMap();
    }
    ...
    static void a(Spannable spannable, float f3, com.facebook.yoga.p pVar, float f4, com.facebook.yoga.p pVar2, double d4, int i3, boolean z3, int i4, int i5, Layout.Alignment alignment, int i6, TextPaint textPaint) {
        ...
        int iH = (int) (Double.isNaN(d4) ? C0392f0.h(4.0f) : d4);
        int i7 = 0;
        ...
        while (i8 > iH) {
            ...
            int iMax2 = i8 - Math.max(1, (int) C0392f0.h(1.0f));
            float f5 = iMax2 / iMax;
            float f6 = iH;
    ...
    */
    ...
    private static Layout c(Context context, com.facebook.react.common.mapbuffer.a aVar, com.facebook.react.common.mapbuffer.a aVar2, float f3, float f4, o oVar) {
        ...
        if (aVar.g(3)) {
            ...
            TextPaint textPaint = (TextPaint) p064q.g.g((TextPaint) f8052c.get());
    ...
    private static Layout d(Spannable spannable, BoringLayout.Metrics metrics, float f3, com.facebook.yoga.p pVar, boolean z3, int i3, int i4, Layout.Alignment alignment, int i5, TextPaint textPaint) {
        ...
        if (metrics.width < 0) {
            ReactSoftExceptionLogger.logSoftException(f8051b, new ReactNoCrashSoftException("Text width is invalid: " + metrics.width));
            i6 = 0;
        } else {
            i6 = iCeil;
        }
    ...
    public static void f(int i3) {
        if (f8050a) {
            Y.a.m(f8051b, "Delete cached spannable for tag[" + i3 + "]");
        }
        f8053d.remove(Integer.valueOf(i3));
    }
    ...
    public static Spannable g(Context context, com.facebook.react.common.mapbuffer.a aVar, o oVar) {
        ...
        return (Spannable) f8053d.get(Integer.valueOf(aVar.getInt(3)));
    }
    ...
    private static Layout.Alignment h(com.facebook.react.common.mapbuffer.a aVar, Spannable spannable, String str) {
        ...
        if (str.equals("right")) {
            return z3 ? Layout.Alignment.ALIGN_NORMAL : Layout.Alignment.ALIGN_OPPOSITE;
        }
        return alignment;
    }
    ...
    */
    ...
    public static WritableArray m(Context context, com.facebook.react.common.mapbuffer.a aVar, com.facebook.react.common.mapbuffer.a aVar2, float f3, float f4) {
        ...
        return b.a(layoutC.getText(), layoutC, (TextPaint) p064q.g.g((TextPaint) f8052c.get()), context);
    }
    ...
    public static long n(Context context, com.facebook.react.common.mapbuffer.a aVar, com.facebook.react.common.mapbuffer.a aVar2, float f3, com.facebook.yoga.p pVar, float f4, com.facebook.yoga.p pVar2, o oVar, float[] fArr) {
        float fCeil;
        float lineBottom;
        char c4;
        float lineRight;
        ...
        char c5;
        float lineWidth;
        Layout layoutC = c(context, aVar, aVar2, f3, f4, oVar);
        ...
        int i3 = 0;
        int i4 = -1;
        int i5 = aVar2.g(0) ? aVar2.getInt(0) : -1;
        int lineCount = (i5 == -1 || i5 == 0) ? layoutC.getLineCount() : Math.min(i5, layoutC.getLineCount());
        char c6 = '\n';
        boolean z4 = true;
        if (pVar == com.facebook.yoga.p.EXACTLY) {
            fCeil = f3;
            ...
            for (int i6 = 0; i6 < lineCount; i6++) {
                boolean z5 = spannable.length() > 0 && spannable.charAt(layoutC.getLineEnd(i6) - 1) == '\n';
                if (!z5 && i6 + 1 < layoutC.getLineCount()) {
                    fCeil = f3;
                    break;
                }
                float lineMax = z5 ? layoutC.getLineMax(i6) : layoutC.getLineWidth(i6);
                if (lineMax > fCeil) {
                    fCeil = lineMax;
                }
            }
            if (pVar == com.facebook.yoga.p.AT_MOST && fCeil > f3) {
                fCeil = f3;
            }
        }
        ...
        while (i7 < spannable.length()) {
            int iNextSpanTransition = spannable.nextSpanTransition(i7, spannable.length(), Z1.q.class);
            Z1.q[] qVarArr = (Z1.q[]) spannable.getSpans(i7, iNextSpanTransition, Z1.q.class);
            int length = qVarArr.length;
            int i9 = i3;
            while (i9 < length) {
                Z1.q qVar = qVarArr[i9];
                ...
                if (layoutC.getEllipsisCount(lineForOffset) <= 0 || spanStart < layoutC.getLineStart(lineForOffset) + layoutC.getEllipsisStart(lineForOffset) || spanStart >= layoutC.getLineEnd(lineForOffset)) {
                    ...
                    boolean z6 = layoutC.getParagraphDirection(lineForOffset) == i4;
                    if (spanStart == spannable.length() - 1) {
                        if (spannable.length() > 0) {
                            ...
                            if (z6) {
                                ...
                                lineRight = layoutC.getLineRight(lineForOffset) - fC;
                            }
                            c4 = c5;
                        } else {
                            c5 = '\n';
                        ...
                        c4 = '\n';
                        float primaryHorizontal = z6 == zIsRtlCharAt ? layoutC.getPrimaryHorizontal(spanStart) : layoutC.getSecondaryHorizontal(spanStart);
                        float lineRight2 = (!z6 || zIsRtlCharAt) ? primaryHorizontal : fCeil - (layoutC.getLineRight(lineForOffset) - primaryHorizontal);
                        lineRight = zIsRtlCharAt ? lineRight2 - fC : lineRight2;
                    }
                    int i10 = i8 * 2;
                    fArr[i10] = C0392f0.f(layoutC.getLineBaseline(lineForOffset) - fA);
                    z3 = true;
                    fArr[i10 + 1] = C0392f0.f(lineRight);
                    i8++;
                } else {
                    c4 = c6;
                    z3 = z4;
        ...
        float f5 = C0392f0.f(fCeil);
        float f6 = C0392f0.f(lineBottom);
        if (f8050a) {
            Y.a.m(f8051b, "TextMeasure call ('" + ((Object) spannable) + "'): w: " + fCeil + " px - h: " + lineBottom + " px - w : " + f5 + " sp - h: " + f6 + " sp");
        }
        return com.facebook.yoga.q.a(f5, f6);
    }

    public static void o(int i3, Spannable spannable) {
        if (f8050a) {
            Y.a.m(f8051b, "Set cached spannable for tag[" + i3 + "]: " + spannable.toString());
        }
        f8053d.put(Integer.valueOf(i3), spannable);
    }
