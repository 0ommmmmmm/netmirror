...
public final class n extends C0396h0 {

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    public static final b f8003y = new b(null);
    ...
    public n(View view, boolean z3, int i3) {
        super(view, z3, i3);
        D2.h.f(view, "view");
        this.f8004x = (a) V().getTag(AbstractC0462m.f9234f);
    }
    ...
    private final Rect k0(a.C0118a c0118a) {
        ...
        AbsoluteSizeSpan absoluteSizeSpan = (AbsoluteSizeSpan) l0(c0118a.d(), c0118a.b(), AbsoluteSizeSpan.class);
        paint.setTextSize(absoluteSizeSpan != null ? absoluteSizeSpan.getSize() : textView.getTextSize());
        int iCeil = (int) Math.ceil(paint.measureText(c0118a.a()));
    ...
    @Override // com.facebook.react.uimanager.C0396h0, p092x.a
    ...
    protected void L(int i3, p068r.v vVar) {
        ...
        vVar.a(16);
        vVar.l0(rectK0);
        vVar.F0(V().getResources().getString(AbstractC0465p.f9297w));
        vVar.p0(C0396h0.d.e(C0396h0.d.BUTTON));
    }
    ...
    @Override // com.facebook.react.uimanager.C0396h0, p092x.a, androidx.core.view.C0230a
