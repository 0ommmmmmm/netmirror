...
@p086v1.a(name = ReactModalHostManager.REACT_CLASS)
public final class ReactModalHostManager extends ViewGroupManager<c> implements n {
    ...
    public static final void addEventEmitters$lambda$0(EventDispatcher eventDispatcher, B0 b4, c cVar, DialogInterface dialogInterface) {
        eventDispatcher.b(new d(H0.e(b4), cVar.getId()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void addEventEmitters$lambda$1(EventDispatcher eventDispatcher, B0 b4, c cVar, DialogInterface dialogInterface) {
        eventDispatcher.b(new e(H0.e(b4), cVar.getId()));
    }
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.put("topRequestClose", DebugProbesKt.probeCoroutineResumed(p071r2.n.a("registrationName", "onRequestClose")));
        exportedCustomDirectEventTypeConstants.put("topShow", DebugProbesKt.probeCoroutineResumed(p071r2.n.a("registrationName", "onShow")));
        exportedCustomDirectEventTypeConstants.put("topDismiss", DebugProbesKt.probeCoroutineResumed(p071r2.n.a("registrationName", "onDismiss")));
        exportedCustomDirectEventTypeConstants.put("topOrientationChange", DebugProbesKt.probeCoroutineResumed(p071r2.n.a("registrationName", "onOrientationChange")));
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public void addEventEmitters(final B0 b4, final c cVar) {
        h.f(b4, "reactContext");
        h.f(cVar, "view");
        final EventDispatcher eventDispatcherC = H0.c(b4, cVar.getId());
        if (eventDispatcherC != null) {
            cVar.setOnRequestCloseListener(new c.InterfaceC0113c() { // from class: com.facebook.react.views.modal.a
                ...
                public final void a(DialogInterface dialogInterface) {
                    ReactModalHostManager.addEventEmitters$lambda$0(eventDispatcherC, b4, cVar, dialogInterface);
                }
            });
            cVar.setOnShowListener(new DialogInterface.OnShowListener() { // from class: com.facebook.react.views.modal.b
                ...
                public final void onShow(DialogInterface dialogInterface) {
                    ReactModalHostManager.addEventEmitters$lambda$1(eventDispatcherC, b4, cVar, dialogInterface);
                }
            });
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    public Object updateState(c cVar, C0417s0 c0417s0, A0 a4) {
        h.f(cVar, "view");
        h.f(c0417s0, "props");
        h.f(a4, "stateWrapper");
        cVar.setStateWrapper(a4);
        return null;
    }
}
