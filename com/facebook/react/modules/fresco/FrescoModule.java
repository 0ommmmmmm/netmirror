...
@p086v1.a(name = FrescoModule.NAME, needsEagerInit = true)
public class FrescoModule extends ReactContextBaseJavaModule implements LifecycleEventListener, TurboModule {
    ...
    public static final class a {
        ...
        public final C0186u.a c(ReactContext reactContext) {
            ...
            C0186u.a aVarT = F0.a.a(applicationContext, zVarA).S(new c(zVarA)).R(EnumC0180n.AUTO).T(hashSet);
            aVarT.b().d(true);
            return aVarT;
        }
    ...
    public void initialize() {
        ...
        if (!aVar.d()) {
            ...
            p049m0.d.c(reactApplicationContext.getApplicationContext(), c0186uB, aVarE.e());
