...
public final class NetworkingModule extends NativeNetworkingAndroidSpec {
    ...
    class a implements i {
        ...
        long f6990a = System.nanoTime();

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f6991b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ ReactApplicationContext f6992c;
        ...
        a(String str, ReactApplicationContext reactApplicationContext, int i3) {
            this.f6991b = str;
            this.f6992c = reactApplicationContext;
            this.f6993d = i3;
        }
        ...
        public void a(long j3, long j4, boolean z3) {
            ...
            if ((z3 || NetworkingModule.shouldDispatch(jNanoTime, this.f6990a)) && !this.f6991b.equals("text")) {
                o.c(this.f6992c, this.f6993d, j3, j4);
                this.f6990a = jNanoTime;
            }
        }
    }
    ...
    class b implements InterfaceC0195f {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ ReactApplicationContext f6996b;
        ...
        b(int i3, ReactApplicationContext reactApplicationContext, String str, boolean z3) {
            this.f6995a = i3;
            this.f6996b = reactApplicationContext;
            this.f6997c = str;
            this.f6998d = z3;
        }
        ...
        public void a(InterfaceC0194e interfaceC0194e, IOException iOException) {
            ...
            NetworkingModule.this.removeRequest(this.f6995a);
            if (iOException.getMessage() != null) {
                message = iOException.getMessage();
            } else {
                message = "Error while executing request: " + iOException.getClass().getSimpleName();
            }
            o.f(this.f6996b, this.f6995a, message, iOException);
        }
        ...
        public void b(InterfaceC0194e interfaceC0194e, D d4) {
            ...
            NetworkingModule.this.removeRequest(this.f6995a);
            o.h(this.f6996b, this.f6995a, d4.A(), NetworkingModule.translateHeaders(d4.d0()), d4.y0().l().toString());
            try {
                E eQ = d4.q();
                ...
                for (e eVar : NetworkingModule.this.mResponseHandlers) {
                    if (eVar.b(this.f6997c)) {
                        o.a(this.f6996b, this.f6995a, eVar.a(eQ));
                        o.g(this.f6996b, this.f6995a);
                        return;
                    }
                }
                if (this.f6998d && this.f6997c.equals("text")) {
                    NetworkingModule.this.readWithProgress(this.f6995a, eQ);
                    o.g(this.f6996b, this.f6995a);
                    return;
                }
                String strA = "";
                if (this.f6997c.equals("text")) {
                    try {
                        strA = eQ.A();
                    } catch (IOException e4) {
                        if (!d4.y0().h().equalsIgnoreCase("HEAD")) {
                            o.f(this.f6996b, this.f6995a, e4.getMessage(), e4);
                        }
                    }
                } else if (this.f6997c.equals(NetworkingModule.REQUEST_BODY_KEY_BASE64)) {
                    strA = Base64.encodeToString(eQ.i(), 2);
                }
                o.b(this.f6996b, this.f6995a, strA);
                o.g(this.f6996b, this.f6995a);
            } catch (IOException e5) {
                o.f(this.f6996b, this.f6995a, e5.getMessage(), e5);
            }
        }
    }
    ...
    class c implements i {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        long f7000a = System.nanoTime();

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ ReactApplicationContext f7001b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ int f7002c;

        c(ReactApplicationContext reactApplicationContext, int i3) {
            this.f7001b = reactApplicationContext;
            this.f7002c = i3;
        }
        ...
        public void a(long j3, long j4, boolean z3) {
            long jNanoTime = System.nanoTime();
            if (z3 || NetworkingModule.shouldDispatch(jNanoTime, this.f7000a)) {
                o.d(this.f7001b, this.f7002c, j3, j4);
                this.f7000a = jNanoTime;
            }
        }
    }
    ...
    private void cancelRequest(int i3) {
        p034i1.a.a(this.mClient, Integer.valueOf(i3));
    }
    ...
    public void sendRequestInternal(String str, String str2, final int i3, ReadableArray readableArray, ReadableMap readableMap, final String str3, boolean z3, int i4, boolean z4) {
        ...
        try {
            ...
            for (f fVar : this.mUriHandlers) {
                if (fVar.b(uri, str3)) {
                    o.a(reactApplicationContextIfActiveOrWarn, i3, fVar.a(uri));
                    o.g(reactApplicationContextIfActiveOrWarn, i3);
                    return;
                }
            }
            try {
                B.a aVarM = new B.a().m(str2);
                if (i3 != 0) {
                    aVarM.k(Integer.valueOf(i3));
                }
                z.a aVarC = this.mClient.C();
                applyCustomBuilder(aVarC);
                if (!z4) {
                    aVarC.f(M2.n.f1202a);
                }
                if (z3) {
                    aVarC.a(new v() { // from class: com.facebook.react.modules.network.f
                        @Override // M2.v
                        public final D a(v.a aVar) {
                            return this.f7008a.lambda$sendRequestInternal$0(str3, reactApplicationContextIfActiveOrWarn, i3, aVar);
                        }
                    });
                }
                if (i4 != this.mClient.j()) {
                    aVarC.d(i4, TimeUnit.MILLISECONDS);
                }
                z zVarB = aVarC.b();
                M2.t tVarExtractHeaders = extractHeaders(readableArray, readableMap);
                if (tVarExtractHeaders == null) {
                    o.f(reactApplicationContextIfActiveOrWarn, i3, "Unrecognized headers format", null);
                    return;
                }
                String strA = tVarExtractHeaders.a(CONTENT_TYPE_HEADER_NAME);
                String strA2 = tVarExtractHeaders.a(CONTENT_ENCODING_HEADER_NAME);
                ...
                if (readableMap != null) {
                    ...
                    if (str.toLowerCase(locale).equals("get") || str.toLowerCase(locale).equals("head")) {
                        ...
                        cG = next.b(readableMap, strA);
                    } else if (readableMap.hasKey(REQUEST_BODY_KEY_STRING)) {
                        if (strA == null) {
                            o.f(reactApplicationContextIfActiveOrWarn, i3, "Payload is set but no content-type header specified", null);
                            return;
                        }
                        ...
                        if (n.i(strA2)) {
                            cG = n.d(xVarF, string);
                            if (cG == null) {
                                o.f(reactApplicationContextIfActiveOrWarn, i3, "Failed to gzip request body", null);
                                return;
                            }
                        } else {
                            cG = C.e(xVarF, string.getBytes(xVarF == null ? StandardCharsets.UTF_8 : xVarF.c(StandardCharsets.UTF_8)));
                        }
                        ...
                        cG = C.c(x.f(strA), b3.l.c(readableMap.getString(REQUEST_BODY_KEY_BASE64)));
                        ...
                        InputStream inputStreamH = n.h(getReactApplicationContext(), string2);
                        if (inputStreamH == null) {
                            o.f(reactApplicationContextIfActiveOrWarn, i3, "Could not retrieve file for uri " + string2, null);
                            return;
                        }
                        cG = n.c(x.f(strA), inputStreamH);
                    } else if (readableMap.hasKey(REQUEST_BODY_KEY_FORMDATA)) {
                        if (strA == null) {
                            strA = "multipart/form-data";
                        }
                        y.a aVarConstructMultipartBody = constructMultipartBody(readableMap.getArray(REQUEST_BODY_KEY_FORMDATA), strA, i3);
                        if (aVarConstructMultipartBody == null) {
                            return;
                        } else {
                            cG = aVarConstructMultipartBody.c();
                        }
                    } else {
                        cG = n.g(str);
                    }
                ...
                aVarM.g(str, wrapRequestBodyWithProgressEmitter(cG, i3));
                addRequest(i3);
                zVarB.b(aVarM.b()).o(new b(i3, reactApplicationContextIfActiveOrWarn, str3, z3));
            } catch (Exception e4) {
                o.f(reactApplicationContextIfActiveOrWarn, i3, e4.getMessage(), null);
            }
        } catch (IOException e5) {
            o.f(reactApplicationContextIfActiveOrWarn, i3, e5.getMessage(), e5);
        }
    }
