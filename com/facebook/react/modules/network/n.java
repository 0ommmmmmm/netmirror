...
public final class n {
    ...
    public static final n f7027a = new n();

    public static final class a extends C {

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ x f7028b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ InputStream f7029c;

        a(x xVar, InputStream inputStream) {
            this.f7028b = xVar;
            this.f7029c = inputStream;
        }

        @Override // M2.C
        public long a() {
            try {
                return this.f7029c.available();
        ...
        public void h(b3.j jVar) {
            ...
            F fC = null;
            try {
                fC = AbstractC0298c.a().c(this.f7029c);
                jVar.T(fC);
            } finally {
                if (fC != null) {
                    n.f7027a.b(fC);
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        A2.a.a(readableByteChannelNewChannel, th);
                        throw th2;
                    }
                }
            } catch (Throwable th3) {
                try {
                    ...
                    A2.a.a(inputStreamOpenStream, th3);
                    throw th4;
                }
            }
        } catch (Throwable th5) {
    ...
    public static final C g(String str) {
        ...
        return C.f908a.a(null, b3.l.f5639e);
    }
