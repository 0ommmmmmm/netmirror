...
@p086v1.a(name = NativeDevSettingsSpec.NAME)
public final class DevSettingsModule extends NativeDevSettingsSpec {
    ...
    public DevSettingsModule(ReactApplicationContext reactApplicationContext, p042k1.e eVar) {
    ...
    public void addMenuItem(final String str) {
        D2.h.f(str, "title");
        this.devSupportManager.p(str, new p042k1.d() { // from class: com.facebook.react.modules.debug.b
            @Override // p042k1.d
            public final void a() {
        ...
        if (this.devSupportManager.n()) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.modules.debug.c
                ...
                public final void run() {
                    DevSettingsModule.reload$lambda$0(this.f6935b);
                }
            });
        }
    }
