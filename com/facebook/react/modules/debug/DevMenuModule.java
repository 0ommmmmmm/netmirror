...
@p086v1.a(name = NativeDevMenuSpec.NAME)
public final class DevMenuModule extends NativeDevMenuSpec {
    private final p042k1.e devSupportManager;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DevMenuModule(ReactApplicationContext reactApplicationContext, p042k1.e eVar) {
        ...
        if (this.devSupportManager.n()) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.modules.debug.a
                ...
                public final void run() {
                    DevMenuModule.reload$lambda$0(this.f6932b);
                }
            });
        }
    }
