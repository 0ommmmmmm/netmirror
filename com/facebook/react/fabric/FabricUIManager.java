...
public class FabricUIManager implements UIManager, LifecycleEventListener, p050m1.b, p {
    private static final com.facebook.react.fabric.a.InterfaceC0106a FABRIC_PERF_LOGGER = new com.facebook.react.fabric.a.InterfaceC0106a() { // from class: com.facebook.react.fabric.d
    ...
    private p046l1.a mInteropUIBlockListener;
    private final p054n1.c mMountItemDispatcher;
    private final n1.d.a mMountItemExecutor;
    private final p054n1.d mMountingManager;
    ...
    class b implements MountItem {
        ...
        final /* synthetic */ ReadableMap f6798b;

        b(int i3, ReadableMap readableMap) {
            this.f6797a = i3;
            this.f6798b = readableMap;
        }

        @Override // com.facebook.react.fabric.mounting.mountitems.MountItem
        public void execute(p054n1.d dVar) {
            try {
                dVar.u(this.f6797a, this.f6798b);
        ...
        public String toString() {
            return String.format("SYNC UPDATE PROPS [%d]: %s", Integer.valueOf(this.f6797a), FabricUIManager.IS_DEVELOPMENT_ENVIRONMENT ? this.f6798b.toHashMap().toString() : "<hidden>");
        }
    }
    ...
    class d implements MountItem {
        ...
        @Override // com.facebook.react.fabric.mounting.mountitems.MountItem
        public void execute(p054n1.d dVar) {
            p054n1.g gVarF = dVar.f(this.f6801a);
            if (gVarF != null) {
                gVarF.H(this.f6802b, this.f6803c, this.f6804d);
                return;
            }
            Y.a.m(FabricUIManager.TAG, "setJSResponder skipped, surface no longer available [" + this.f6801a + "]");
        }
        ...
        public String toString() {
            return String.format("SET_JS_RESPONDER [%d] [surface:%d]", Integer.valueOf(this.f6802b), Integer.valueOf(this.f6801a));
        }
    }
    ...
    private class f extends M {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private volatile boolean f6807b;
    ...
    private class g implements n1.c.a {
    ...
    public FabricUIManager(ReactApplicationContext reactApplicationContext, U0 u3, P1.a aVar) {
        a aVar2 = new a();
        this.mMountItemExecutor = aVar2;
        this.mDispatchUIFrameCallback = new f(reactApplicationContext);
        this.mReactApplicationContext = reactApplicationContext;
        p054n1.d dVar = new p054n1.d(u3, aVar2);
        this.mMountingManager = dVar;
        this.mMountItemDispatcher = new p054n1.c(dVar, new g());
        this.mEventDispatcher = new k(reactApplicationContext);
        this.mBatchEventDispatchedListener = aVar;
        reactApplicationContext.addLifecycleEventListener(this);
        this.mViewManagerRegistry = u3;
        reactApplicationContext.registerComponentCallbacks(u3);
    }
    ...
    private p046l1.a getInteropUIBlockListener() {
        if (this.mInteropUIBlockListener == null) {
            p046l1.a aVar = new p046l1.a();
    ...
    public static /* synthetic */ void lambda$static$0(com.facebook.react.fabric.a.b bVar) {
        long jF = bVar.f();
        long jO = bVar.o();
        long j3 = bVar.j();
        long jS = bVar.s();
        long jC = bVar.c();
        com.facebook.react.fabric.g gVar = com.facebook.react.fabric.a.f6815c;
        gVar.a(jF);
        com.facebook.react.fabric.g gVar2 = com.facebook.react.fabric.a.f6816d;
        gVar2.a(jO);
        com.facebook.react.fabric.g gVar3 = com.facebook.react.fabric.a.f6817e;
        gVar3.a(j3);
        com.facebook.react.fabric.g gVar4 = com.facebook.react.fabric.a.f6818f;
        gVar4.a(jS);
        com.facebook.react.fabric.g gVar5 = com.facebook.react.fabric.a.f6819g;
        gVar5.a(jC);
    ...
    private NativeArray measureLines(ReadableMapBuffer readableMapBuffer, ReadableMapBuffer readableMapBuffer2, float f3, float f4) {
        return (NativeArray) t.m(this.mReactApplicationContext, readableMapBuffer, readableMapBuffer2, C0392f0.h(f3), C0392f0.h(f4));
    }
    ...
    private long measureMapBuffer(int i3, String str, ReadableMapBuffer readableMapBuffer, ReadableMapBuffer readableMapBuffer2, ReadableMapBuffer readableMapBuffer3, float f3, float f4, float f5, float f6, float[] fArr) {
        ...
        if (i3 > 0) {
            p054n1.g gVarG = this.mMountingManager.g(i3, "measure");
            if (gVarG.u()) {
                return 0L;
            }
        ...
        return this.mMountingManager.n(reactContextL, str, readableMapBuffer, readableMapBuffer2, readableMapBuffer3, p054n1.a.c(f3, f4), p054n1.a.b(f3, f4), p054n1.a.c(f5, f6), p054n1.a.b(f5, f6), fArr);
    }
    ...
    public <T extends View> int addRootView(T t3, WritableMap writableMap) {
        ...
        InterfaceC0410o0 interfaceC0410o0 = (InterfaceC0410o0) t3;
        int rootViewTag = interfaceC0410o0.getRootViewTag();
        this.mMountingManager.r(rootViewTag, new B0(this.mReactApplicationContext, t3.getContext(), interfaceC0410o0.getSurfaceID(), rootViewTag), t3);
        String jSModuleName = interfaceC0410o0.getJSModuleName();
        if (p070r1.b.e()) {
    ...
    public void addUIBlock(p050m1.a aVar) {
        if (p070r1.b.p()) {
    ...
    public void attachRootView(p062p1.b bVar, View view) {
        this.mMountingManager.a(bVar.getSurfaceId(), view, new B0(this.mReactApplicationContext, view.getContext(), bVar.a(), bVar.getSurfaceId()));
        bVar.h(true);
    }
    ...
    public boolean getThemeData(int i3, float[] fArr) {
        p054n1.g gVarF = this.mMountingManager.f(i3);
    ...
    public void prependUIBlock(p050m1.a aVar) {
        if (p070r1.b.p()) {
    ...
    public View resolveView(int i3) {
        ...
        p054n1.g gVarH = this.mMountingManager.h(i3);
        if (gVarH == null) {
            return null;
        }
        return gVarH.p(i3);
    ...
    public <T extends View> int startSurface(T t3, String str, WritableMap writableMap, int i3, int i4) {
        int rootViewTag = ((InterfaceC0410o0) t3).getRootViewTag();
        Context context = t3.getContext();
        B0 b4 = new B0(this.mReactApplicationContext, context, str, rootViewTag);
        if (p070r1.b.e()) {
            Y.a.d(TAG, "Starting surface for module: %s and reactTag: %d", str, Integer.valueOf(rootViewTag));
        }
        this.mMountingManager.r(rootViewTag, b4, t3);
        Point pointB = UiThreadUtil.isOnUiThread() ? C0427x0.b(t3) : new Point(0, 0);
        this.mBinding.startSurfaceWithConstraints(rootViewTag, str, (NativeMap) writableMap, p054n1.a.a(i3), p054n1.a.d(i3), p054n1.a.a(i4), p054n1.a.d(i4), pointB.x, pointB.y, com.facebook.react.modules.i18nmanager.a.f().i(context), com.facebook.react.modules.i18nmanager.a.f().d(context));
        return rootViewTag;
    }

    public void stopSurface(p062p1.b bVar) {
        if (!bVar.isRunning()) {
            ReactSoftExceptionLogger.logSoftException(TAG, new IllegalStateException("Trying to stop surface that hasn't started yet"));
            return;
        }
        this.mMountingManager.s(bVar.getSurfaceId());
    ...
    public void updateRootLayoutSpecs(int i3, int i4, int i5, int i6, int i7) {
        ...
        this.mBinding.setConstraints(i3, p054n1.a.a(i4), p054n1.a.d(i4), p054n1.a.a(i5), p054n1.a.d(i5), i6, i7, z3, zD);
    }
    ...
    private long measure(int i3, String str, ReadableMap readableMap, ReadableMap readableMap2, ReadableMap readableMap3, float f3, float f4, float f5, float f6, float[] fArr) {
        ...
        return this.mMountingManager.m(reactContextL, str, readableMap, readableMap2, readableMap3, p054n1.a.c(f3, f4), p054n1.a.b(f3, f4), p054n1.a.c(f5, f6), p054n1.a.b(f5, f6), fArr);
    }
    ...
    public void startSurface(p062p1.b bVar, Context context, View view) {
        int iA = C0412p0.a();
        this.mMountingManager.r(iA, new B0(this.mReactApplicationContext, context, bVar.a(), iA), view);
        if (bVar instanceof SurfaceHandlerBinding) {
