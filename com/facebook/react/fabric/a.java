...
public class a implements ReactMarker.FabricMarkerListener {
    ...
    static final g f6815c = new g();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    static final g f6816d = new g();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    static final g f6817e = new g();

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    static final g f6818f = new g();

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    static final g f6819g = new g();

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final Map f6820a = new HashMap();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final List f6821b = new ArrayList();
    ...
    public static class b {
        ...
        public String toString() {
            return "FabricCommitPoint{mCommitNumber=" + this.f6822a + ", mPoints=" + this.f6823b + '}';
        }
    ...
    public void a(InterfaceC0106a interfaceC0106a) {
        this.f6821b.add(interfaceC0106a);
    }

    public void d(InterfaceC0106a interfaceC0106a) {
        this.f6821b.remove(interfaceC0106a);
    }
    ...
    public void logFabricMarker(ReactMarkerConstants reactMarkerConstants, String str, int i3, long j3, int i4) {
        if (b(reactMarkerConstants)) {
            b bVar = (b) this.f6820a.get(Integer.valueOf(i3));
            if (bVar == null) {
                bVar = new b(i3);
                this.f6820a.put(Integer.valueOf(i3), bVar);
            }
            ...
            c(bVar);
            this.f6820a.remove(Integer.valueOf(i3));
        }
    }
}
