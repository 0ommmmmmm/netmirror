...
public final class g {
    ...
    public static final g f6859a = new g();
    ...
    public static final MountItem e(int i3, int i4, String str, ReadableMap readableMap, A0 a4, boolean z3) {
        D2.h.f(str, "component");
        return new h(i3, i4, str, readableMap, a4, z3);
    }
