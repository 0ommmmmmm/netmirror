...
public final class t extends w {
    ...
    public String e() {
        return "SubtractionAnimatedNode[" + this.f6382d + "]: input nodes: " + this.f6482j + " - super: " + super.e();
    }

    @Override // com.facebook.react.animated.b
    public void h() {
        int length = this.f6482j.length;
        for (int i3 = 0; i3 < length; i3++) {
            b bVarL = this.f6481i.l(this.f6482j[i3]);
