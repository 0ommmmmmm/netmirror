...
public class o implements P1.g {
    ...
    private final ReactApplicationContext f6443e;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final SparseArray f6439a = new SparseArray();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final SparseArray f6440b = new SparseArray();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final SparseArray f6441c = new SparseArray();
    ...
    private final List f6445g = new LinkedList();
    ...
    class a implements Runnable {
        ...
        public void run() {
            o.this.o(this.f6449b);
        }
    }

    public o(ReactApplicationContext reactApplicationContext) {
        this.f6443e = reactApplicationContext;
    }

    private void A(b bVar) {
        WritableArray writableArrayCreateArray = null;
        int i3 = 0;
        while (i3 < this.f6440b.size()) {
            e eVar = (e) this.f6440b.valueAt(i3);
            if (bVar.equals(eVar.f6384b)) {
                if (eVar.f6385c != null) {
                    WritableMap writableMapCreateMap = Arguments.createMap();
                    writableMapCreateMap.putBoolean("finished", false);
                    writableMapCreateMap.putDouble("value", eVar.f6384b.f6496f);
                    eVar.f6385c.invoke(writableMapCreateMap);
                } else if (this.f6443e != null) {
                    WritableMap writableMapCreateMap2 = Arguments.createMap();
                    writableMapCreateMap2.putInt("animationId", eVar.f6386d);
                    writableMapCreateMap2.putBoolean("finished", false);
                    writableMapCreateMap2.putDouble("value", eVar.f6384b.f6496f);
                ...
                this.f6440b.removeAt(i3);
                i3--;
            }
            i3++;
        }
        if (writableArrayCreateArray != null) {
            this.f6443e.emitDeviceEvent("onNativeAnimatedModuleAnimationFinished", writableArrayCreateArray);
        }
    }
    ...
    private void D(List list) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            if (bVar2.f6379a != null) {
                for (int i8 = 0; i8 < bVar2.f6379a.size(); i8++) {
                    b bVar3 = (b) bVar2.f6379a.get(i8);
                    bVar3.f6380b++;
                    int i9 = bVar3.f6381c;
                    int i10 = this.f6444f;
                    if (i9 != i10) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            if (bVar5.f6379a != null) {
                for (int i17 = 0; i17 < bVar5.f6379a.size(); i17++) {
                    b bVar6 = (b) bVar5.f6379a.get(i17);
                    int i18 = bVar6.f6380b - 1;
                    bVar6.f6380b = i18;
                    int i19 = bVar6.f6381c;
                    int i20 = this.f6444f;
                    if (i19 != i20 && i18 == 0) {
                        bVar6.f6381c = i20;
                        i13++;
    ...
    public void o(P1.d dVar) {
        ...
        P1.d.b bVarH = dVar.h();
        boolean z3 = false;
        for (EventAnimationDriver eventAnimationDriver : this.f6442d) {
            if (bVarH.a(eventAnimationDriver.viewTag, eventAnimationDriver.eventName)) {
                ...
                this.f6445g.add(eventAnimationDriver.valueNode);
                z3 = true;
            }
        }
        if (z3) {
    ...
    public void c(int i3, String str, ReadableMap readableMap) {
        ...
        String strR = r(str);
        this.f6442d.add(new EventAnimationDriver(strR, i3, arrayList, (w) bVar));
    ...
    public void d(int i3, int i4) {
        ...
        ReactApplicationContext reactApplicationContext = this.f6443e;
    ...
    public void e(int i3, int i4) {
        ...
        b bVar2 = (b) this.f6439a.get(i4);
        if (bVar2 != null) {
            bVar.b(bVar2);
            this.f6441c.put(i4, bVar2);
        } else {
    ...
    public void f(int i3, ReadableMap readableMap) {
        ...
        if ("style".equals(string)) {
            ...
            pVar = new f(readableMap, this, this.f6443e);
        ...
        pVar.f6382d = i3;
        this.f6439a.put(i3, pVar);
        this.f6441c.put(i3, pVar);
    }
    ...
    Set m(int i3, String str) {
        ...
        ListIterator listIterator = this.f6442d.listIterator();
        while (listIterator.hasNext()) {
            ...
            if (eventAnimationDriver != null && str.equals(eventAnimationDriver.eventName) && i3 == (i4 = eventAnimationDriver.viewTag)) {
                ...
                if (wVar != null && (list = wVar.f6379a) != null) {
                    Iterator it = list.iterator();
                    while (it.hasNext()) {
                        hashSet.add(Integer.valueOf(((b) it.next()).f6382d));
                    }
                }
            }
        }
    ...
    public void n(int i3, Callback callback) {
        ...
        if (callback != null) {
            ...
            this.f6443e.emitDeviceEvent("onNativeAnimatedModuleGetValue", writableMapCreateMap);
        }
    }

    public boolean p() {
        return this.f6440b.size() > 0 || this.f6441c.size() > 0;
    }
    ...
    public void q(int i3) {
        ...
        UIManager uIManagerG = H0.g(this.f6443e, i3);
        if (uIManagerG != null) {
    ...
    public void s(int i3, String str, int i4) {
        ...
        while (listIterator.hasNext()) {
            EventAnimationDriver eventAnimationDriver = (EventAnimationDriver) listIterator.next();
            if (strR.equals(eventAnimationDriver.eventName) && i3 == eventAnimationDriver.viewTag && i4 == eventAnimationDriver.valueNode.f6382d) {
                listIterator.remove();
                break;
            }
        }
    ...
    public void u(long j3) {
        ...
        for (int i3 = 0; i3 < this.f6441c.size(); i3++) {
            this.f6445g.add((b) this.f6441c.valueAt(i3));
        }
        this.f6441c.clear();
        boolean z3 = false;
        for (int i4 = 0; i4 < this.f6440b.size(); i4++) {
            e eVar = (e) this.f6440b.valueAt(i4);
            eVar.b(j3);
            this.f6445g.add(eVar.f6384b);
            if (eVar.f6383a) {
                z3 = true;
            }
        }
        ...
        if (z3) {
            ...
            for (int size = this.f6440b.size() - 1; size >= 0; size--) {
                e eVar2 = (e) this.f6440b.valueAt(size);
                if (eVar2.f6383a) {
                    if (eVar2.f6385c != null) {
                        WritableMap writableMapCreateMap = Arguments.createMap();
                        writableMapCreateMap.putBoolean("finished", true);
                        writableMapCreateMap.putDouble("value", eVar2.f6384b.f6496f);
                        eVar2.f6385c.invoke(writableMapCreateMap);
                    } else if (this.f6443e != null) {
                        WritableMap writableMapCreateMap2 = Arguments.createMap();
                        writableMapCreateMap2.putInt("animationId", eVar2.f6386d);
                        writableMapCreateMap2.putBoolean("finished", true);
                        writableMapCreateMap2.putDouble("value", eVar2.f6384b.f6496f);
                        if (writableArrayCreateArray == null) {
                            writableArrayCreateArray = Arguments.createArray();
                        }
                        writableArrayCreateArray.pushMap(writableMapCreateMap2);
                    }
                    this.f6440b.removeAt(size);
                }
            }
            if (writableArrayCreateArray != null) {
                this.f6443e.emitDeviceEvent("onNativeAnimatedModuleAnimationFinished", writableArrayCreateArray);
    ...
    public void x(int i3, int i4, ReadableMap readableMap, Callback callback) {
        ...
        gVar.f6386d = i3;
        gVar.f6385c = callback;
        gVar.f6384b = (w) bVar;
        this.f6440b.put(i3, gVar);
    }
