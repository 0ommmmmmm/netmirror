...
public final class p extends com.facebook.react.animated.b {
    ...
    public static final a f6451h = new a(null);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private final o f6452f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private final JavaOnlyMap f6453g;
    ...
    public p(ReadableMap readableMap, o oVar) {
        ...
        this.f6452f = oVar;
        this.f6453g = JavaOnlyMap.Companion.deepClone(readableMap);
    }
    ...
    private final JavaOnlyArray j(ReadableArray readableArray) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            switch (b.f6454a[readableArray.getType(i3).ordinal()]) {
                case 1:
                ...
                case 5:
                    ...
                    if (map != null && map.hasKey("nodeTag") && map.getType("nodeTag") == ReadableType.Number) {
                        com.facebook.react.animated.b bVarL = this.f6452f.l(map.getInt("nodeTag"));
                        if (bVarL == null) {
    ...
    private final JavaOnlyMap k(ReadableMap readableMap) {
        ...
        while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
            ...
            switch (b.f6454a[readableMap.getType(strNextKey).ordinal()]) {
                case 1:
    ...
    public String e() {
        return "ObjectAnimatedNode[" + this.f6382d + "]: mConfig: " + this.f6453g;
    }

    public final void i(String str, JavaOnlyMap javaOnlyMap) {
        D2.h.f(str, "propKey");
        D2.h.f(javaOnlyMap, "propsMap");
        ReadableType type = this.f6453g.getType("value");
        if (type == ReadableType.Map) {
            javaOnlyMap.putMap(str, k(this.f6453g.getMap("value")));
        } else {
            if (type != ReadableType.Array) {
                throw new IllegalArgumentException("Invalid value type for ObjectAnimatedNode");
            }
            javaOnlyMap.putArray(str, j(this.f6453g.getArray("value")));
        }
    }
}
