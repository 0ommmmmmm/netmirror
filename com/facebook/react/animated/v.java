...
public final class v extends com.facebook.react.animated.b {
    ...
    private final o f6488f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private final List f6489g;
    ...
    public String e() {
        return "TransformAnimatedNode[" + this.f6382d + "]: transformConfigs: " + this.f6489g;
    }

    public final void i(JavaOnlyMap javaOnlyMap) {
        double dC;
        D2.h.f(javaOnlyMap, "propsMap");
        int size = this.f6489g.size();
        ArrayList arrayList = new ArrayList(size);
        for (int i3 = 0; i3 < size; i3++) {
            c cVar = (c) this.f6489g.get(i3);
            if (cVar instanceof a) {
                com.facebook.react.animated.b bVarL = this.f6488f.l(((a) cVar).c());
                if (bVarL == null) {
