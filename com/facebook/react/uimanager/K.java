...
public final class K {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            switch (key.hashCode()) {
                case -2114203985:
                    ...
                    colorMatrixP = f7256a.p(fDoubleValue);
                ...
                case -1267206133:
                    ...
                    colorMatrixP = f7256a.n(fDoubleValue);
                    colorMatrix.preConcat(colorMatrixP);
                    break;
                    break;
                case -1183703082:
                    ...
                    colorMatrixP = f7256a.l(fDoubleValue);
                    colorMatrix.preConcat(colorMatrixP);
                    break;
                    break;
                case -905411385:
                    ...
                    colorMatrixP = f7256a.h(fDoubleValue);
                    colorMatrix.preConcat(colorMatrixP);
                    break;
                    break;
                case -566947070:
                    ...
                    colorMatrixP = f7256a.e(fDoubleValue);
                    colorMatrix.preConcat(colorMatrixP);
                    break;
                    break;
                case 109324790:
                    ...
                    colorMatrixP = f7256a.r(fDoubleValue);
                    colorMatrix.preConcat(colorMatrixP);
                    break;
                    break;
                case 648162385:
                    ...
                    colorMatrixP = f7256a.b(fDoubleValue);
                    colorMatrix.preConcat(colorMatrixP);
                    break;
                    break;
                case 650888307:
                    ...
                    colorMatrixP = f7256a.j(fDoubleValue);
                    colorMatrix.preConcat(colorMatrixP);
                    break;
                    break;
                default:
    ...
    public final RenderEffect g(float f3, float f4, float f5, int i3, RenderEffect renderEffect) {
        ...
        B.a();
        RenderEffect renderEffectCreateColorFilterEffect = RenderEffect.createColorFilterEffect(AbstractC0428y.a(i3, BlendMode.SRC_IN), renderEffectCreateOffsetEffect);
    ...
    public final RenderEffect u(ReadableMap readableMap, RenderEffect renderEffect) {
        ...
        return g(c0392f0.a(readableMap.getDouble("offsetX")), c0392f0.a(readableMap.getDouble("offsetY")), readableMap.hasKey("standardDeviation") ? x((float) readableMap.getDouble("standardDeviation")) : 0.0f, readableMap.hasKey("color") ? readableMap.getInt("color") : -16777216, renderEffect);
    }

    public final float x(float f3) {
        float fH = C0392f0.h(f3);
        if (fH > 0.5f) {
