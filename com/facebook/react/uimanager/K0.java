...
public class K0 {
    static Map a(V0 v3) {
        Map mapB = J0.b();
        mapB.put("ViewManagerNames", new ArrayList(v3.b()));
    ...
    public static Map d() {
        return p018e1.d.e("bubblingEventTypes", J0.a(), "directEventTypes", J0.c());
    }
