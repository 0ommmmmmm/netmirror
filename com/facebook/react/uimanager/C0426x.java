...
public final class C0426x {
    ...
    public static final C0426x f7635a = new C0426x();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static DisplayMetrics f7636b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static DisplayMetrics f7637c;
    ...
    public static final WritableMap a(double d4) {
        ...
        C0426x c0426x = f7635a;
        DisplayMetrics displayMetrics = f7636b;
        D2.h.d(displayMetrics, "null cannot be cast to non-null type android.util.DisplayMetrics");
        writableNativeMap.putMap("windowPhysicalPixels", c0426x.b(displayMetrics, d4));
        DisplayMetrics displayMetrics2 = f7637c;
        D2.h.d(displayMetrics2, "null cannot be cast to non-null type android.util.DisplayMetrics");
        writableNativeMap.putMap("screenPhysicalPixels", c0426x.b(displayMetrics2, d4));
    ...
    public static final DisplayMetrics c() {
        DisplayMetrics displayMetrics = f7637c;
