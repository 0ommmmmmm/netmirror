...
public final class C0381a {
    ...
    public static final C0381a f7441a = new C0381a();
    ...
    public static final void a(View view, Canvas canvas) {
        ...
        C0381a c0381a = f7441a;
        O1.g gVarF = c0381a.f(view);
        ...
        if (eVarD == null || !eVarD.c()) {
            ...
            Path pathB = c0381a.b(view, gVarF, rectF, rectFA);
    ...
    private final Path b(View view, O1.g gVar, RectF rectF, RectF rectF2) {
        ...
        if (eVarD != null) {
            ...
            Context context = view.getContext();
            D2.h.e(context, "getContext(...)");
            jVarD = eVarD.d(layoutDirection, context, C0392f0.f(gVar.getBounds().width()), C0392f0.f(gVar.getBounds().height()));
        } else {
            jVarD = null;
        }
        Path path = new Path();
        path.addRoundRect(rectF, new float[]{l((jVarD == null || (kVarC2 = jVarD.c()) == null) ? null : Float.valueOf(C0392f0.f7477a.b(kVarC2.a())), rectF2 != null ? Float.valueOf(C0392f0.f7477a.b(rectF2.left)) : null), l((jVarD == null || (kVarC = jVarD.c()) == null) ? null : Float.valueOf(C0392f0.f7477a.b(kVarC.b())), rectF2 != null ? Float.valueOf(C0392f0.f7477a.b(rectF2.top)) : null), l((jVarD == null || (kVarD2 = jVarD.d()) == null) ? null : Float.valueOf(C0392f0.f7477a.b(kVarD2.a())), rectF2 != null ? Float.valueOf(C0392f0.f7477a.b(rectF2.right)) : null), l((jVarD == null || (kVarD = jVarD.d()) == null) ? null : Float.valueOf(C0392f0.f7477a.b(kVarD.b())), rectF2 != null ? Float.valueOf(C0392f0.f7477a.b(rectF2.top)) : null), l((jVarD == null || (kVarB2 = jVarD.b()) == null) ? null : Float.valueOf(C0392f0.f7477a.b(kVarB2.a())), rectF2 != null ? Float.valueOf(C0392f0.f7477a.b(rectF2.right)) : null), l((jVarD == null || (kVarB = jVarD.b()) == null) ? null : Float.valueOf(C0392f0.f7477a.b(kVarB.b())), rectF2 != null ? Float.valueOf(C0392f0.f7477a.b(rectF2.bottom)) : null), l((jVarD == null || (kVarA2 = jVarD.a()) == null) ? null : Float.valueOf(C0392f0.f7477a.b(kVarA2.a())), rectF2 != null ? Float.valueOf(C0392f0.f7477a.b(rectF2.left)) : null), l((jVarD == null || (kVarA = jVarD.a()) == null) ? null : Float.valueOf(C0392f0.f7477a.b(kVarA.b())), rectF2 != null ? Float.valueOf(C0392f0.f7477a.b(rectF2.bottom)) : null)}, Path.Direction.CW);
        return path;
    }
    ...
    private final O1.c d(View view) {
        ...
        D2.h.e(context, "getContext(...)");
        R1.e eVarD = gVarF.d();
        O1.c cVar = new O1.c(context, new C0431z0(0.0f), eVarD, gVarF.c(), R1.f.SOLID);
    ...
    private final O1.k g(View view) {
        ...
        R1.e eVarD = p070r1.b.h() ? gVarF.d() : e(view).h();
        Context context = view.getContext();
        D2.h.e(context, "getContext(...)");
        O1.k kVar = new O1.k(context, eVarD, -16777216, 0.0f, R1.o.SOLID, 0.0f);
    ...
    public static final void n(View view, Integer num) {
        ...
        if (p070r1.b.h()) {
            f7441a.c(view).d(num != null ? num.intValue() : 0);
        } else {
            f7441a.e(view).C(num != null ? num.intValue() : 0);
        }
    }
    ...
    public static final void o(View view, List list) {
        D2.h.f(view, "view");
        if (p070r1.b.h()) {
            f7441a.c(view).e(list);
        } else {
            f7441a.e(view).v(list);
        }
    }
    ...
    public static final void p(View view, R1.n nVar, Integer num) {
        ...
        D2.h.f(nVar, "edge");
        if (p070r1.b.h()) {
            f7441a.d(view).o(nVar, num);
        } else {
            f7441a.e(view).x(nVar.b(), num);
        }
    }
    ...
    public static final void r(View view, R1.f fVar) {
        D2.h.f(view, "view");
        if (p070r1.b.h()) {
            f7441a.d(view).r(fVar);
        } else {
            f7441a.e(view).A(fVar);
        }
    }
    ...
    public static final void s(View view, R1.n nVar, Float f3) {
        ...
        if (p070r1.b.h()) {
            c0381a.d(view).s(nVar.b(), f3 != null ? C0392f0.f7477a.b(f3.floatValue()) : Float.NaN);
            O1.a aVarA = gVarF.a();
            if (aVarA != null) {
                aVarA.f(gVarF.c());
            }
            ...
            c0381a.e(view).B(nVar.b(), f3 != null ? C0392f0.f7477a.b(f3.floatValue()) : Float.NaN);
        }
        R1.c cVarC3 = gVarF.c();
        if (cVarC3 == null) {
            cVarC3 = new R1.c();
    ...
    public static final void t(View view, ReadableArray readableArray) {
        ...
        if (readableArray == null) {
            u(view, AbstractC0492n.g());
            return;
        }
        ArrayList arrayList = new ArrayList();
        int size = readableArray.size();
        for (int i3 = 0; i3 < size; i3++) {
            R1.g.a aVar = R1.g.f2034g;
    ...
    public static final void u(View view, List list) {
        ...
        view.setBackground(f7441a.f(view).q(arrayList2, arrayList));
    }

    public static final void v(View view, Drawable drawable) {
        D2.h.f(view, "view");
        if (p070r1.b.h()) {
            f7441a.f(view).o(drawable);
        } else {
            view.setBackground(f7441a.f(view).o(drawable));
        }
    }
    ...
    public static final void x(View view, float f3) {
        ...
        f7441a.g(view).g(C0392f0.f7477a.b(f3));
    }
    ...
    public static final void z(View view, float f3) {
        ...
        f7441a.g(view).i(C0392f0.f7477a.b(f3));
    }
}
