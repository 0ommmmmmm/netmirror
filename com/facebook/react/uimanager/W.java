...
public final class W {
    ...
    public static final a f7405c = new a(null);

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final float f7406a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final X f7407b;
    ...
    public static final class a {
        ...
        public final W a(Dynamic dynamic) {
            ...
            int i3 = C0110a.f7408a[dynamic.getType().ordinal()];
            if (i3 == 1) {
                double dAsDouble = dynamic.asDouble();
                if (dAsDouble >= 0.0d) {
                    return new W((float) dAsDouble, X.POINT);
                }
                return null;
            }
            if (i3 != 2) {
    ...
    public final float b(float f3) {
        return this.f7407b == X.PERCENT ? (this.f7406a / 100) * f3 : this.f7406a;
    }

    public final R1.k c(float f3, float f4) {
        if (this.f7407b != X.PERCENT) {
            float f5 = this.f7406a;
    ...
    public boolean equals(Object obj) {
        ...
        W w3 = (W) obj;
        return Float.compare(this.f7406a, w3.f7406a) == 0 && this.f7407b == w3.f7407b;
    }

    public int hashCode() {
        return (Float.hashCode(this.f7406a) * 31) + this.f7407b.hashCode();
    }

    public String toString() {
        return "LengthPercentage(value=" + this.f7406a + ", type=" + this.f7407b + ")";
    }
