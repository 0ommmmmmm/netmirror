...
@p086v1.a(name = UIManagerModule.NAME)
public class UIManagerModule extends ReactContextBaseJavaModule implements OnBatchCompleteListener, LifecycleEventListener, UIManager {
    static final /* synthetic */ boolean $assertionsDisabled = false;
    private static final boolean DEBUG = p037j0.c.a().a(p041k0.a.f9585g);
    ...
    class b extends GuardedRunnable {
        ...
        public void runGuarded() {
            UIManagerModule.this.mUIImplementation.U(this.f7398b, this.f7399c);
        }
    }
    ...
    class c extends GuardedRunnable {
        ...
        @Override // com.facebook.react.bridge.GuardedRunnable
        public void runGuarded() {
            UIManagerModule.this.mUIImplementation.Y(this.f7401b, this.f7402c, this.f7403d);
    ...
    public UIManagerModule(ReactApplicationContext reactApplicationContext, V0 v3, int i3) {
        super(reactApplicationContext);
        this.mMemoryTrimCallback = new e();
        this.mListeners = new ArrayList();
        this.mUIManagerListeners = new CopyOnWriteArrayList<>();
        this.mBatchId = 0;
        C0426x.f(reactApplicationContext);
        P1.e eVar = new P1.e(reactApplicationContext);
        this.mEventDispatcher = eVar;
        this.mModuleConstants = createConstants(v3);
        this.mCustomDirectEvents = J0.c();
        U0 u3 = new U0(v3);
        this.mViewManagerRegistry = u3;
        this.mUIImplementation = new G0(reactApplicationContext, u3, eVar, i3);
        reactApplicationContext.addLifecycleEventListener(this);
    }

    private static Map<String, Object> createConstants(V0 v3) {
        ReactMarker.logMarker(ReactMarkerConstants.CREATE_UI_MANAGER_MODULE_CONSTANTS_START);
        p015d2.b.a(0L, "CreateUIManagerConstants").b("Lazy", Boolean.TRUE).c();
        try {
            return K0.a(v3);
        } finally {
            p015d2.a.i(0L);
    ...
    public void addUIBlock(F0 f3) {
        this.mUIImplementation.a(f3);
    }
    ...
    @Deprecated
    public void addUIManagerListener(L0 l3) {
    ...
    public void createView(int i3, String str, int i4, ReadableMap readableMap) {
        if (DEBUG) {
            ...
            p037j0.c.a().c(p041k0.a.f9585g, str2);
        }
    ...
    public void findSubviewIn(int i3, ReadableArray readableArray, Callback callback) {
        this.mUIImplementation.o(i3, Math.round(C0392f0.g(readableArray.getDouble(0))), Math.round(C0392f0.g(readableArray.getDouble(1))), callback);
    }
    ...
    public void invalidateNodeLayout(int i3) {
        InterfaceC0414q0 interfaceC0414q0N = this.mUIImplementation.N(i3);
    ...
    public void manageChildren(int i3, ReadableArray readableArray, ReadableArray readableArray2, ReadableArray readableArray3, ReadableArray readableArray4, ReadableArray readableArray5) {
        if (DEBUG) {
            ...
            p037j0.c.a().c(p041k0.a.f9585g, str);
        }
    ...
    public void onBatchComplete() {
        ...
        this.mBatchId = i3 + 1;
        p015d2.b.a(0L, "onBatchCompleteUI").a("BatchId", i3).c();
    ...
    public void prependUIBlock(F0 f3) {
        this.mUIImplementation.F(f3);
    }
    ...
    @Deprecated
    public void removeUIManagerListener(L0 l3) {
        this.mListeners.remove(l3);
    }
    ...
    public void synchronouslyUpdateViewOnUIThread(int i3, ReadableMap readableMap) {
        this.mUIImplementation.V(i3, new C0417s0(readableMap));
    }
    ...
    public <T extends View> int addRootView(T t3, WritableMap writableMap) {
        p015d2.a.c(0L, "UIManagerModule.addRootView");
        int iA = C0412p0.a();
        this.mUIImplementation.H(t3, iA, new B0(getReactApplicationContext(), t3.getContext(), ((InterfaceC0410o0) t3).getSurfaceID(), -1));
        p015d2.a.i(0L);
        return iA;
    }
    ...
    public static WritableMap getConstantsForViewManager(ViewManager viewManager, Map<String, Object> map) {
        p015d2.b.a(0L, "UIManagerModule.getConstantsForViewManager").b("ViewManager", viewManager.getName()).b("Lazy", Boolean.TRUE).c();
        try {
    ...
    public static Map<String, Object> createConstants(List<ViewManager> list, Map<String, Object> map, Map<String, Object> map2) {
        ReactMarker.logMarker(ReactMarkerConstants.CREATE_UI_MANAGER_MODULE_CONSTANTS_START);
        p015d2.b.a(0L, "CreateUIManagerConstants").b("Lazy", Boolean.FALSE).c();
        try {
