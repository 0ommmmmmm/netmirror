...
public final class C0392f0 {
    ...
    public static final C0392f0 f7477a = new C0392f0();

    private C0392f0() {
    }

    public static final float c() {
        return C0426x.d().density;
    }
    ...
    public static final float h(float f3) {
        ...
        return TypedValue.applyDimension(1, f3, C0426x.d());
    }
    ...
    public static final float k(float f3, float f4) {
        ...
        DisplayMetrics displayMetricsD = C0426x.d();
