...
public final class U0 implements ComponentCallbacks2 {
    ...
    public U0(V0 v3) {
        this.f7393b = p018e1.d.b();
        this.f7394c = v3;
    }

    private ViewManager d(String str) {
        ViewManager viewManagerA = this.f7394c.a(str);
        if (viewManagerA != null) {
            this.f7393b.put(str, viewManagerA);
        }
        return viewManagerA;
    }
    ...
    public synchronized ViewManager c(String str) {
        try {
            ViewManager viewManager = (ViewManager) this.f7393b.get(str);
            if (viewManager != null) {
                return viewManager;
            }
            String str2 = "RCT" + str;
            ViewManager viewManager2 = (ViewManager) this.f7393b.get(str2);
            ...
            throw new P("ViewManagerResolver returned null for either " + str + " or " + str2 + ", existing names are: " + this.f7394c.b());
        } catch (Throwable th) {
            throw th;
        }
    }
    ...
    public void f() {
        ...
        synchronized (this) {
            arrayList = new ArrayList(this.f7393b.values());
        }
    ...
    public U0(Map<String, ViewManager> map) {
        this.f7393b = map == null ? p018e1.d.b() : map;
        this.f7394c = null;
    }
}
