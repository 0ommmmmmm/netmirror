...
public final class W {
    ...
    private static final a f6664b = new a(null);

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final M2.z f6665a;
    ...
    public static final class b implements InterfaceC0195f {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ p042k1.g f6666a;
    ...
    public W() {
        ...
        this.f6665a = aVar.e(5000L, timeUnit).M(0L, timeUnit).N(0L, timeUnit).b();
    }

    public final void a(String str, p042k1.g gVar) {
        D2.h.f(str, "host");
        D2.h.f(gVar, "callback");
        this.f6665a.b(new M2.B.a().m(f6664b.b(str)).b()).o(new b(gVar));
    }
