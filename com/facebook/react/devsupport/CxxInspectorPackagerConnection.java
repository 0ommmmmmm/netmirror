...
class CxxInspectorPackagerConnection implements M {
    ...
    private static class DelegateImpl {
        ...
        class a extends M2.I {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ WebSocketDelegate f6582a;
            ...
            class RunnableC0100a implements Runnable {
                ...
                public void run() {
                    String message = this.f6584b.getMessage();
                    WebSocketDelegate webSocketDelegate = a.this.f6582a;
                    if (message == null) {
            ...
            class b implements Runnable {
                ...
                @Override // java.lang.Runnable
                public void run() {
                    a.this.f6582a.didReceiveMessage(this.f6586b);
                }
            }
            ...
            class d implements Runnable {
                ...
                @Override // java.lang.Runnable
                public void run() {
                    a.this.f6582a.didClose();
                    a.this.f6582a.close();
                }
            }

            a(WebSocketDelegate webSocketDelegate) {
                this.f6582a = webSocketDelegate;
            }
        ...
        class b implements a {
            ...
            public void close() {
                this.f6590b.a(1000, "End of session");
            }
        }

        public a connectWebSocket(String str, WebSocketDelegate webSocketDelegate) {
            return new b(this.f6580a.D(new M2.B.a().m(str).b(), new a(webSocketDelegate)));
        }

        public void scheduleCallback(Runnable runnable, long j3) {
            this.f6581b.postDelayed(runnable, j3);
        }

        private DelegateImpl() {
            M2.z.a aVar = new M2.z.a();
            TimeUnit timeUnit = TimeUnit.SECONDS;
            this.f6580a = aVar.e(10L, timeUnit).N(10L, timeUnit).M(0L, TimeUnit.MINUTES).b();
            this.f6581b = new Handler(Looper.getMainLooper());
        }
    }
    ...
    private static class WebSocketDelegate implements Closeable {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final HybridData f6592b;

        private WebSocketDelegate(HybridData hybridData) {
            this.f6592b = hybridData;
        }

        @Override // java.io.Closeable, java.lang.AutoCloseable
        public void close() {
            this.f6592b.resetNative();
        }
