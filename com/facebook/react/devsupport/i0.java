...
public final class i0 implements p018e1.j {

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final a f6725e = new a(null);

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final p042k1.e f6726a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final K f6727b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private Dialog f6728c;
    ...
    public static final class a {
        ...
        public static final class C0104a implements LifecycleEventListener {
            ...
            /* JADX INFO: renamed from: b, reason: collision with root package name */
            final /* synthetic */ Runnable f6730b;

            /* JADX INFO: renamed from: c, reason: collision with root package name */
            final /* synthetic */ ReactContext f6731c;

            C0104a(Runnable runnable, ReactContext reactContext) {
                this.f6730b = runnable;
                this.f6731c = reactContext;
            }
            ...
            public void onHostResume() {
                this.f6730b.run();
                this.f6731c.removeLifecycleEventListener(this);
            }
        }
    ...
    public static final class b extends Dialog {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final C0257n0 b(int i3, View view, C0257n0 c0257n0) {
            D2.h.f(view, "view");
            D2.h.f(c0257n0, "windowInsetsCompat");
            androidx.core.graphics.b bVarF = c0257n0.f(i3);
        ...
        protected void onCreate(Bundle bundle) {
            ...
            final int iE = C0257n0.m.e() | C0257n0.m.a();
            g0 g0Var = this.f6732b.f6729d;
            if (g0Var == null) {
                throw new IllegalStateException("Required value was null.");
            }
        ...
        public boolean onKeyUp(int i3, KeyEvent keyEvent) {
            ...
            if (i3 == 82) {
                this.f6732b.f6726a.x();
                return true;
            }
            if (this.f6732b.f6727b.b(i3, getCurrentFocus())) {
                this.f6732b.f6726a.s();
            }
            return super.onKeyUp(i3, keyEvent);
        }
    }

    public i0(p042k1.e eVar) {
    ...
    @Override // p018e1.j
    public boolean a() {
        Dialog dialog = this.f6728c;
        return dialog != null && dialog.isShowing();
    }

    @Override // p018e1.j
    public void b() {
        String strL = this.f6726a.l();
        Activity activityI = this.f6726a.i();
        if (activityI == null || activityI.isFinishing()) {
            ReactContext reactContextC = this.f6726a.C();
            if (reactContextC != null) {
                f6725e.b(reactContextC, new Runnable() { // from class: com.facebook.react.devsupport.h0
        ...
        g0 g0Var = this.f6729d;
        if ((g0Var != null ? g0Var.getContext() : null) != activityI) {
            f(NativeRedBoxSpec.NAME);
        }
        g0 g0Var2 = this.f6729d;
        if (g0Var2 != null) {
            g0Var2.g();
        }
        if (this.f6728c == null) {
            b bVar = new b(activityI, this, AbstractC0466q.f9303c);
            bVar.requestWindowFeature(1);
            g0 g0Var3 = this.f6729d;
            if (g0Var3 == null) {
                throw new IllegalStateException("Required value was null.");
            }
    ...
    public void f(String str) {
        ...
        Activity activityI = this.f6726a.i();
        if (activityI != null && !activityI.isFinishing()) {
            g0 g0Var = new g0(activityI, this.f6726a, null);
            g0Var.d();
            this.f6729d = g0Var;
            return;
        }
