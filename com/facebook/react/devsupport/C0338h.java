...
public final class C0338h implements p042k1.c {

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final a f6718d = new a(null);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static boolean f6719e = true;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final c0 f6720a;
    ...
    public C0338h(c0 c0Var) {
        D2.h.f(c0Var, "reactInstanceDevHelper");
        this.f6720a = c0Var;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void g(C0338h c0338h) {
        c0338h.h();
    }

    private final void h() {
        PopupWindow popupWindow = this.f6722c;
    ...
    private final void i(String str) {
        PopupWindow popupWindow = this.f6722c;
        if (popupWindow == null || !popupWindow.isShowing()) {
            Activity activityI = this.f6720a.i();
            if (activityI == null) {
            ...
            try {
                ...
                View viewInflate = ((LayoutInflater) systemService).inflate(AbstractC0464o.f9257b, (ViewGroup) null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void j(C0338h c0338h, String str) {
        c0338h.i(str);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void k(Integer num, Integer num2, C0338h c0338h, String str) {
        String str2;
        ...
        TextView textView = c0338h.f6721b;
        if (textView != null) {
            if (str == null) {
                str = "Loading";
            }
