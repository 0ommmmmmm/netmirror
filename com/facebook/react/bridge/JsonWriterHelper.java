            ...
            try {
                switch (AnonymousClass1.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i3).ordinal()]) {
                    case 1:
                        ...
                        break;
                    case 2:
                        jsonWriter.value(readableArray.getBoolean(i3));
                        continue;
                        break;
                    case 3:
                        jsonWriter.value(readableArray.getDouble(i3));
                        continue;
                        break;
                    case 4:
                        jsonWriter.value(readableArray.getString(i3));
                        continue;
                        break;
                    case 5:
                        readableMapValue(jsonWriter, readableArray.getMap(i3));
                        continue;
                        break;
                    case 6:
                        readableArrayValue(jsonWriter, readableArray.getArray(i3));
                        continue;
                        break;
                    default:
                        throw new IllegalArgumentException("Unknown data type: " + readableArray.getType(i3));
                }
            } catch (Throwable th) {
                jsonWriter.endArray();
                throw th;
