...
public class ReadableNativeMap extends NativeMap implements ReadableMap {
    ...
    protected ReadableNativeMap() {
        ...
        this.keys$delegate = p071r2.d.b(gVar, new C2.a() { // from class: com.facebook.react.bridge.r
            @Override // C2.a
            public final Object a() {
                return ReadableNativeMap.keys_delegate$lambda$1(this.f6513b);
            }
        });
        this.localMap$delegate = p071r2.d.b(gVar, new C2.a() { // from class: com.facebook.react.bridge.s
            @Override // C2.a
            public final Object a() {
                return ReadableNativeMap.localMap_delegate$lambda$2(this.f6514b);
            }
        });
        this.localTypeMap$delegate = p071r2.d.b(gVar, new C2.a() { // from class: com.facebook.react.bridge.t
            @Override // C2.a
            public final Object a() {
                return ReadableNativeMap.localTypeMap_delegate$lambda$3(this.f6515b);
            }
        });
    }
    ...
    private final Object getValue(String str) {
        ...
        Object objC = p002a1.a.c(getLocalMap().get(str));
        ...
        for (String str : map.keySet()) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[getType(str2).ordinal()]) {
                ...
                case 4:
                    break;
                case 5:
                    map.put(str2, ((ReadableNativeMap) p002a1.a.c(getMap(str2))).toHashMap());
                    break;
                case 6:
                    map.put(str2, ((ReadableArray) p002a1.a.c(getArray(str2))).toArrayList());
                    break;
                default:
                    throw new p071r2.h();
            }
