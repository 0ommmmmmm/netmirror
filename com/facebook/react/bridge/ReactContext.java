...
public abstract class ReactContext extends ContextWrapper {
    ...
    public void assertOnJSQueueThread() {
        ((MessageQueueThread) p002a1.a.c(this.mJSMessageQueueThread)).assertIsOnThread();
    }
    ...
    public void assertOnNativeModulesQueueThread() {
        ...
        ((MessageQueueThread) p002a1.a.c(this.mNativeModulesMessageQueueThread)).assertIsOnThread();
    }

    public void assertOnUiQueueThread() {
        ((MessageQueueThread) p002a1.a.c(this.mUiMessageQueueThread)).assertIsOnThread();
    }
    ...
    public boolean isOnJSQueueThread() {
        return ((MessageQueueThread) p002a1.a.c(this.mJSMessageQueueThread)).isOnThread();
    }

    public boolean isOnNativeModulesQueueThread() {
        return ((MessageQueueThread) p002a1.a.c(this.mNativeModulesMessageQueueThread)).isOnThread();
    }

    public boolean isOnUiQueueThread() {
        return ((MessageQueueThread) p002a1.a.c(this.mUiMessageQueueThread)).isOnThread();
    }
    ...
    public boolean runOnJSQueueThread(Runnable runnable) {
        return ((MessageQueueThread) p002a1.a.c(this.mJSMessageQueueThread)).runOnQueue(runnable);
    }

    public void runOnNativeModulesQueueThread(Runnable runnable) {
        ((MessageQueueThread) p002a1.a.c(this.mNativeModulesMessageQueueThread)).runOnQueue(runnable);
    }

    public void runOnUiQueueThread(Runnable runnable) {
        ((MessageQueueThread) p002a1.a.c(this.mUiMessageQueueThread)).runOnQueue(runnable);
    }
    ...
    public void assertOnNativeModulesQueueThread(String str) {
        if (this.mIsInitialized) {
            ((MessageQueueThread) p002a1.a.c(this.mNativeModulesMessageQueueThread)).assertIsOnThread(str);
            return;
        }
