...
public class ReadableNativeArray extends NativeArray implements ReadableArray {
    ...
    protected ReadableNativeArray() {
        ...
        this.localArray$delegate = p071r2.d.b(gVar, new C2.a() { // from class: com.facebook.react.bridge.p
            @Override // C2.a
            public final Object a() {
                return ReadableNativeArray.localArray_delegate$lambda$0(this.f6507b);
            }
        });
        this.localTypeArray$delegate = p071r2.d.b(gVar, new C2.a() { // from class: com.facebook.react.bridge.q
            @Override // C2.a
            public final Object a() {
                return ReadableNativeArray.localTypeArray_delegate$lambda$1(this.f6508b);
            }
        });
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ReadableNativeArray) {
            return AbstractC0486h.c(getLocalArray(), ((ReadableNativeArray) obj).getLocalArray());
        }
        return false;
    }
