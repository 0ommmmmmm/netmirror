...
class JavaMethodWrapper implements JavaModuleWrapper.NativeMethod {
    ...
    private static final boolean DEBUG = p037j0.c.a().a(p041k0.a.f9583e);
    ...
    private ArgumentExtractor[] buildArgumentExtractors(Class[] clsArr) {
        ...
        while (jSArgumentsNeeded < clsArr.length) {
            ...
            if (cls == Boolean.class || cls == Boolean.TYPE) {
                ...
                p002a1.a.b(jSArgumentsNeeded == clsArr.length - 1, "Promise must be used as last parameter only");
    ...
    private String buildSignature(Method method, Class[] clsArr, boolean z3) {
        ...
        while (i3 < clsArr.length) {
            ...
            if (cls == Promise.class) {
                p002a1.a.b(i3 == clsArr.length - 1, "Promise must be used as last parameter only");
            }
    ...
    private int calculateJSArgumentsNeeded() {
        int jSArgumentsNeeded = 0;
        for (ArgumentExtractor argumentExtractor : (ArgumentExtractor[]) p002a1.a.c(this.mArgumentExtractors)) {
    ...
    private void processArguments() {
        ...
        p015d2.b.a(0L, "processArguments").b("method", this.mModuleWrapper.getName() + "." + this.mMethod.getName()).c();
        try {
    ...
    public String getSignature() {
        ...
        return (String) p002a1.a.c(this.mSignature);
    }
    ...
    public void invoke(JSInstance jSInstance, ReadableArray readableArray) {
        ...
        p015d2.b.a(0L, "callJavaModuleMethod").b("method", str).c();
        if (DEBUG) {
            p037j0.c.a().b(p041k0.a.f9583e, "JS->Java: %s.%s()", this.mModuleWrapper.getName(), this.mMethod.getName());
        }
        try {
            if (!this.mArgumentsProcessed) {
                processArguments();
