...
public final class WritableNativeMap extends ReadableNativeMap implements WritableMap {
    ...
    public void merge(ReadableMap readableMap) {
        ...
        p002a1.a.b(readableMap instanceof ReadableNativeMap, "Illegal type provided");
    ...
    public void putArray(String str, ReadableArray readableArray) {
        D2.h.f(str, "key");
        p002a1.a.b(readableArray == null || (readableArray instanceof ReadableNativeArray), "Illegal type provided");
    ...
    public void putMap(String str, ReadableMap readableMap) {
        D2.h.f(str, "key");
        p002a1.a.b(readableMap == null || (readableMap instanceof ReadableNativeMap), "Illegal type provided");
