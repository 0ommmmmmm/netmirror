...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public static class Builder {
        ...
        public CatalystInstanceImpl build() {
            return new CatalystInstanceImpl((ReactQueueConfigurationSpec) p002a1.a.c(this.mReactQueueConfigurationSpec), (JavaScriptExecutor) p002a1.a.c(this.mJSExecutor), (NativeModuleRegistry) p002a1.a.c(this.mRegistry), (JSBundleLoader) p002a1.a.c(this.mJSBundleLoader), (JSExceptionHandler) p002a1.a.c(this.mJSExceptionHandler), this.mInspectorTarget);
        }
    ...
    public void decrementPendingJSCalls() {
        ...
        p015d2.a.m(0L, this.mJsPendingCallsTitleForTrace, iDecrementAndGet);
        ...
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.g
            @Override // java.lang.Runnable
            public final void run() {
                this.f6505b.lambda$decrementPendingJSCalls$5();
            }
        });
    }
    ...
    private TurboModuleRegistry getTurboModuleRegistry() {
        if (p070r1.b.t()) {
            return (TurboModuleRegistry) p002a1.a.d(this.mTurboModuleRegistry, "TurboModules are enabled, but mTurboModuleRegistry hasn't been set.");
        }
        return null;
    }
    ...
    public void incrementPendingJSCalls() {
        ...
        p015d2.a.m(0L, this.mJsPendingCallsTitleForTrace, andIncrement + 1);
        if (!z3 || this.mBridgeIdleListeners.isEmpty()) {
            return;
        }
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.e
            @Override // java.lang.Runnable
            public final void run() {
                this.f6503b.lambda$incrementPendingJSCalls$4();
            }
        });
    }
    ...
    public void onNativeException(Exception exc) {
        ...
        this.mReactQueueConfiguration.getUIQueueThread().runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.c
            @Override // java.lang.Runnable
            public final void run() {
                this.f6501b.lambda$onNativeException$6();
            }
        });
    }
    ...
    public void lambda$onNativeException$6() {
        ...
        if (reactInstanceManagerInspectorTarget != null) {
            p002a1.a.b(reactInstanceManagerInspectorTarget.isValid(), "ReactInstanceManager inspector target destroyed before instance was unregistered");
        }
        ...
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.a
            @Override // java.lang.Runnable
            public final void run() {
                this.f6499b.lambda$destroy$2();
            }
        });
        p015d2.a.p(this.mTraceListener);
    }
    ...
    public void initialize() {
        ...
        p002a1.a.b(!this.mInitialized, "This catalyst instance has already been initialized");
        p002a1.a.b(this.mAcceptCalls, "RunJSBundle hasn't completed.");
        this.mInitialized = true;
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.f
            @Override // java.lang.Runnable
            public final void run() {
                this.f6504b.lambda$initialize$3();
            }
        });
    }
    ...
    public void runJSBundle() {
        ...
        p002a1.a.b(!this.mJSBundleHasLoaded, "JS bundle was already loaded!");
        ...
        p015d2.a.k(this.mTraceListener);
    }
    ...
    private CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, JSExceptionHandler jSExceptionHandler, ReactInstanceManagerInspectorTarget reactInstanceManagerInspectorTarget) {
        ...
        p015d2.a.c(0L, "createCatalystInstanceImpl");
        ...
        p015d2.a.c(0L, "initializeCxxBridge");
