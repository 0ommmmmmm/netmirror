...
public final class BridgelessCatalystInstance implements CatalystInstance {
    ...
    public CallInvokerHolder getJSCallInvokerHolder() {
        CallInvokerHolder callInvokerHolderI0 = this.f7055a.i0();
    ...
    public JavaScriptModule getJSModule(Class cls) {
        ...
        ReactContext reactContextF0 = this.f7055a.f0();
    ...
    public JavaScriptContextHolder getJavaScriptContextHolder() {
        JavaScriptContextHolder javaScriptContextHolderJ0 = this.f7055a.j0();
    ...
    public NativeModule getNativeModule(Class cls) {
        ...
        return this.f7055a.m0(cls);
    }

    @Override // com.facebook.react.bridge.CatalystInstance
    public Collection getNativeModules() {
        Collection collectionO0 = this.f7055a.o0();
    ...
    public ReactQueueConfiguration getReactQueueConfiguration() {
        ReactQueueConfiguration reactQueueConfigurationV0 = this.f7055a.v0();
