...
public class K extends M implements v0 {
    ...
    private static final Class f6023d = K.class;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final String[] f6024e = {"_id", "_data"};

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final String[] f6025f = {"_data"};

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final Rect f6026g = new Rect(0, 0, 512, 384);

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private static final Rect f6027h = new Rect(0, 0, 96, 96);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final ContentResolver f6028c;

    public K(Executor executor, p001a0.i iVar, ContentResolver contentResolver) {
        super(executor, iVar);
        this.f6028c = contentResolver;
    }

    private O0.j g(Uri uri, I0.g gVar) {
        Cursor cursorQuery;
        O0.j jVarJ;
        if (gVar == null || (cursorQuery = this.f6028c.query(uri, f6024e, null, null, null)) == null) {
            return null;
        }
        try {
    ...
    private static int i(String str) {
        ...
        try {
            ...
            Y.a.l(f6023d, e4, "Unable to retrieve thumbnail rotation for %s", str);
            return 0;
        }
    }
    ...
    private O0.j j(I0.g gVar, long j3) {
        ...
        int columnIndex;
        int iK = k(gVar);
        if (iK == 0 || (cursorQueryMiniThumbnail = MediaStore.Images.Thumbnails.queryMiniThumbnail(this.f6028c, j3, iK, f6025f)) == null) {
            return null;
        }
        try {
