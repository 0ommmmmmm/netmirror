...
public class C0304a implements e0 {
    ...
    private static class C0094a extends AbstractC0323u {
        ...
        private C0094a(InterfaceC0317n interfaceC0317n) {
            super(interfaceC0317n);
        }
    }

    public C0304a(e0 e0Var) {
        this.f6104a = e0Var;
    }

    @Override // com.facebook.imagepipeline.producers.e0
    public void b(InterfaceC0317n interfaceC0317n, f0 f0Var) {
        this.f6104a.b(new C0094a(interfaceC0317n), f0Var);
    }
}
