...
public final class C0324v {
    ...
    public static final C0324v f6261a = new C0324v();
    ...
    public static final H0.j a(U0.b bVar, H0.j jVar, H0.j jVar2, Map map) {
        ...
        if (bVar.c() == U0.b.EnumC0034b.SMALL) {
            return jVar;
        }
        if (bVar.c() == U0.b.EnumC0034b.DEFAULT) {
            return jVar2;
        }
        if (bVar.c() != U0.b.EnumC0034b.DYNAMIC || map == null || (strF = bVar.f()) == null) {
            return null;
        }
