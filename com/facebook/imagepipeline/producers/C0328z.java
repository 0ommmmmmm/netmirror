...
public class C0328z extends V {

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private final H0.k f6278f;

    public C0328z(H0.k kVar, boolean z3, e0 e0Var) {
    ...
    public Pair j(f0 f0Var) {
        return Pair.create(this.f6278f.c(f0Var.X(), f0Var.i()), f0Var.d0());
    }
}
