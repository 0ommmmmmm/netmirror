...
public final class c {
    ...
    public static final class a {
        ...
        public final boolean a(D d4, B b4) {
            ...
            h.f(b4, "request");
            int iA = d4.A();
            if (iA != 200 && iA != 410 && iA != 414 && iA != 501 && iA != 203 && iA != 204) {
                if (iA == 307) {
                    if (D.c0(d4, "Expires", null, 2, null) == null && d4.v().c() == -1 && !d4.v().b() && !d4.v().a()) {
                        return false;
                    }
                } else if (iA != 308 && iA != 404 && iA != 405) {
                    switch (iA) {
                        case 300:
                        case 301:
                            break;
                        case 302:
                            if (D.c0(d4, "Expires", null, 2, null) == null) {
                                return false;
                            }
                            break;
                        default:
            ...
            return (d4.v().h() || b4.b().h()) ? false : true;
        }
    ...
    public static final class b {
        ...
        private final long d() {
            ...
            C0193d c0193dV = d4.v();
            if (c0193dV.c() != -1) {
                return TimeUnit.SECONDS.toMillis(c0193dV.c());
            }
