...
abstract class b {
    ...
    private static class c implements Comparator {
        ...
        private final Rect f10929a = new Rect();

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final Rect f10930b = new Rect();
        ...
        public int compare(Object obj, Object obj2) {
            Rect rect = this.f10929a;
            Rect rect2 = this.f10930b;
            this.f10932d.a(obj, rect);
            this.f10932d.a(obj2, rect2);
            int i3 = rect.top;
            int i4 = rect2.top;
            if (i3 < i4) {
                return -1;
