...
public final class d {
    ...
    public static final class a {
        ...
        private final void b() {
            AbstractC0486h.k(this.f2469c, null, 0, 0, 6, null);
        ...
        public final List e() {
            List listE0 = AbstractC0492n.e0(this.f2467a);
            this.f2467a.clear();
            return listE0;
        }
    ...
    public static final class b {
        ...
        private final void b() {
            AbstractC0486h.k(this.f2478d, null, 0, 0, 6, null);
        ...
        public final void g(List list) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                b3.l lVarX = cVar.f2462b.x();
                b3.l lVar = cVar.f2463c;
                d dVar = d.f2466c;
                Integer num = (Integer) dVar.b().get(lVarX);
                if (num != null) {
                    ...
                    if (2 > length2 || 7 < length2) {
                        length = length2;
                        length2 = -1;
                    } else if (D2.h.b(dVar.c()[iIntValue].f2463c, lVar)) {
                        length = length2;
                    } else if (D2.h.b(dVar.c()[length2].f2463c, lVar)) {
                        length = length2;
                        length2 = iIntValue + 2;
                    } else {
                        length = length2;
                ...
                if (length2 == -1) {
                    int length3 = this.f2478d.length;
                    for (int i5 = this.f2479e + 1; i5 < length3; i5++) {
                        c cVar2 = this.f2478d[i5];
                        D2.h.c(cVar2);
                        if (D2.h.b(cVar2.f2462b, lVarX)) {
                            c cVar3 = this.f2478d[i5];
                            D2.h.c(cVar3);
                            if (D2.h.b(cVar3.f2463c, lVar)) {
                                length2 = d.f2466c.c().length + (i5 - this.f2479e);
                                break;
                            } else if (length == -1) {
                                length = (i5 - this.f2479e) + d.f2466c.c().length;
                            }
                        }
                    }
                }
                if (length2 != -1) {
                    ...
                    f(lVar);
                    d(cVar);
                } else if (!lVarX.w(c.f2454d) || D2.h.b(c.f2459i, lVarX)) {
                    h(length, 63, 64);
                    f(lVar);
                    d(cVar);
                } else {
