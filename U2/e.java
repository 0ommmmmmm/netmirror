...
public final class e {
    ...
    public static final b3.l f2485a = b3.l.f5640f.e("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    public final String a(int i3, int i4) {
        ...
        if (i3 != 2 && i3 != 3) {
            ...
            if (i3 != 7 && i3 != 8) {
                ...
                String str2 = str;
                if (i3 != 5 || (i4 & 4) == 0) {
                    return (i3 != 0 || (i4 & 32) == 0) ? str2 : o.v(str2, "PRIORITY", "COMPRESSED", false, 4, null);
                }
                return o.v(str2, "HEADERS", "PUSH_PROMISE", false, 4, null);
            }
        }
        return f2488d[i4];
    }
