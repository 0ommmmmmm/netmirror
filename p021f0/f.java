...
public class f {
    ...
    private static final Uri f9381a = Uri.withAppendedPath((Uri) a.e(ContactsContract.AUTHORITY_URI), "display_photo");
    ...
    public static boolean k(Uri uri) {
        return uri.getPath() != null && l(uri) && "com.android.contacts".equals(uri.getAuthority()) && !uri.getPath().startsWith((String) a.e(f9381a.getPath()));
    }
