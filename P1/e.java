...
public class e implements EventDispatcher, LifecycleEventListener {
    ...
    private final Map f1617f = p018e1.d.b();
    ...
    private class c implements Runnable {
        @Override // java.lang.Runnable
        public void run() {
            p015d2.a.c(0L, "DispatchEventsRunnable");
            try {
                p015d2.a.f(0L, "ScheduleDispatchFrameCallback", e.this.f1623l.getAndIncrement());
                e.this.f1628q = false;
                p002a1.a.c(e.this.f1626o);
    ...
    private class d implements Choreographer.FrameCallback {
        ...
        private void c() {
            com.facebook.react.modules.core.b.h().k(com.facebook.react.modules.core.b.a.TIMERS_EVENTS, e.this.f1622k);
        }
        ...
        public void doFrame(long j3) {
            ...
            p015d2.a.c(0L, "ScheduleDispatchFrameCallback");
            try {
                e.this.E();
                if (!e.this.f1628q) {
                    e.this.f1628q = true;
                    p015d2.a.l(0L, "ScheduleDispatchFrameCallback", e.this.f1623l.get());
    ...
    public void b(P1.d dVar) {
        p002a1.a.b(dVar.s(), "Dispatched event hasn't been initialized");
