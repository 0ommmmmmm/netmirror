...
public class n extends d {
    ...
    private static final p064q.f f1652o = new p064q.f(6);
    ...
    public static n C(String str, int i3, b bVar, MotionEvent motionEvent) {
        ...
        nVar.A(str, i3, bVar, (MotionEvent) p002a1.a.c(motionEvent), (short) 0);
        return nVar;
    }
    ...
    public static n D(String str, int i3, b bVar, MotionEvent motionEvent, short s3) {
        ...
        nVar.A(str, i3, bVar, (MotionEvent) p002a1.a.c(motionEvent), s3);
        return nVar;
    }
    ...
    private List x() {
        int actionIndex = this.f1653h.getActionIndex();
    ...
    private WritableMap y(int i3) {
        ...
        double dF = C0392f0.f(fArr[0]);
        double dF2 = C0392f0.f(fArr[1]);
        ...
        double dF3 = C0392f0.f(fArr2[0]);
        double dF4 = C0392f0.f(fArr2[1]);
        ...
        writableMapCreateMap.putDouble("offsetX", C0392f0.f(fArr3[0]));
        writableMapCreateMap.putDouble("offsetY", C0392f0.f(fArr3[1]));
        ...
        if (strE.equals("mouse") || B()) {
            ...
            double dF5 = C0392f0.f(this.f1653h.getTouchMajor(i3));
