...
public class k implements EventDispatcher, LifecycleEventListener {
    ...
    final class b implements Choreographer.FrameCallback {
        ...
        private final void b() {
            com.facebook.react.modules.core.b.f6917f.a().k(com.facebook.react.modules.core.b.a.TIMERS_EVENTS, k.this.f1643f);
        }
        ...
        public void doFrame(long j3) {
            ...
            p015d2.a.c(0L, "BatchEventDispatchedListeners");
            try {
    ...
    private final void q(d dVar) {
        p015d2.a.c(0L, "FabricEventDispatcher.dispatchSynchronous('" + dVar.k() + "')");
        try {
