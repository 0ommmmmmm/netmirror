...
public final class c extends Drawable {
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[R1.f.DASHED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[R1.f.DOTTED.ordinal()] = 3;
    ...
    public c(Context context, C0431z0 c0431z0, R1.e eVar, R1.c cVar, R1.f fVar) {
    ...
    private final RectF b() {
        ...
        return new RectF(Float.isNaN(rectFA.left) ? 0.0f : C0392f0.f7477a.b(rectFA.left), Float.isNaN(rectFA.top) ? 0.0f : C0392f0.f7477a.b(rectFA.top), Float.isNaN(rectFA.right) ? 0.0f : C0392f0.f7477a.b(rectFA.right), Float.isNaN(rectFA.bottom) ? 0.0f : C0392f0.f7477a.b(rectFA.bottom));
    }
        ...
        if (iC > 0 || iC3 > 0 || iC2 > 0 || iC4 > 0) {
            ...
            if (iF == 0) {
                ...
                if (iC > 0) {
                    ...
                    float f5 = i3 + iC;
                    int i5 = i4 + iHeight;
                    c(canvas, this.f1503g.b(), f3, f4, f5, i4 + iC2, f5, i5 - iC4, f3, i5);
                }
                if (iC2 > 0) {
                    float f6 = i3;
                    float f7 = i4;
                    ...
                    float f9 = i4 + iC2;
                    int i6 = i3 + iWidth;
                    c(canvas, this.f1503g.d(), f6, f7, f8, f9, i6 - iC3, f9, i6, f7);
                }
                if (iC3 > 0) {
                    int i7 = i3 + iWidth;
                    float f10 = i7;
                    ...
                    int i8 = i4 + iHeight;
                    float f12 = i7 - iC3;
                    c(canvas, this.f1503g.c(), f10, f11, f10, i8, f12, i8 - iC4, f12, i4 + iC2);
                }
                if (iC4 > 0) {
                    float f13 = i3;
                    int i9 = i4 + iHeight;
                    ...
                    int i10 = i3 + iWidth;
                    float f15 = i9 - iC4;
                    c(canvas, this.f1503g.a(), f13, f14, i10, f14, i10 - iC3, f15, i3 + iC, f15);
                }
            ...
            if (Color.alpha(iF) != 0) {
                ...
                if (iC3 > 0) {
                    ...
                    if (path10 != null) {
                        path10.moveTo(i11 - (iC7 / 2), i4);
                    }
                    Path path11 = this.f1510n;
                    if (path11 != null) {
                        path11.lineTo(i11 - (iC7 / 2), i12);
                    }
                ...
                if (iC4 > 0) {
                    ...
                    if (path14 != null) {
                        path14.moveTo(i3, i12 - (iC8 / 2));
                    }
                    Path path15 = this.f1510n;
                    if (path15 != null) {
                        path15.lineTo(i11, i12 - (iC8 / 2));
                    }
    ...
    private final void e(Canvas canvas) {
        ...
        if (rectFB.top > 0.0f || rectFB.bottom > 0.0f || rectFB.left > 0.0f || rectFB.right > 0.0f) {
            ...
            if (rectFB.top != fJ || rectFB.bottom != fJ || rectFB.left != fJ || rectFB.right != fJ || this.f1503g.b() != iG || this.f1503g.d() != iG || this.f1503g.c() != iG || this.f1503g.a() != iG) {
                ...
                PointF pointF3 = this.f1517u;
                if (pointF3 == null) {
                    throw new IllegalStateException("Required value was null.");
                }
                PointF pointF4 = this.f1518v;
                if (pointF4 == null) {
                    throw new IllegalStateException("Required value was null.");
                }
                PointF pointF5 = this.f1515s;
                if (pointF5 == null) {
                    throw new IllegalStateException("Required value was null.");
                }
                PointF pointF6 = this.f1516t;
                if (pointF6 == null) {
                    throw new IllegalStateException("Required value was null.");
                }
                if (rectFB.left > 0.0f) {
                    float f7 = this.f1506j;
                    c(canvas, this.f1503g.b(), f3, f5 - f7, pointF3.x, pointF3.y - f7, pointF5.x, pointF5.y + f7, f3, f6 + f7);
                }
                if (rectFB.top > 0.0f) {
                    float f8 = this.f1506j;
                    pointF = pointF4;
                    c(canvas, this.f1503g.d(), f3 - f8, f5, pointF3.x - f8, pointF3.y, pointF4.x + f8, pointF4.y, f4 + f8, f5);
                } else {
                    pointF = pointF4;
                }
                if (rectFB.right > 0.0f) {
                    float f9 = this.f1506j;
                    PointF pointF7 = pointF;
                    pointF2 = pointF6;
                    c(canvas, this.f1503g.c(), f4, f5 - f9, pointF7.x, pointF7.y - f9, pointF6.x, pointF6.y + f9, f4, f6 + f9);
                } else {
                    pointF2 = pointF6;
                }
                if (rectFB.bottom > 0.0f) {
                    ...
                    c(canvas, this.f1503g.a(), f3 - f10, f6, pointF5.x - f10, pointF5.y, pointF8.x + f10, pointF8.y, f4 + f10, f6);
                }
            } else if (fJ > 0.0f) {
    ...
    private final float j() {
        C0431z0 c0431z0 = this.f1498b;
        float fB = c0431z0 != null ? c0431z0.b(8) : Float.NaN;
        if (Float.isNaN(fB)) {
            return 0.0f;
        }
        return fB;
    ...
    private final void t() {
        ...
        if (this.f1509m) {
            ...
            if (eVar != null) {
                ...
                float fD = rectF9 != null ? C0392f0.f7477a.d(rectF9.width()) : 0.0f;
                RectF rectF10 = this.f1520x;
                jVarD = eVar.d(layoutDirection, context, fD, rectF10 != null ? C0392f0.f7477a.d(rectF10.height()) : 0.0f);
            } else {
                jVarD = null;
            }
            this.f1504h = jVarD;
    ...
    public int getOpacity() {
        if (p083u2.a.d(Color.alpha(n(this.f1503g.b(), this.f1505i)), Color.alpha(n(this.f1503g.d(), this.f1505i)), Color.alpha(n(this.f1503g.c(), this.f1505i)), Color.alpha(n(this.f1503g.a(), this.f1505i))) == 0) {
            return -2;
        }
        return p083u2.a.e(Color.alpha(n(this.f1503g.b(), this.f1505i)), Color.alpha(n(this.f1503g.d(), this.f1505i)), Color.alpha(n(this.f1503g.c(), this.f1505i)), Color.alpha(n(this.f1503g.a(), this.f1505i))) == 255 ? -1 : -3;
    }
    ...
    public final void s(int i3, float f3) {
        C0431z0 c0431z0 = this.f1498b;
        if (L.b(c0431z0 != null ? Float.valueOf(c0431z0.b(i3)) : null, Float.valueOf(f3))) {
            return;
        }
        C0431z0 c0431z1 = this.f1498b;
        if (c0431z1 != null) {
            c0431z1.c(i3, f3);
        }
