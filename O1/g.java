...
public final class g extends LayerDrawable {
    ...
    public static final class a {
        ...
        public final Drawable[] b(Drawable drawable, List list, e eVar, O1.a aVar, c cVar, Drawable drawable2, List list2, k kVar) {
            ...
            arrayList.addAll(AbstractC0492n.B(list));
            if (eVar != null) {
                arrayList.add(eVar);
            }
            if (aVar != null) {
            ...
            arrayList.addAll(AbstractC0492n.B(list2));
            if (kVar != null) {
                arrayList.add(kVar);
            }
    ...
    public /* synthetic */ g(Context context, Drawable drawable, List list, e eVar, O1.a aVar, c cVar, Drawable drawable2, List list2, k kVar, R1.c cVar2, R1.e eVar2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i3 & 2) != 0 ? null : drawable, (i3 & 4) != 0 ? AbstractC0492n.g() : list, (i3 & 8) != 0 ? null : eVar, (i3 & 16) != 0 ? null : aVar, (i3 & 32) != 0 ? null : cVar, (i3 & 64) != 0 ? null : drawable2, (i3 & 128) != 0 ? AbstractC0492n.g() : list2, (i3 & 256) != 0 ? null : kVar, (i3 & 512) != 0 ? null : cVar2, (i3 & 1024) == 0 ? eVar2 : null);
    }
    ...
    public void getOutline(Outline outline) {
        ...
        if (jVarD != null) {
            ...
            path.addRoundRect(rectF, new float[]{c0392f0.b(jVarD.c().a() + (rectFA != null ? rectFA.left : 0.0f)), c0392f0.b(jVarD.c().b() + (rectFA != null ? rectFA.top : 0.0f)), c0392f0.b(jVarD.d().a() + (rectFA != null ? rectFA.right : 0.0f)), c0392f0.b(jVarD.d().b() + (rectFA != null ? rectFA.top : 0.0f)), c0392f0.b(jVarD.b().a() + (rectFA != null ? rectFA.right : 0.0f)), c0392f0.b(jVarD.b().b() + (rectFA != null ? rectFA.bottom : 0.0f)), c0392f0.b(jVarD.a().a() + (rectFA != null ? rectFA.left : 0.0f)), c0392f0.b(jVarD.a().b() + (rectFA != null ? rectFA.bottom : 0.0f))}, Path.Direction.CW);
        }
