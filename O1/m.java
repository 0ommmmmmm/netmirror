...
public final class m extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float fD = c0392f0.d(getBounds().width());
        float fD2 = c0392f0.d(getBounds().height());
        R1.e eVar = this.f1594g;
        R1.j jVar = (eVar == null || (jVarD = eVar.d(getLayoutDirection(), this.f1588a, fD, fD2)) == null) ? null : new R1.j(new R1.k(c0392f0.b(jVarD.c().a()), c0392f0.b(jVarD.c().b())), new R1.k(c0392f0.b(jVarD.d().a()), c0392f0.b(jVarD.d().b())), new R1.k(c0392f0.b(jVarD.a().a()), c0392f0.b(jVarD.a().b())), new R1.k(c0392f0.b(jVarD.b().a()), c0392f0.b(jVarD.b().b())));
        float fB = c0392f0.b(this.f1593f);
        RectF rectF = new RectF(getBounds());
        float f3 = -fB;
        rectF.inset(f3, f3);
        rectF.offset(c0392f0.b(this.f1590c), c0392f0.b(this.f1591d));
