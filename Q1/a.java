...
abstract class a {
    ...
    private static final Map f1799e = p018e1.d.g(d.LINEAR, new LinearInterpolator(), d.EASE_IN, new AccelerateInterpolator(), d.EASE_OUT, new DecelerateInterpolator(), d.EASE_IN_EASE_OUT, new AccelerateDecelerateInterpolator());
    ...
    private static Interpolator c(d dVar, ReadableMap readableMap) {
        Interpolator nVar = dVar.equals(d.SPRING) ? new n(n.a(readableMap)) : (Interpolator) f1799e.get(dVar);
        if (nVar != null) {
            return nVar;
        }
