...
public final class e {
    ...
    private static final Lazy f2802b = p071r2.d.a(new C2.a() { // from class: Z0.b
        @Override // C2.a
    ...
    public static final p064q.f b() {
        return new p064q.f(12);
    }

    private final ByteBuffer c() {
        return f2803c ? p001a0.b.f2850a.b() : (ByteBuffer) g().b();
    }
    ...
    public static final g e(InputStream inputStream) {
        ...
        try {
            options.inTempStorage = byteBufferK.array();
            eVar.f(inputStream, null, options);
            return new g(options.outWidth, options.outHeight, Build.VERSION.SDK_INT >= 26 ? options.outColorSpace : null);
        } finally {
            f2801a.l(byteBufferK);
        }
    }

    private final p064q.f g() {
        return (p064q.f) f2802b.getValue();
    }
