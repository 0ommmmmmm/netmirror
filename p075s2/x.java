...
public class x extends w {
    ...
    public static final class a implements c {
        ...
        final /* synthetic */ Iterable f10634a;
    ...
    public static c H(Iterable iterable) {
        h.f(iterable, "<this>");
    ...
    public static List K(List list, int i3) {
        h.f(list, "<this>");
        if (i3 >= 0) {
            return AbstractC0492n.b0(list, d.c(list.size() - i3, 0));
        }
    ...
    public static final Object M(Iterable iterable) {
        ...
        if (iterable instanceof List) {
            return AbstractC0492n.N((List) iterable);
        }
        Iterator it = iterable.iterator();
        if (it.hasNext()) {
            return it.next();
    ...
    public static final Appendable P(Iterable iterable, Appendable appendable, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i3, CharSequence charSequence4, l lVar) throws IOException {
        h.f(iterable, "<this>");
    ...
    public static final String R(Iterable iterable, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i3, CharSequence charSequence4, l lVar) {
        h.f(iterable, "<this>");
        h.f(charSequence, "separator");
        h.f(charSequence2, "prefix");
        h.f(charSequence3, "postfix");
    ...
    public static /* synthetic */ String S(Iterable iterable, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i3, CharSequence charSequence4, l lVar, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            charSequence = ", ";
        }
    ...
    public static Object T(List list) {
        ...
        return list.get(AbstractC0492n.i(list));
    }
    ...
    public static List W(Collection collection, Iterable iterable) {
        ...
        if (!(iterable instanceof Collection)) {
            ...
            AbstractC0492n.t(arrayList, iterable);
            return arrayList;
        }
    ...
    public static List Y(Iterable iterable) {
        ...
        if ((iterable instanceof Collection) && ((Collection) iterable).size() <= 1) {
            return AbstractC0492n.e0(iterable);
        }
    ...
    public static List b0(Iterable iterable, int i3) {
        ...
        if (iterable instanceof Collection) {
            ...
            if (i3 == 1) {
                return AbstractC0492n.b(M(iterable));
            }
        }
    ...
    public static List e0(Iterable iterable) {
        ...
        if (size != 1) {
            return AbstractC0492n.g0(collection);
        }
        return AbstractC0492n.b(iterable instanceof List ? ((List) iterable).get(0) : iterable.iterator().next());
    }

    public static final List f0(Iterable iterable) {
        h.f(iterable, "<this>");
        return iterable instanceof Collection ? AbstractC0492n.g0((Collection) iterable) : (List) c0(iterable, new ArrayList());
    }
    ...
    public static Set h0(Iterable iterable) {
        ...
        if (size != 1) {
            return (Set) c0(iterable, new LinkedHashSet((int) DebugProbesKt.probeCoroutineCreated(collection.size())));
        }
    ...
    public static List i0(Iterable iterable, Iterable iterable2) {
        ...
        ArrayList arrayList = new ArrayList(Math.min(AbstractC0492n.q(iterable, 10), AbstractC0492n.q(iterable2, 10)));
