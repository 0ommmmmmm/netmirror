...
public class C0490l extends C0489k {
    ...
    public static List B(Object[] objArr) {
        ...
        if (length != 0) {
            return length != 1 ? AbstractC0486h.C(objArr) : AbstractC0492n.b(objArr[0]);
        }
    ...
    public static List m(Object[] objArr) {
        h.f(objArr, "<this>");
        return (List) AbstractC0486h.n(objArr, new ArrayList());
    }
    ...
    public static c o(byte[] bArr) {
        h.f(bArr, "<this>");
        return new c(0, q(bArr));
    }

    public static c p(Object[] objArr) {
        h.f(objArr, "<this>");
        return new c(0, AbstractC0486h.r(objArr));
    }
    ...
    public static final Appendable u(int[] iArr, Appendable appendable, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i3, CharSequence charSequence4, l lVar) throws IOException {
        h.f(iArr, "<this>");
    ...
    public static final String v(int[] iArr, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i3, CharSequence charSequence4, l lVar) {
        h.f(iArr, "<this>");
        h.f(charSequence, "separator");
        h.f(charSequence2, "prefix");
        h.f(charSequence3, "postfix");
    ...
    public static /* synthetic */ String w(int[] iArr, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i3, CharSequence charSequence4, l lVar, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            charSequence = ", ";
        }
    ...
    public static Object x(Object[] objArr) {
        h.f(objArr, "<this>");
        if (objArr.length != 0) {
            return objArr[AbstractC0486h.r(objArr)];
        }
    ...
    public static Comparable y(Comparable[] comparableArr) {
        ...
        int iR = AbstractC0486h.r(comparableArr);
        int i3 = 1;
        if (1 <= iR) {
            while (true) {
