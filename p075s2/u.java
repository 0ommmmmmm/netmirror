...
public class u extends t {
    ...
    public static boolean u(Collection collection, Object[] objArr) {
        h.f(collection, "<this>");
        h.f(objArr, "elements");
        return collection.addAll(AbstractC0486h.d(objArr));
    }

    private static final boolean v(Iterable iterable, l lVar, boolean z3) {
        Iterator it = iterable.iterator();
        boolean z4 = false;
        while (it.hasNext()) {
    ...
    private static final boolean w(List list, l lVar, boolean z3) {
        int i3;
        if (!(list instanceof RandomAccess)) {
            ...
            return v(v.a(list), lVar, z3);
        }
        int i4 = AbstractC0492n.i(list);
        if (i4 >= 0) {
            int i5 = 0;
            i3 = 0;
            while (true) {
    ...
    public static boolean x(List list, l lVar) {
        h.f(list, "<this>");
        h.f(lVar, "predicate");
