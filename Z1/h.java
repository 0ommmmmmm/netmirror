...
public final class h extends CharacterStyle implements UpdateAppearance, i {
    ...
    public void updateDrawState(TextPaint textPaint) {
        ...
        int i3 = textPaint.bgColor;
        if (i3 != 0) {
            textPaint.bgColor = Color.argb(F2.a.c(Color.alpha(i3) * this.f2828a), Color.red(textPaint.bgColor), Color.green(textPaint.bgColor), Color.blue(textPaint.bgColor));
        }
    }
}
