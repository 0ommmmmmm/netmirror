...
public class a {
    ...
    public static final class C0045a {
        ...
        public final a a(Context context) {
            h.f(context, "context");
            return new a(context, "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=", 0.0d, 0.0d, E1.a.DEFAULT, 12, null);
        }
    ...
    public /* synthetic */ a(Context context, String str, double d4, double d5, E1.a aVar, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str, (i3 & 4) != 0 ? 0.0d : d4, (i3 & 8) != 0 ? 0.0d : d5, (i3 & 16) != 0 ? E1.a.DEFAULT : aVar);
    }
}
