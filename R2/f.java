...
public final class f extends U2.f.d implements M2.j {
    ...
    static final class c extends D2.i implements C2.a {
        ...
        public final List a() {
            ...
            ArrayList arrayList = new ArrayList(AbstractC0492n.q(listD, 10));
    ...
    public static final class d extends a3.d.AbstractC0048d {
    ...
    private final void F(int i3) throws SocketException {
        ...
        U2.f fVarA = new U2.f.b(true, Q2.e.f1870h).m(socket, this.f2175s.a().l().h(), kVar, jVar).k(this).l(i3).a();
        this.f2163g = fVarA;
    ...
    /* JADX WARN: Code duplicated, block: B:75:0x014e A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:76:0x014e A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:77:? A[LOOP:0: B:71:0x009a->B:77:?, LOOP_END, SYNTHETIC] */
    public final void f(int i3, int i4, int i5, int i6, boolean z3, InterfaceC0194e interfaceC0194e, r rVar) throws Throwable {
        Socket socket;
        Socket socket2;
        ...
        List listB = this.f2175s.a().b();
        R2.b bVar = new R2.b(listB);
        if (this.f2175s.a().k() == null) {
            if (!listB.contains(l.f1169j)) {
                throw new j(new UnknownServiceException("CLEARTEXT communication not enabled for client"));
            }
            String strH = this.f2175s.a().l().h();
            if (!W2.j.f2732c.g().j(strH)) {
                throw new j(new UnknownServiceException("CLEARTEXT communication to " + strH + " not permitted by network security policy"));
            }
        } else if (this.f2175s.a().f().contains(A.H2_PRIOR_KNOWLEDGE)) {
        ...
        while (true) {
            try {
                if (this.f2175s.c()) {
                    j(i3, i4, i5, interfaceC0194e, rVar);
                    if (this.f2159c == null) {
                        break;
                    }
                } else {
                    try {
                        ...
                        this.f2163g = null;
                        this.f2171o = 1;
                        rVar.i(interfaceC0194e, this.f2175s.d(), this.f2175s.b(), null, e);
                        if (jVar == null) {
                            jVar = new j(e);
                        } else {
                            jVar.a(e);
                ...
                try {
                    m(bVar, i6, interfaceC0194e, rVar);
                    rVar.h(interfaceC0194e, this.f2175s.d(), this.f2175s.b(), this.f2162f);
                    break;
        ...
        if (this.f2175s.c() && this.f2159c == null) {
    ...
    public final a3.d.AbstractC0048d x(R2.c cVar) throws SocketException {
