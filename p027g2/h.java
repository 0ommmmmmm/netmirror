...
public abstract class h implements View.OnTouchListener {
    ...
    private final Rect f9438e = new Rect();
    ...
    class a implements View.OnLayoutChangeListener {
        ...
        public /* synthetic */ void d(float f3, int i3, float f4, View view) {
            h.this.u();
            float f5 = h.this.f9439f * f3;
            float f6 = i3 / 2.0f;
            h.this.w(Math.max((int) (f5 - f6), 0), Math.max((int) ((h.this.f9440g * f4) - f6), 0));
        ...
        public void onLayoutChange(final View view, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10) {
            ...
            final float f3 = this.f9445b;
            final int i11 = this.f9446c;
            final float f4 = this.f9447d;
            view.postDelayed(new Runnable() { // from class: g2.f
                @Override // java.lang.Runnable
                public final void run() {
                    this.f9429b.d(f3, i11, f4, view);
                }
            }, this.f9448e);
        }
    }
    ...
    public Rect h() {
        Window window;
        Context contextH = this.f9435b.h();
    ...
    public void r() {
        ...
        int i3 = this.f9441h - this.f9443j;
        int i4 = this.f9442i - this.f9444k;
        float fG = g();
        float f4 = i3;
        float f5 = 1.0f;
        if (f4 <= fG) {
            ...
            f3 = ((float) Math.abs(this.f9439f - (i3 + width))) < fG ? 1.0f : (f4 + (width / 2.0f)) / this.f9439f;
        }
        float f6 = i4;
        if (f6 <= fG) {
            f5 = 0.0f;
        } else if (Math.abs(this.f9440g - (i4 + height)) >= fG) {
            f5 = (f6 + (height / 2.0f)) / this.f9440g;
        }
        View viewE = e();
        if (viewE == null) {
            return;
        }
        viewE.addOnLayoutChangeListener(new a(f3, width, f5, 100L));
    }
    ...
    public void u() {
        ...
        viewE.getWindowVisibleDisplayFrame(this.f9438e);
        Rect rect = this.f9438e;
        int i3 = rect.right;
        int i4 = rect.left;
        this.f9439f = i3 - i4;
        int i5 = rect.bottom;
    ...
    public void v(p023f2.h hVar) {
        this.f9435b = hVar;
        View viewI = hVar.i();
        this.f9436c = viewI;
        viewI.setOnTouchListener(this);
        this.f9436c.post(new Runnable() { // from class: g2.e
            @Override // java.lang.Runnable
            public final void run() {
                this.f9428b.q();
            }
    ...
    public void y(int i3, int i4, boolean z3) {
        ...
        int iK = this.f9435b.k();
        int iJ = this.f9435b.j();
        int iM = m();
        int iJ2 = j();
        if (i3 < rectH.left - l()) {
            i3 = rectH.left - l();
    ...
    public void z(int i3, int i4) {
        WindowManager.LayoutParams layoutParamsL = this.f9435b.l();
