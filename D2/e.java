...
public final class e implements I2.b, d {
    ...
    /* JADX WARN: Type inference failed for: r2v14, types: [int, kotlin.coroutines.Continuation] */
    /* JADX WARN: Type inference failed for: r2v15, types: [int, kotlin.coroutines.Continuation] */
    static {
        List listJ = AbstractC0492n.j(C2.a.class, C2.l.class, C2.p.class, C2.q.class, C2.r.class, C2.s.class, C2.t.class, C2.u.class, C2.v.class, w.class, C2.b.class, C2.c.class, C2.d.class, C2.e.class, C2.f.class, C2.g.class, C2.h.class, C2.i.class, C2.j.class, C2.k.class, C2.m.class, C2.n.class, C2.o.class);
        ArrayList arrayList = new ArrayList(AbstractC0492n.q(listJ, 10));
        int i3 = 0;
        for (Object obj : listJ) {
            ...
            arrayList.add(p071r2.n.a((Class) obj, Integer.valueOf(i3)));
            i3 = i4;
        }
        f175c = D.m(arrayList);
        ...
        for (String str : collectionValues) {
            ...
            p071r2.i iVarA = p071r2.n.a(sb.toString(), str + ".Companion");
        ...
        f178f = map3;
        LinkedHashMap linkedHashMap = new LinkedHashMap((int) DebugProbesKt.probeCoroutineCreated(map3.size()));
