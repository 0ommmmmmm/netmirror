...
abstract class f {
    ...
    final class a implements Iterator {
        ...
        boolean f9645e = false;

        a(int i3) {
            this.f9642b = i3;
            this.f9643c = f.this.d();
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            return this.f9644d < this.f9643c;
        }
        ...
        public Object next() {
            ...
            Object objB = f.this.b(this.f9644d, this.f9642b);
            this.f9644d++;
            this.f9645e = true;
            return objB;
        }
    ...
    final class b implements Set {
        ...
        public boolean contains(Object obj) {
            ...
            return p044l.c.c(f.this.b(iE, 1), entry.getValue());
        }
    ...
    final class d implements Iterator, Map.Entry {
        ...
        public boolean equals(Object obj) {
            ...
            Map.Entry entry = (Map.Entry) obj;
            return p044l.c.c(entry.getKey(), f.this.b(this.f9650c, 0)) && p044l.c.c(entry.getValue(), f.this.b(this.f9650c, 1));
        }

        @Override // java.util.Map.Entry
        public Object getKey() {
            if (this.f9651d) {
                return f.this.b(this.f9650c, 0);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        @Override // java.util.Iterator
        public boolean hasNext() {
            return this.f9650c < this.f9649b;
        }
        ...
        public int hashCode() {
            ...
            Object objB = f.this.b(this.f9650c, 0);
            Object objB2 = f.this.b(this.f9650c, 1);
        ...
        public Object setValue(Object obj) {
            if (this.f9651d) {
                return f.this.i(this.f9650c, obj);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
