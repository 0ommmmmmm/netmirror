...
public final class a implements c.b {
    ...
    public static final class C0002a {
        ...
        public final c l(byte[] bArr, int i3) {
            if (!p025g0.b.h(bArr, 0, i3)) {
                throw new IllegalStateException("Check failed.");
            }
            if (p025g0.b.g(bArr, 0)) {
                return b.f140g;
            }
            if (p025g0.b.f(bArr, 0)) {
                return b.f141h;
            }
            if (!p025g0.b.c(bArr, 0, i3)) {
                return c.f151d;
            }
            if (p025g0.b.b(bArr, 0)) {
                return b.f144k;
            }
            return p025g0.b.d(bArr, 0) ? b.f143j : b.f142i;
        }
    ...
    public a() {
        Object objY = AbstractC0486h.y(new Integer[]{21, 20, Integer.valueOf(f116d), Integer.valueOf(f118f), 6, Integer.valueOf(f122j), Integer.valueOf(f124l), 12, 4, 12});
        if (objY == null) {
    ...
    public c b(byte[] bArr, int i3) {
        ...
        return c0002a.p(bArr, i3) ? b.f146m : c.f151d;
    }
}
