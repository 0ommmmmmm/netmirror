...
public class y extends x {
    ...
    static final class a extends D2.i implements C2.p {
        ...
        public final p071r2.i e(CharSequence charSequence, int i3) {
            D2.h.f(charSequence, "$this$$receiver");
            int iP = y.P(charSequence, this.f858c, i3, this.f859d);
            if (iP < 0) {
                return null;
            }
            return p071r2.n.a(Integer.valueOf(iP), 1);
        }
    }
    ...
    static final class b extends D2.i implements C2.p {
        ...
        public final p071r2.i e(CharSequence charSequence, int i3) {
            D2.h.f(charSequence, "$this$$receiver");
            p071r2.i iVarH = y.H(charSequence, this.f860c, i3, this.f861d, false);
            if (iVarH != null) {
                return p071r2.n.a(iVarH.c(), Integer.valueOf(((String) iVarH.d()).length()));
            }
            return null;
        }
    }
    ...
    public static final p071r2.i H(CharSequence charSequence, Collection collection, int i3, boolean z3, boolean z4) {
        Object next;
        String str;
        Object next2;
        String str2;
        if (!z3 && collection.size() == 1) {
            String str3 = (String) AbstractC0492n.Z(collection);
            int iO = !z4 ? o.O(charSequence, str3, i3, false, 4, null) : U(charSequence, str3, i3, false, 4, null);
            if (iO < 0) {
                return null;
            }
            return p071r2.n.a(Integer.valueOf(iO), str3);
        }
            ...
            if ((iC > 0 && iA <= iB) || (iC < 0 && iB <= iA)) {
                while (true) {
                    ...
                    do {
                        ...
                        next2 = it.next();
                        str2 = (String) next2;
                    } while (!x.p(str2, 0, (String) charSequence, iA, str2.length(), z3));
                    String str4 = (String) next2;
                    if (str4 != null) {
                        return p071r2.n.a(Integer.valueOf(iA), str4);
                    }
                    if (iA != iB) {
                        iA += iC;
                    }
            ...
            if ((iC2 > 0 && iA2 <= iB2) || (iC2 < 0 && iB2 <= iA2)) {
                while (true) {
                    ...
                    do {
                        ...
                        next = it2.next();
                        str = (String) next;
                    } while (!c0(str, 0, charSequence, iA2, str.length(), z3));
                    String str5 = (String) next;
                    if (str5 != null) {
                        return p071r2.n.a(Integer.valueOf(iA2), str5);
                    }
                    if (iA2 != iB2) {
                        iA2 += iC2;
                    }
    ...
    public static final int P(CharSequence charSequence, char[] cArr, int i3, boolean z3) {
        ...
        if (!z3 && cArr.length == 1 && (charSequence instanceof String)) {
            return ((String) charSequence).indexOf(AbstractC0486h.z(cArr), i3);
        }
        int iC = H2.d.c(i3, 0);
    ...
    public static final int V(CharSequence charSequence, char[] cArr, int i3, boolean z3) {
        ...
        D2.h.f(cArr, "chars");
        if (!z3 && cArr.length == 1 && (charSequence instanceof String)) {
            return ((String) charSequence).lastIndexOf(AbstractC0486h.z(cArr), i3);
        }
    ...
    private static final J2.c Z(CharSequence charSequence, String[] strArr, int i3, boolean z3, int i4) {
        h0(i4);
        return new e(charSequence, i3, i4, new b(AbstractC0486h.d(strArr), z3));
    }
    ...
    public static final List i0(CharSequence charSequence, char[] cArr, boolean z3, int i3) {
        ...
        ArrayList arrayList = new ArrayList(AbstractC0492n.q(iterableA, 10));
    ...
    private static final List j0(CharSequence charSequence, String str, boolean z3, int i3) {
        ...
        if (iK == -1 || i3 == 1) {
            return AbstractC0492n.b(charSequence.toString());
        }
        boolean z4 = i3 > 0;
