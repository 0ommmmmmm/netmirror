...
class ActivityResultRegistry$1 implements InterfaceC0295j {
    ...
    final /* synthetic */ p004b.a f3042c;
    ...
    public void d(l lVar, AbstractC0292g.a aVar) {
        if (!AbstractC0292g.a.ON_START.equals(aVar)) {
            if (AbstractC0292g.a.ON_STOP.equals(aVar)) {
                this.f3043d.f3051f.remove(this.f3040a);
                return;
            } else {
                if (AbstractC0292g.a.ON_DESTROY.equals(aVar)) {
