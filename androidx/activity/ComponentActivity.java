...
import androidx.lifecycle.InterfaceC0291f;
...
public class ComponentActivity extends androidx.core.app.f implements androidx.lifecycle.l, H, InterfaceC0291f, G.d, o, androidx.activity.result.f, androidx.core.content.c, androidx.core.content.d, androidx.core.app.j, androidx.core.app.k, InterfaceC0271z, l {

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    final p000a.a f2966d;
    ...
    public ComponentActivity() {
        ...
        t().a(new InterfaceC0295j() { // from class: androidx.activity.ComponentActivity.3
        ...
        t().a(new InterfaceC0295j() { // from class: androidx.activity.ComponentActivity.4
            @Override // androidx.lifecycle.InterfaceC0295j
            public void d(androidx.lifecycle.l lVar, AbstractC0292g.a aVar) {
        ...
        t().a(new InterfaceC0295j() { // from class: androidx.activity.ComponentActivity.5
            @Override // androidx.lifecycle.InterfaceC0295j
            public void d(androidx.lifecycle.l lVar, AbstractC0292g.a aVar) {
        ...
        cVarA.c();
        y.c(this);
        b().h("android:support:activity-result", new androidx.savedstate.a.c() { // from class: androidx.activity.d
            @Override // androidx.savedstate.a.c
            public final Bundle a() {
                return this.f3018a.L();
            }
        });
        E(new p000a.b() { // from class: androidx.activity.e
            @Override // p000a.b
    ...
    public final void E(p000a.b bVar) {
        this.f2966d.a(bVar);
    }

    public final void F(p064q.a aVar) {
        this.f2980r.add(aVar);
    }
    ...
    public final void g(p064q.a aVar) {
        this.f2981s.remove(aVar);
    }

    @Override // androidx.core.content.c
    public final void i(p064q.a aVar) {
        this.f2978p.remove(aVar);
    }

    @Override // androidx.lifecycle.InterfaceC0291f
    public E.b j() {
        if (this.f2971i == null) {
    ...
    public final void l(p064q.a aVar) {
        this.f2982t.add(aVar);
    }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        while (it.hasNext()) {
            ((p064q.a) it.next()).a(configuration);
        }
    }
    ...
    public void onMultiWindowModeChanged(boolean z3) {
        ...
        while (it.hasNext()) {
            ((p064q.a) it.next()).a(new androidx.core.app.g(z3));
        }
    }
    ...
    public void onPictureInPictureModeChanged(boolean z3) {
        ...
        while (it.hasNext()) {
            ((p064q.a) it.next()).a(new androidx.core.app.l(z3));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        AbstractC0292g abstractC0292gT = t();
        if (abstractC0292gT instanceof androidx.lifecycle.m) {
            ((androidx.lifecycle.m) abstractC0292gT).m(AbstractC0292g.b.CREATED);
        }
    ...
    public void onTrimMemory(int i3) {
        ...
        while (it.hasNext()) {
            ((p064q.a) it.next()).a(Integer.valueOf(i3));
        }
    }

    @Override // androidx.core.app.j
    public final void q(p064q.a aVar) {
        this.f2981s.add(aVar);
    }

    @Override // androidx.core.content.c
    public final void r(p064q.a aVar) {
    ...
    @Override // androidx.core.app.k
    public final void u(p064q.a aVar) {
        this.f2982t.remove(aVar);
    }

    @Override // androidx.core.content.d
    public final void v(p064q.a aVar) {
        this.f2979q.remove(aVar);
    }

    @Override // androidx.core.content.d
    public final void x(p064q.a aVar) {
        this.f2979q.add(aVar);
    }
    ...
    public void onMultiWindowModeChanged(boolean z3, Configuration configuration) {
        ...
        try {
            ...
            Iterator it = this.f2981s.iterator();
            while (it.hasNext()) {
                ((p064q.a) it.next()).a(new androidx.core.app.g(z3, configuration));
            }
        } catch (Throwable th) {
            this.f2983u = false;
            throw th;
    ...
    public void onPictureInPictureModeChanged(boolean z3, Configuration configuration) {
        ...
        try {
            ...
            Iterator it = this.f2982t.iterator();
            while (it.hasNext()) {
                ((p064q.a) it.next()).a(new androidx.core.app.l(z3, configuration));
            }
        } catch (Throwable th) {
            this.f2984v = false;
            throw th;
