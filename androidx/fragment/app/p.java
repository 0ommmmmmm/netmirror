...
public abstract class p extends AbstractC0283l {
    ...
    p(ActivityC0281j activityC0281j) {
        this(activityC0281j, activityC0281j, new Handler(), 0);
    }

    p(Activity activity, Context context, Handler handler, int i3) {
        this.f5172f = new y();
        this.f5168b = activity;
        this.f5169c = (Context) p064q.g.h(context, "context == null");
        this.f5170d = (Handler) p064q.g.h(handler, "handler == null");
        this.f5171e = i3;
    }
}
