...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, androidx.lifecycle.l, androidx.lifecycle.H, InterfaceC0291f, G.d {
    ...
    class e extends AbstractC0283l {
        e() {
        }

        @Override // androidx.fragment.app.AbstractC0283l
    ...
    public Fragment() {
        ...
        this.f4922L = true;
        this.f4924N = new a();
        this.f4929S = AbstractC0292g.b.RESUMED;
    ...
    private int B() {
        AbstractC0292g.b bVar = this.f4929S;
        return (bVar == AbstractC0292g.b.INITIALIZED || this.f4961x == null) ? bVar.ordinal() : Math.min(bVar.ordinal(), this.f4961x.B());
    }
    ...
    public LayoutInflater A(Bundle bundle) {
        ...
        AbstractC0270y.a(layoutInflaterY, this.f4960w.u0());
    ...
    void P0(Bundle bundle) {
        ...
        this.f4938b = 1;
        this.f4918H = false;
        this.f4930T.a(new InterfaceC0295j() { // from class: androidx.fragment.app.Fragment.6
            @Override // androidx.lifecycle.InterfaceC0295j
            public void d(androidx.lifecycle.l lVar, AbstractC0292g.a aVar) {
                View view;
                if (aVar != AbstractC0292g.a.ON_STOP || (view = Fragment.this.f4920J) == null) {
                    return;
                }
                g.a(view);
            }
        ...
        this.f4927Q = true;
        if (this.f4918H) {
            this.f4930T.h(AbstractC0292g.a.ON_CREATE);
            return;
        }
    ...
    void S0() {
        this.f4960w.D();
        this.f4930T.h(AbstractC0292g.a.ON_DESTROY);
        this.f4938b = 0;
        this.f4918H = false;
        this.f4927Q = false;
        p0();
    ...
    void T0() {
        this.f4960w.E();
        if (this.f4920J != null && this.f4931U.t().b().b(AbstractC0292g.b.CREATED)) {
            this.f4931U.c(AbstractC0292g.a.ON_DESTROY);
        }
        this.f4938b = 1;
        this.f4918H = false;
        r0();
    ...
    void a1() {
        this.f4960w.M();
        if (this.f4920J != null) {
            this.f4931U.c(AbstractC0292g.a.ON_PAUSE);
        }
        this.f4930T.h(AbstractC0292g.a.ON_PAUSE);
        this.f4938b = 6;
        this.f4918H = false;
        A0();
        if (this.f4918H) {
    ...
    void e1() {
        ...
        AbstractC0292g.a aVar = AbstractC0292g.a.ON_RESUME;
        mVar.h(aVar);
        if (this.f4920J != null) {
            this.f4931U.c(aVar);
        }
    ...
    void g1() {
        ...
        androidx.lifecycle.m mVar = this.f4930T;
        AbstractC0292g.a aVar = AbstractC0292g.a.ON_START;
        mVar.h(aVar);
        if (this.f4920J != null) {
            this.f4931U.c(aVar);
        }
    ...
    public final ActivityC0281j h() {
        p pVar = this.f4959v;
        if (pVar == null) {
            return null;
        }
        return (ActivityC0281j) pVar.j();
    }
    ...
    void h1() {
        this.f4960w.T();
        if (this.f4920J != null) {
            this.f4931U.c(AbstractC0292g.a.ON_STOP);
        }
        this.f4930T.h(AbstractC0292g.a.ON_STOP);
        this.f4938b = 4;
        this.f4918H = false;
        I0();
        if (this.f4918H) {
    ...
    public androidx.lifecycle.E.b j() {
    ...
    public F.a k() {
        ...
        F.d dVar = new F.d();
        if (application != null) {
            dVar.c(androidx.lifecycle.E.a.f5272h, application);
        }
    ...
    public final ActivityC0281j k1() {
        ActivityC0281j activityC0281jH = h();
        if (activityC0281jH != null) {
            return activityC0281jH;
        }
    ...
    final void q1(Bundle bundle) {
        ...
        if (this.f4918H) {
            if (this.f4920J != null) {
                this.f4931U.c(AbstractC0292g.a.ON_CREATE);
            }
        } else {
    ...
    public androidx.lifecycle.G s() {
        ...
        if (B() != AbstractC0292g.b.INITIALIZED.ordinal()) {
