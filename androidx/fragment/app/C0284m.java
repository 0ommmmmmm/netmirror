...
public final class C0284m extends FrameLayout {
    ...
    public C0284m(Context context, AttributeSet attributeSet) {
    ...
    public WindowInsets dispatchApplyWindowInsets(WindowInsets windowInsets) {
        C0257n0 c0257n0M;
        D2.h.f(windowInsets, "insets");
        C0257n0 c0257n0V = C0257n0.v(windowInsets);
        D2.h.e(c0257n0V, "toWindowInsetsCompat(insets)");
        View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = this.f5163d;
        if (onApplyWindowInsetsListener != null) {
            a aVar = a.f5165a;
            D2.h.c(onApplyWindowInsetsListener);
            c0257n0M = C0257n0.v(aVar.a(onApplyWindowInsetsListener, this, windowInsets));
        } else {
            c0257n0M = Z.M(this, c0257n0V);
        }
        D2.h.e(c0257n0M, "if (applyWindowInsetsLis…, insetsCompat)\n        }");
        if (!c0257n0M.n()) {
            int childCount = getChildCount();
            for (int i3 = 0; i3 < childCount; i3++) {
                Z.e(getChildAt(i3), c0257n0M);
            }
        }
        return windowInsets;
    }
    ...
    public /* synthetic */ C0284m(Context context, AttributeSet attributeSet, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, attributeSet, (i4 & 4) != 0 ? 0 : i3);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0284m(Context context, AttributeSet attributeSet, int i3) {
        String str;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0284m(Context context, AttributeSet attributeSet, x xVar) {
        String str;
