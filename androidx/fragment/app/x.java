...
public abstract class x {
    ...
    /* JADX INFO: renamed from: p, reason: collision with root package name */
    private final p064q.a f5217p = new p064q.a() { // from class: androidx.fragment.app.s
        @Override // p064q.a
    ...
    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private final p064q.a f5218q = new p064q.a() { // from class: androidx.fragment.app.t
        @Override // p064q.a
        public final void a(Object obj) {
    ...
    private final p064q.a f5219r = new p064q.a() { // from class: androidx.fragment.app.u
        @Override // p064q.a
        public final void a(Object obj) {
    ...
    /* JADX INFO: renamed from: s, reason: collision with root package name */
    private final p064q.a f5220s = new p064q.a() { // from class: androidx.fragment.app.v
        @Override // p064q.a
        public final void a(Object obj) {
    ...
    static class j extends p004b.a {
        j() {
        }
    ...
    private static void c0(ArrayList arrayList, ArrayList arrayList2, int i3, int i4) {
        while (i3 < i4) {
            C0272a c0272a = (C0272a) arrayList.get(i3);
    ...
    private void d0(ArrayList arrayList, ArrayList arrayList2, int i3, int i4) {
        boolean z3 = ((C0272a) arrayList.get(i3)).f4899r;
        ...
        for (int i5 = i3; i5 < i4; i5++) {
            C0272a c0272a = (C0272a) arrayList.get(i5);
            fragmentX0 = !((Boolean) arrayList2.get(i5)).booleanValue() ? c0272a.t(this.f5198O, fragmentX0) : c0272a.w(this.f5198O, fragmentX0);
            z4 = z4 || c0272a.f4890i;
        }
        this.f5198O.clear();
        if (!z3 && this.f5222u >= 1) {
            for (int i6 = i3; i6 < i4; i6++) {
                Iterator it = ((C0272a) arrayList.get(i6)).f4884c.iterator();
                while (it.hasNext()) {
        ...
        for (int i7 = i3; i7 < i4; i7++) {
            C0272a c0272a2 = (C0272a) arrayList.get(i7);
            if (zBooleanValue) {
                for (int size = c0272a2.f4884c.size() - 1; size >= 0; size--) {
                    Fragment fragment2 = ((F.a) c0272a2.f4884c.get(size)).f4902b;
                    if (fragment2 != null) {
                        v(fragment2).m();
                    }
                }
            } else {
                Iterator it2 = c0272a2.f4884c.iterator();
                while (it2.hasNext()) {
        ...
        while (i3 < i4) {
            C0272a c0272a3 = (C0272a) arrayList.get(i3);
            if (((Boolean) arrayList2.get(i3)).booleanValue() && c0272a3.f5058v >= 0) {
                c0272a3.f5058v = -1;
            }
            c0272a3.v();
            i3++;
    ...
    private void d1(ArrayList arrayList, ArrayList arrayList2) {
        ...
        int i4 = 0;
        while (i3 < size) {
            if (!((C0272a) arrayList.get(i3)).f4899r) {
                if (i4 != i3) {
                    d0(arrayList, arrayList2, i4, i3);
                }
                i4 = i3 + 1;
                if (((Boolean) arrayList2.get(i3)).booleanValue()) {
                    while (i4 < size && ((Boolean) arrayList2.get(i4)).booleanValue() && !((C0272a) arrayList.get(i4)).f4899r) {
                        i4++;
                    }
                }
    ...
    private int f0(String str, int i3, boolean z3) {
        ...
        while (size >= 0) {
            C0272a c0272a = (C0272a) this.f5205d.get(size);
            if ((str != null && str.equals(c0272a.u())) || (i3 >= 0 && i3 == c0272a.f5058v)) {
                break;
            }
            size--;
        }
        ...
        while (size > 0) {
            C0272a c0272a2 = (C0272a) this.f5205d.get(size - 1);
            if ((str == null || !str.equals(c0272a2.u())) && (i3 < 0 || i3 != c0272a2.f5058v)) {
                return size;
            }
            size--;
        }
    ...
    static x j0(View view) {
        ...
        while (true) {
            ...
            if (context instanceof ActivityC0281j) {
                activityC0281j = (ActivityC0281j) context;
                break;
            }
            context = ((ContextWrapper) context).getBaseContext();
        }
        if (activityC0281j != null) {
            return activityC0281j.T();
        }
    ...
    private void s() {
        ...
        if (pVar instanceof androidx.lifecycle.H) {
            ...
            zO = pVar.k() instanceof Activity ? !((Activity) this.f5223v.k()).isChangingConfigurations() : true;
        }
        if (zO) {
            Iterator it = this.f5211j.values().iterator();
            while (it.hasNext()) {
                Iterator it2 = ((C0274c) it.next()).f5074a.iterator();
                while (it2.hasNext()) {
    ...
    private Set u(ArrayList arrayList, int i3, int i4) {
        ...
        HashSet hashSet = new HashSet();
        while (i3 < i4) {
            Iterator it = ((C0272a) arrayList.get(i3)).f4884c.iterator();
            while (it.hasNext()) {
                Fragment fragment = ((F.a) it.next()).f4902b;
    ...
    void D() {
        ...
        if (obj5 instanceof InterfaceC0271z) {
            ((InterfaceC0271z) obj5).d(this.f5221t);
        }
        this.f5223v = null;
        this.f5224w = null;
        this.f5225x = null;
    ...
    void V0(C0284m c0284m) {
        View view;
        for (D d4 : this.f5204c.k()) {
            Fragment fragmentK = d4.k();
            if (fragmentK.f4963z == c0284m.getId() && (view = fragmentK.f4920J) != null && view.getParent() == null) {
                fragmentK.f4919I = c0284m;
                d4.b();
            }
        }
    }
    ...
    public void W(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (arrayList2 != null && (size = arrayList2.size()) > 0) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                C0272a c0272a = (C0272a) this.f5205d.get(i4);
                printWriter.print(str);
                printWriter.print("  #");
                printWriter.print(i4);
                printWriter.print(": ");
                printWriter.println(c0272a.toString());
                c0272a.p(str2, printWriter);
            }
        }
        printWriter.print(str);
    ...
    boolean b1(ArrayList arrayList, ArrayList arrayList2, String str, int i3, int i4) {
        ...
        for (int size = this.f5205d.size() - 1; size >= iF0; size--) {
            arrayList.add((C0272a) this.f5205d.remove(size));
    ...
    void f1(Parcelable parcelable) {
        ...
        if (zVar.f5246c != null) {
            ...
            int i3 = 0;
            while (true) {
                C0273b[] c0273bArr = zVar.f5246c;
                if (i3 >= c0273bArr.length) {
                    break;
                }
                C0272a c0272aB = c0273bArr[i3].b(this);
                if (G0(2)) {
                    Log.v("FragmentManager", "restoreAllState: back stack #" + i3 + " (index " + c0272aB.f5058v + "): " + c0272aB);
                    PrintWriter printWriter = new PrintWriter(new K("FragmentManager"));
                    c0272aB.q("  ", printWriter, false);
                    printWriter.close();
                }
                this.f5205d.add(c0272aB);
                i3++;
            }
        } else {
            this.f5205d = null;
        ...
        if (arrayList2 != null) {
            for (int i4 = 0; i4 < arrayList2.size(); i4++) {
                this.f5211j.put((String) arrayList2.get(i4), (C0274c) zVar.f5250g.get(i4));
            }
        }
    ...
    public Bundle O0() {
        ...
        if (!arrayListM.isEmpty()) {
            ...
            if (arrayList == null || (size = arrayList.size()) <= 0) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    c0273bArr[i3] = new C0273b((C0272a) this.f5205d.get(i3));
                    if (G0(2)) {
    ...
    void i(C0272a c0272a) {
        if (this.f5205d == null) {
            this.f5205d = new ArrayList();
        }
        this.f5205d.add(c0272a);
    }
    ...
    void j1(Fragment fragment, boolean z3) {
        ViewGroup viewGroupQ0 = q0(fragment);
        if (viewGroupQ0 == null || !(viewGroupQ0 instanceof C0284m)) {
            return;
        }
        ((C0284m) viewGroupQ0).setDrawDisappearingViewsLast(!z3);
    }
    ...
    void k1(Fragment fragment, AbstractC0292g.b bVar) {
    ...
    void m(p pVar, AbstractC0283l abstractC0283l, Fragment fragment) {
        String str;
        ...
        if ((obj instanceof G.d) && fragment == null) {
            ...
            aVarB.h("android:support:fragments", new androidx.savedstate.a.c() { // from class: androidx.fragment.app.w
        ...
        if (obj2 instanceof androidx.activity.result.f) {
            ...
            this.f5187D = eVarO.g(str2 + "StartActivityForResult", new p004b.c(), new h());
            this.f5188E = eVarO.g(str2 + "StartIntentSenderForResult", new j(), new i());
            this.f5189F = eVarO.g(str2 + "RequestPermissions", new p004b.b(), new a());
        }
        Object obj3 = this.f5223v;
        ...
        if ((obj7 instanceof InterfaceC0271z) && fragment == null) {
            ((InterfaceC0271z) obj7).n(this.f5221t);
        }
    }
