...
import androidx.core.view.AbstractC0239e0;
...
class C0275d extends L {
    ...
    class C0073d implements androidx.core.os.d.a {
    ...
    class g implements Runnable {
        ...
        /* JADX INFO: renamed from: e, reason: collision with root package name */
        final /* synthetic */ p044l.a f5103e;

        g(L.e eVar, L.e eVar2, boolean z3, p044l.a aVar) {
            this.f5100b = eVar;
            this.f5101c = eVar2;
            this.f5102d = z3;
            this.f5103e = aVar;
    ...
    private static class k extends l {
        ...
        /* JADX INFO: renamed from: e, reason: collision with root package name */
        private AbstractC0282k.a f5116e;
        ...
        AbstractC0282k.a e(Context context) {
            if (this.f5115d) {
                return this.f5116e;
            }
            AbstractC0282k.a aVarB = AbstractC0282k.b(context, b().f(), b().e() == L.e.c.VISIBLE, this.f5114c);
            this.f5116e = aVarB;
            this.f5115d = true;
            return aVarB;
        }
    ...
    private void w(List list, List list2, boolean z3, Map map) {
        ...
        while (true) {
            ...
            if (kVar.d()) {
                ...
                AbstractC0282k.a aVarE = kVar.e(context2);
                if (aVarE == null) {
                    kVar.a();
                } else {
        ...
        for (k kVar2 : arrayList) {
            ...
            if (z3) {
                ...
                Animation animation = (Animation) p064q.g.g(((AbstractC0282k.a) p064q.g.g(kVar2.e(context2))).f5154a);
                if (eVarB2.e() != L.e.c.REMOVED) {
                    ...
                    AbstractC0282k.b bVar = new AbstractC0282k.b(animation, viewGroupM, view3);
                    z4 = z5;
                    context = context2;
                    view = view3;
    ...
    private Map x(List list, List list2, boolean z3, L.e eVar, L.e eVar2) {
        ...
        while (true) {
            ...
            if (!mVar3.i() || eVar7 == null || eVar8 == null) {
                ...
                HashMap map3 = map2;
                int i5 = 0;
                while (i5 < arrayListP.size()) {
                    int iIndexOf = arrayListO.indexOf(arrayListP.get(i5));
                    ArrayList arrayList8 = arrayListP;
                    if (iIndexOf != -1) {
                        arrayListO.set(iIndexOf, (String) arrayListO2.get(i5));
                    }
                    i5++;
                    arrayListP = arrayList8;
                }
                ...
                int i6 = 0;
                while (i6 < size) {
                    aVar.put((String) arrayListO.get(i6), (String) arrayListP2.get(i6));
                    i6++;
                    size = size;
                    rect2 = rect2;
                }
                ...
                p044l.a aVar2 = new p044l.a();
                u(aVar2, eVar.f().f4920J);
                aVar2.o(arrayListO);
                if (mVarU != null) {
                    if (x.G0(2)) {
                        Log.v("FragmentManager", "Executing exit callback for operation " + eVar7);
                    }
                    mVarU.a(arrayListO, aVar2);
                    int size2 = arrayListO.size() - 1;
                    while (size2 >= 0) {
                        String str4 = (String) arrayListO.get(size2);
                        View view8 = (View) aVar2.get(str4);
                        if (view8 == null) {
                            aVar.remove(str4);
                            arrayList5 = arrayListO;
                        } else {
                            arrayList5 = arrayListO;
                            if (!str4.equals(Z.A(view8))) {
                                aVar.put(Z.A(view8), (String) aVar.remove(str4));
                            }
                        }
                        size2--;
                        arrayListO = arrayList5;
                    }
                ...
                p044l.a aVar3 = new p044l.a();
                u(aVar3, eVar2.f().f4920J);
                aVar3.o(arrayListP2);
                aVar3.o(aVar.values());
                if (mVarX != null) {
                    if (x.G0(2)) {
                    ...
                    mVarX.a(arrayListP2, aVar3);
                    for (int size3 = arrayListP2.size() - 1; size3 >= 0; size3--) {
                        String str5 = (String) arrayListP2.get(size3);
                        View view9 = (View) aVar3.get(str5);
                        if (view9 == null) {
                            String strB2 = G.b(aVar, str5);
                            if (strB2 != null) {
                                aVar.remove(strB2);
                            }
                        } else if (!str5.equals(Z.A(view9)) && (strB = G.b(aVar, str5)) != null) {
                            aVar.put(strB, Z.A(view9));
                        }
                    }
                } else {
                    G.d(aVar, aVar3);
                ...
                if (aVar.isEmpty()) {
                    ...
                    G.a(eVar2.f(), eVar.f(), z3, aVar2, true);
                    ArrayList arrayList9 = arrayList7;
                    androidx.core.view.L.a(m(), new g(eVar2, eVar, z3, aVar3));
                    ...
                    if (arrayList4.isEmpty()) {
                        ...
                        i3 = 0;
                        view6 = (View) aVar2.get((String) arrayList4.get(0));
                        i4.p(objU, view6);
                    }
                    arrayList9.addAll(aVar3.values());
                    if (arrayListP2.isEmpty() || (view4 = (View) aVar3.get((String) arrayListP2.get(i3))) == null) {
                        rect = rect3;
                    } else {
                        rect = rect3;
                        androidx.core.view.L.a(m(), new h(i4, view4, rect));
                        z4 = true;
                    }
                    i4.s(objU, view3, arrayList6);
                    i4.n(objU, null, null, null, null, objU, arrayList9);
        ...
        while (it6.hasNext()) {
            ...
            if (mVar4.d()) {
                ...
                L.e eVarB = mVar4.b();
                boolean z5 = obj != null && (eVarB == eVar9 || eVarB == eVar10);
                if (objF == null) {
                    if (!z5) {
                    ...
                    if (arrayList13.isEmpty()) {
                        ...
                        arrayList2 = arrayList11;
                        eVar3 = eVar10;
                        i7.n(objF, objF, arrayList13, null, null, null, null);
                        if (eVarB.e() == L.e.c.GONE) {
                            eVar4 = eVarB;
                            list2.remove(eVar4);
                            ArrayList arrayList14 = new ArrayList(arrayList13);
                            arrayList14.remove(eVar4.f().f4920J);
                            i7.m(objF, eVar4.f().f4920J, arrayList14);
                            androidx.core.view.L.a(m(), new i(arrayList13));
                        } else {
                            eVar4 = eVarB;
                        }
                    }
                    ...
                    if (mVar4.j()) {
                        objK2 = i7.k(objK2, objF, null);
                    } else {
                        objK = i7.k(objK, objF, null);
                    }
                }
                it6 = it7;
                obj2 = objK;
        ...
        L.e eVar11 = eVar10;
        Object objJ = i7.j(obj3, obj2, obj);
        if (objJ == null) {
            return map4;
        }
        ...
        while (it8.hasNext()) {
            ...
            if (!mVar5.d()) {
                Object objH = mVar5.h();
                L.e eVarB2 = mVar5.b();
                boolean z6 = obj != null && (eVarB2 == eVar9 || eVarB2 == eVar11);
                if (objH == null && !z6) {
                    str2 = str6;
                } else if (Z.F(m())) {
                    str2 = str6;
        ...
        G.e(arrayList12, 4);
        ArrayList arrayListL = i7.l(arrayList16);
        if (x.G0(2)) {
            Log.v(str7, ">>>>> Beginning transition <<<<<");
            Log.v(str7, ">>>>> SharedElementFirstOutViews <<<<<");
            for (View view12 : arrayList15) {
                Log.v(str7, "View: " + view12 + " Name: " + Z.A(view12));
            }
        ...
        i7.c(m(), objJ);
        i7.r(m(), arrayList15, arrayList16, arrayListL, aVar4);
        G.e(arrayList12, 0);
        i7.t(obj, arrayList15, arrayList16);
        return map4;
    }
    ...
    void f(List list, boolean z3) {
        ...
        while (it.hasNext()) {
            ...
            L.e.c cVarC = L.e.c.c(eVar3.f().f4920J);
            int i3 = a.f5076a[eVar3.e().ordinal()];
            if (i3 == 1 || i3 == 2 || i3 == 3) {
                if (cVarC == L.e.c.VISIBLE && eVar == null) {
                    eVar = eVar3;
                }
            } else if (i3 == 4 && cVarC != L.e.c.VISIBLE) {
                eVar2 = eVar3;
            }
        }
        if (x.G0(2)) {
        ...
        Map mapX = x(arrayList2, arrayList3, z3, eVar, eVar2);
    ...
    void t(ArrayList arrayList, View view) {
        ...
        if (AbstractC0239e0.a(viewGroup)) {
            if (arrayList.contains(view)) {
                return;
            }
    ...
    void v(p044l.a aVar, Collection collection) {
