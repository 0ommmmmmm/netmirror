...
public class DialogInterfaceOnCancelListenerC0276e extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    class a implements Runnable {
        ...
        public void run() {
            DialogInterfaceOnCancelListenerC0276e.this.f5125g0.onDismiss(DialogInterfaceOnCancelListenerC0276e.this.f5133o0);
        }
    }
    ...
    class b implements DialogInterface.OnCancelListener {
        ...
        public void onCancel(DialogInterface dialogInterface) {
            if (DialogInterfaceOnCancelListenerC0276e.this.f5133o0 != null) {
                DialogInterfaceOnCancelListenerC0276e dialogInterfaceOnCancelListenerC0276e = DialogInterfaceOnCancelListenerC0276e.this;
                dialogInterfaceOnCancelListenerC0276e.onCancel(dialogInterfaceOnCancelListenerC0276e.f5133o0);
            }
        }
    }
    ...
    class c implements DialogInterface.OnDismissListener {
        ...
        public void onDismiss(DialogInterface dialogInterface) {
            if (DialogInterfaceOnCancelListenerC0276e.this.f5133o0 != null) {
                DialogInterfaceOnCancelListenerC0276e dialogInterfaceOnCancelListenerC0276e = DialogInterfaceOnCancelListenerC0276e.this;
                dialogInterfaceOnCancelListenerC0276e.onDismiss(dialogInterfaceOnCancelListenerC0276e.f5133o0);
            }
        }
    }
    ...
    class d implements androidx.lifecycle.q {
        ...
        public void a(androidx.lifecycle.l lVar) {
            if (lVar == null || !DialogInterfaceOnCancelListenerC0276e.this.f5129k0) {
                return;
            }
            View viewN1 = DialogInterfaceOnCancelListenerC0276e.this.n1();
            if (viewN1.getParent() != null) {
                throw new IllegalStateException("DialogFragment can not be attached to a container view");
            }
            if (DialogInterfaceOnCancelListenerC0276e.this.f5133o0 != null) {
                if (x.G0(3)) {
                    Log.d("FragmentManager", "DialogFragment " + this + " setting the content view on " + DialogInterfaceOnCancelListenerC0276e.this.f5133o0);
                }
                DialogInterfaceOnCancelListenerC0276e.this.f5133o0.setContentView(viewN1);
            }
        }
    }

    /* JADX INFO: renamed from: androidx.fragment.app.e$e, reason: collision with other inner class name */
    class C0074e extends AbstractC0283l {

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ AbstractC0283l f5142b;

        C0074e(AbstractC0283l abstractC0283l) {
            this.f5142b = abstractC0283l;
        }

        @Override // androidx.fragment.app.AbstractC0283l
        public View f(int i3) {
            return this.f5142b.h() ? this.f5142b.f(i3) : DialogInterfaceOnCancelListenerC0276e.this.G1(i3);
        }

        @Override // androidx.fragment.app.AbstractC0283l
        public boolean h() {
            return this.f5142b.h() || DialogInterfaceOnCancelListenerC0276e.this.H1();
        }
    }

    public DialogInterfaceOnCancelListenerC0276e() {
        this.f5123e0 = new a();
        this.f5124f0 = new b();
        this.f5125g0 = new c();
        this.f5126h0 = 0;
    ...
    public DialogInterfaceOnCancelListenerC0276e(int i3) {
        super(i3);
        this.f5123e0 = new a();
        this.f5124f0 = new b();
        this.f5125g0 = new c();
