...
final class C0273b implements Parcelable {
    ...
    class a implements Parcelable.Creator {
        ...
        public C0273b[] newArray(int i3) {
            return new C0273b[i3];
        }
    }

    C0273b(C0272a c0272a) {
        int size = c0272a.f4884c.size();
        ...
        for (int i4 = 0; i4 < size; i4++) {
            F.a aVar = (F.a) c0272a.f4884c.get(i4);
            int i5 = i3 + 1;
        ...
        this.f5064e = c0272a.f4889h;
        this.f5065f = c0272a.f4892k;
        this.f5066g = c0272a.f5058v;
        this.f5067h = c0272a.f4893l;
        this.f5068i = c0272a.f4894m;
        this.f5069j = c0272a.f4895n;
        this.f5070k = c0272a.f4896o;
        this.f5071l = c0272a.f4897p;
        this.f5072m = c0272a.f4898q;
        this.f5073n = c0272a.f4899r;
    }
    ...
    private void a(C0272a c0272a) {
        ...
        while (true) {
            ...
            if (i3 >= this.f5060a.length) {
                c0272a.f4889h = this.f5064e;
                c0272a.f4892k = this.f5065f;
                c0272a.f4890i = true;
                c0272a.f4893l = this.f5067h;
                c0272a.f4894m = this.f5068i;
                c0272a.f4895n = this.f5069j;
                c0272a.f4896o = this.f5070k;
                c0272a.f4897p = this.f5071l;
                c0272a.f4898q = this.f5072m;
                c0272a.f4899r = this.f5073n;
                return;
            }
            F.a aVar = new F.a();
            int i5 = i3 + 1;
            ...
            if (x.G0(2)) {
                Log.v("FragmentManager", "Instantiate " + c0272a + " op #" + i4 + " base fragment #" + this.f5060a[i5]);
            }
            aVar.f4908h = AbstractC0292g.b.values()[this.f5062c[i4]];
            aVar.f4909i = AbstractC0292g.b.values()[this.f5063d[i4]];
            int[] iArr = this.f5060a;
            int i6 = i3 + 2;
            if (iArr[i5] == 0) {
                z3 = false;
