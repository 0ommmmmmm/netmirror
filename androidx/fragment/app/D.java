...
class D {
    ...
    static /* synthetic */ class b {
        ...
        static {
            int[] iArr = new int[AbstractC0292g.b.values().length];
            f4877a = iArr;
            try {
                iArr[AbstractC0292g.b.RESUMED.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f4877a[AbstractC0292g.b.STARTED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f4877a[AbstractC0292g.b.CREATED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f4877a[AbstractC0292g.b.INITIALIZED.ordinal()] = 4;
    ...
    int d() {
        ...
        if (i3 != 1) {
            if (i3 == 2) {
                ...
                iMin = i3 != 4 ? Math.min(iMin, -1) : Math.min(iMin, 0);
            } else {
    ...
    void f() {
        ...
        if (viewGroup == null) {
            ...
            if (i3 == 0) {
                ...
                } else if (!(viewGroup instanceof C0284m)) {
