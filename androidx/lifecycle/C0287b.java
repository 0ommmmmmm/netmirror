...
final class C0287b {
    ...
    static C0287b f5312c = new C0287b();
    ...
    static class a {
        ...
        a(Map map) {
            ...
            for (Map.Entry entry : map.entrySet()) {
                AbstractC0292g.a aVar = (AbstractC0292g.a) entry.getValue();
        ...
        private static void b(List list, l lVar, AbstractC0292g.a aVar, Object obj) {
            if (list != null) {
        ...
        void a(l lVar, AbstractC0292g.a aVar, Object obj) {
            b((List) this.f5315a.get(aVar), lVar, aVar, obj);
            b((List) this.f5315a.get(AbstractC0292g.a.ON_ANY), lVar, aVar, obj);
        }
    }
    ...
    private a a(Class cls, Method[] methodArr) {
        ...
        for (Class<?> cls2 : cls.getInterfaces()) {
            for (Map.Entry entry : c(cls2).f5316b.entrySet()) {
                e(map, (C0078b) entry.getKey(), (AbstractC0292g.a) entry.getValue(), cls);
            }
        }
        if (methodArr == null) {
            methodArr = b(cls);
        ...
        for (Method method : methodArr) {
            ...
            if (rVar != null) {
                ...
                AbstractC0292g.a aVarValue = rVar.value();
                if (parameterTypes.length > 1) {
                    if (!AbstractC0292g.a.class.isAssignableFrom(parameterTypes[1])) {
                        throw new IllegalArgumentException("invalid parameter type. second arg must be an event");
                    }
                    if (aVarValue != AbstractC0292g.a.ON_ANY) {
    ...
    private void e(Map map, C0078b c0078b, AbstractC0292g.a aVar, Class cls) {
        AbstractC0292g.a aVar2 = (AbstractC0292g.a) map.get(c0078b);
