...
public final class B extends E.d implements E.b {
    ...
    public D b(Class cls, F.a aVar) {
        ...
        boolean zIsAssignableFrom = C0286a.class.isAssignableFrom(cls);
        Constructor constructorC = (!zIsAssignableFrom || application == null) ? C.c(cls, C.f5259b) : C.c(cls, C.f5258a);
        if (constructorC == null) {
            return this.f5254c.b(cls, aVar);
        }
        return (!zIsAssignableFrom || application == null) ? C.d(cls, constructorC, y.a(aVar)) : C.d(cls, constructorC, application, y.a(aVar));
    }
    ...
    public void c(D d4) {
        ...
        if (this.f5256e != null) {
            ...
            D2.h.c(aVar);
            AbstractC0292g abstractC0292g = this.f5256e;
            D2.h.c(abstractC0292g);
            LegacySavedStateHandleController.a(d4, aVar, abstractC0292g);
        }
    }
    ...
    public final D d(String str, Class cls) {
        ...
        androidx.savedstate.a aVar = this.f5257f;
        D2.h.c(aVar);
        SavedStateHandleController savedStateHandleControllerB = LegacySavedStateHandleController.b(aVar, abstractC0292g, str, this.f5255d);
