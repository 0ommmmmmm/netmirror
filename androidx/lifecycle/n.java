...
public final class n {
    ...
    private final InterfaceC0290e a(Constructor constructor, Object obj) {
        try {
    ...
    public static final InterfaceC0295j f(Object obj) {
        D2.h.f(obj, "object");
        boolean z3 = obj instanceof InterfaceC0295j;
        boolean z4 = obj instanceof InterfaceC0288c;
        if (z3 && z4) {
            return new DefaultLifecycleObserverAdapter((InterfaceC0288c) obj, (InterfaceC0295j) obj);
        }
        if (z4) {
            return new DefaultLifecycleObserverAdapter((InterfaceC0288c) obj, null);
        }
        if (z3) {
            return (InterfaceC0295j) obj;
        }
        ...
        int size = list.size();
        InterfaceC0290e[] interfaceC0290eArr = new InterfaceC0290e[size];
        for (int i3 = 0; i3 < size; i3++) {
            f5341a.a((Constructor) list.get(i3), obj);
            interfaceC0290eArr[i3] = null;
        }
        return new CompositeGeneratedAdaptersObserver(interfaceC0290eArr);
    }
    ...
    private final int g(Class cls) {
        ...
        if (constructorB != null) {
            f5343c.put(cls, AbstractC0492n.b(constructorB));
            return 2;
        }
        if (C0287b.f5312c.d(cls)) {
            return 1;
        }
