...
public abstract class LiveData {
    ...
    class LifecycleBoundObserver extends androidx.lifecycle.LiveData.c implements InterfaceC0295j {
        ...
        public void d(l lVar, AbstractC0292g.a aVar) {
            AbstractC0292g.b bVarB = this.f5297e.t().b();
            if (bVarB == AbstractC0292g.b.DESTROYED) {
                this.f5298f.h(this.f5301a);
                return;
            }
            AbstractC0292g.b bVar = null;
            while (bVar != bVarB) {
                h(j());
                bVar = bVarB;
        ...
        boolean j() {
            return this.f5297e.t().b().b(AbstractC0292g.b.STARTED);
        }
    }
