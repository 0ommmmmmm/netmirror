...
public final class x {
    ...
    private final androidx.savedstate.a.c f5367e;
    ...
    public x(Map<String, ? extends Object> map) {
        ...
        this.f5367e = new androidx.savedstate.a.c() { // from class: androidx.lifecycle.w
    ...
    public static final Bundle d(x xVar) {
        D2.h.f(xVar, "this$0");
        for (Map.Entry entry : p075s2.D.o(xVar.f5364b).entrySet()) {
            xVar.e((String) entry.getKey(), ((androidx.savedstate.a.c) entry.getValue()).a());
        }
        ...
        return androidx.core.os.c.a(p071r2.n.a("keys", arrayList), p071r2.n.a("values", arrayList2));
    }
