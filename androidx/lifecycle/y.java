...
public abstract class y {
    ...
    public static final F.a.b f5368a = new b();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final F.a.b f5369b = new c();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final F.a.b f5370c = new a();
    ...
    public static final void c(G.d dVar) {
        D2.h.f(dVar, "<this>");
        AbstractC0292g.b bVarB = dVar.t().b();
        if (bVarB != AbstractC0292g.b.INITIALIZED && bVarB != AbstractC0292g.b.CREATED) {
    ...
    public static final z d(G.d dVar) {
        D2.h.f(dVar, "<this>");
        androidx.savedstate.a.c cVarC = dVar.b().c("androidx.lifecycle.internal.SavedStateHandlesProvider");
