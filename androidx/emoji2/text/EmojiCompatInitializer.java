...
import androidx.lifecycle.InterfaceC0288c;
...
public class EmojiCompatInitializer implements H.a {
    ...
    void d(Context context) {
        final AbstractC0292g abstractC0292gT = ((androidx.lifecycle.l) androidx.startup.a.e(context).f(ProcessLifecycleInitializer.class)).t();
        abstractC0292gT.a(new InterfaceC0288c() { // from class: androidx.emoji2.text.EmojiCompatInitializer.1
            @Override // androidx.lifecycle.InterfaceC0288c
            public void a(androidx.lifecycle.l lVar) {
                EmojiCompatInitializer.this.e();
                abstractC0292gT.c(this);
            }
        });
    }
