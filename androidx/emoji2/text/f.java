...
public class f {
    ...
    public static abstract class c {
        ...
        protected c(h hVar) {
            p064q.g.h(hVar, "metadataLoader cannot be null.");
            this.f4776a = hVar;
        }
    ...
    private static class g implements Runnable {
        ...
        g(AbstractC0072f abstractC0072f, int i3) {
            this(Arrays.asList((AbstractC0072f) p064q.g.h(abstractC0072f, "initCallback cannot be null")), i3, null);
        }
        ...
        g(Collection collection, int i3, Throwable th) {
            p064q.g.h(collection, "initCallbacks cannot be null");
    ...
    public void l() {
        p064q.g.i(this.f4770m == 1, "Set metadataLoadStrategy to LOAD_STRATEGY_MANUAL to execute manual loading");
        if (k()) {
            return;
        }
        this.f4758a.writeLock().lock();
    ...
    public CharSequence s(CharSequence charSequence, int i3, int i4, int i5, int i6) {
        boolean z3;
        p064q.g.i(k(), "Not initialized yet");
        p064q.g.e(i3, "start cannot be negative");
        p064q.g.e(i4, "end cannot be negative");
        p064q.g.e(i5, "maxEmojiCount cannot be negative");
        p064q.g.b(i3 <= i4, "start should be <= than end");
        if (charSequence == null) {
            return null;
        }
        p064q.g.b(i3 <= charSequence.length(), "start should be < than charSequence length");
        p064q.g.b(i4 <= charSequence.length(), "end should be < than charSequence length");
    ...
    public void t(AbstractC0072f abstractC0072f) {
        p064q.g.h(abstractC0072f, "initCallback cannot be null");
        this.f4758a.writeLock().lock();
        try {
