...
public final class o {
    ...
    private o(Typeface typeface, p100z.b bVar) {
        this.f4834d = typeface;
        this.f4831a = bVar;
        this.f4832b = new char[bVar.k() * 2];
        a(bVar);
    }

    private void a(p100z.b bVar) {
        int iK = bVar.k();
    ...
    void h(q qVar) {
        p064q.g.h(qVar, "emoji metadata cannot be null");
        p064q.g.b(qVar.c() > 0, "invalid metadata codepoint length");
