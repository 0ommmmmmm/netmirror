...
public abstract class d {
    ...
    public static class a {
        ...
        private f.c a(Context context, p060p.e eVar) {
            if (eVar == null) {
                return null;
            }
        ...
        private p060p.e d(ProviderInfo providerInfo, PackageManager packageManager) {
            String str = providerInfo.authority;
            String str2 = providerInfo.packageName;
            return new p060p.e(str, str2, "emojicompat-emoji-font", (List<List<byte[]>>) b(this.f4752a.b(packageManager, str2)));
        }
        ...
        p060p.e h(Context context) {
            PackageManager packageManager = context.getPackageManager();
            p064q.g.h(packageManager, "Package manager required to locate emoji font provider");
