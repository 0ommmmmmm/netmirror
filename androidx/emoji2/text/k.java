...
public class k extends f.c {
    ...
    public static class a {
        public Typeface a(Context context, p.g.b bVar) {
            return p060p.g.a(context, null, new p.g.b[]{bVar});
        }

        public p.g.a b(Context context, p060p.e eVar) {
            return p060p.g.b(context, null, eVar);
        }
    ...
    static class b implements f.h {
        ...
        b(Context context, p060p.e eVar, a aVar) {
            p064q.g.h(context, "Context cannot be null");
            p064q.g.h(eVar, "FontRequest cannot be null");
        ...
        private p.g.b e() {
            try {
                p.g.a aVarB = this.f4816c.b(this.f4814a, this.f4815b);
                if (aVarB.c() == 0) {
                    p.g.b[] bVarArrB = aVarB.b();
        ...
        public void a(f.i iVar) {
            p064q.g.h(iVar, "LoaderCallback cannot be null");
            synchronized (this.f4817d) {
                this.f4822i = iVar;
            }
            d();
    ...
    public k(Context context, p060p.e eVar) {
    ...
    public k(Context context, p060p.e eVar, a aVar) {
