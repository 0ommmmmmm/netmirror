...
public class C0257n0 {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final C0257n0 f4625b;
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            C0257n0 c0257n0A = new b().b(androidx.core.graphics.b.c(rect)).c(androidx.core.graphics.b.c(rect2)).a();
                            c0257n0A.s(c0257n0A);
                            c0257n0A.d(view.getRootView());
                            return c0257n0A;
                        }
                    }
    ...
    private static class f {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final C0257n0 f4639a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        androidx.core.graphics.b[] f4640b;

        f() {
            this(new C0257n0((C0257n0) null));
        }
    ...
    private static class i extends h {
        i(C0257n0 c0257n0, WindowInsets windowInsets) {
            super(c0257n0, windowInsets);
        }

        @Override // androidx.core.view.C0257n0.l
        C0257n0 a() {
            return C0257n0.v(this.f4646c.consumeDisplayCutout());
        }

        @Override // androidx.core.view.C0257n0.g, androidx.core.view.C0257n0.l
        ...
        @Override // androidx.core.view.C0257n0.l
        C0267v f() {
            return C0267v.f(this.f4646c.getDisplayCutout());
        }
    ...
    private static class k extends j {
        ...
        static final C0257n0 f4655q = C0257n0.v(WindowInsets.CONSUMED);

        k(C0257n0 c0257n0, WindowInsets windowInsets) {
            super(c0257n0, windowInsets);
        }
    ...
    private static class l {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        static final C0257n0 f4656b = new b().a().a().b().c();

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final C0257n0 f4657a;
        ...
        public boolean equals(Object obj) {
            ...
            l lVar = (l) obj;
            return o() == lVar.o() && n() == lVar.n() && p064q.c.a(k(), lVar.k()) && p064q.c.a(i(), lVar.i()) && p064q.c.a(f(), lVar.f());
        }
        ...
        public int hashCode() {
            return p064q.c.b(Boolean.valueOf(o()), Boolean.valueOf(n()), k(), i(), f());
        }
        ...
        C0257n0 m(int i3, int i4, int i5, int i6) {
            return f4656b;
        }
    ...
    private C0257n0(WindowInsets windowInsets) {
    ...
    public static C0257n0 v(WindowInsets windowInsets) {
        return w(windowInsets, null);
    }

    public static C0257n0 w(WindowInsets windowInsets, View view) {
        C0257n0 c0257n0 = new C0257n0((WindowInsets) p064q.g.g(windowInsets));
        if (view != null && view.isAttachedToWindow()) {
            c0257n0.s(Z.y(view));
            c0257n0.d(view.getRootView());
        }
        return c0257n0;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof C0257n0) {
            return p064q.c.a(this.f4626a, ((C0257n0) obj).f4626a);
        }
        return false;
    }
    ...
    public C0257n0 l(int i3, int i4, int i5, int i6) {
    ...
    public C0257n0 p(int i3, int i4, int i5, int i6) {
    ...
    private static class c extends f {
        ...
        private static Field f4632e;

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        private static boolean f4633f;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        private static Constructor f4634g;

        /* JADX INFO: renamed from: h, reason: collision with root package name */
        private static boolean f4635h;
        ...
        @Override // androidx.core.view.C0257n0.f
        C0257n0 b() {
            a();
            C0257n0 c0257n0V = C0257n0.v(this.f4636c);
            c0257n0V.q(this.f4640b);
            c0257n0V.t(this.f4637d);
            return c0257n0V;
        }
    ...
    private static class d extends f {
        ...
        C0257n0 b() {
            a();
            C0257n0 c0257n0V = C0257n0.v(this.f4638c.build());
            c0257n0V.q(this.f4640b);
            return c0257n0V;
        }
    ...
    private static class h extends g {
        ...
        h(C0257n0 c0257n0, WindowInsets windowInsets) {
            super(c0257n0, windowInsets);
            this.f4651m = null;
        }
        ...
        @Override // androidx.core.view.C0257n0.l
        C0257n0 b() {
            return C0257n0.v(this.f4646c.consumeStableInsets());
        }

        @Override // androidx.core.view.C0257n0.l
        C0257n0 c() {
            return C0257n0.v(this.f4646c.consumeSystemWindowInsets());
        }
    ...
    private static class g extends l {
        ...
        /* JADX INFO: renamed from: f, reason: collision with root package name */
        private C0257n0 f4649f;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        androidx.core.graphics.b f4650g;

        g(C0257n0 c0257n0, WindowInsets windowInsets) {
            super(c0257n0);
            this.f4648e = null;
        ...
        private androidx.core.graphics.b w() {
            C0257n0 c0257n0 = this.f4649f;
            return c0257n0 != null ? c0257n0.g() : androidx.core.graphics.b.f4471e;
        }
        ...
        @Override // androidx.core.view.C0257n0.l
        void e(C0257n0 c0257n0) {
            c0257n0.s(this.f4649f);
            c0257n0.r(this.f4650g);
        }
        ...
        @Override // androidx.core.view.C0257n0.l
        C0257n0 m(int i3, int i4, int i5, int i6) {
            b bVar = new b(C0257n0.v(this.f4646c));
            bVar.c(C0257n0.m(k(), i3, i4, i5, i6));
            bVar.b(C0257n0.m(i(), i3, i4, i5, i6));
            return bVar.a();
        }
        ...
        protected androidx.core.graphics.b v(int i3, boolean z3) {
            ...
            if (i3 == 2) {
                ...
                C0257n0 c0257n0 = this.f4649f;
                bVarG = c0257n0 != null ? c0257n0.g() : null;
            ...
            if (i3 != 8) {
                ...
                C0257n0 c0257n1 = this.f4649f;
                C0267v c0267vE = c0257n1 != null ? c0257n1.e() : f();
                return c0267vE != null ? androidx.core.graphics.b.b(c0267vE.c(), c0267vE.e(), c0267vE.d(), c0267vE.b()) : androidx.core.graphics.b.f4471e;
            }
        ...
        g(C0257n0 c0257n0, g gVar) {
            this(c0257n0, new WindowInsets(gVar.f4646c));
        }
    }
    ...
    private static class j extends i {
        ...
        j(C0257n0 c0257n0, WindowInsets windowInsets) {
            super(c0257n0, windowInsets);
            this.f4652n = null;
            this.f4653o = null;
            this.f4654p = null;
        ...
        @Override // androidx.core.view.C0257n0.g, androidx.core.view.C0257n0.l
        C0257n0 m(int i3, int i4, int i5, int i6) {
            return C0257n0.v(this.f4646c.inset(i3, i4, i5, i6));
        }

        @Override // androidx.core.view.C0257n0.h, androidx.core.view.C0257n0.l
        public void t(androidx.core.graphics.b bVar) {
        }

        j(C0257n0 c0257n0, j jVar) {
            super(c0257n0, jVar);
            this.f4652n = null;
            this.f4653o = null;
            this.f4654p = null;
    ...
    public static final class b {
        ...
        public b(C0257n0 c0257n0) {
            int i3 = Build.VERSION.SDK_INT;
            if (i3 >= 30) {
                this.f4631a = new e(c0257n0);
            } else if (i3 >= 29) {
                this.f4631a = new d(c0257n0);
            } else {
                this.f4631a = new c(c0257n0);
            }
        }
    }

    public C0257n0(C0257n0 c0257n0) {
        if (c0257n0 != null) {
            l lVar = c0257n0.f4626a;
            int i3 = Build.VERSION.SDK_INT;
