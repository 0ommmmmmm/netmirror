...
public class E {
    ...
    private boolean g(int i3, int i4, int i5, int i6, int[] iArr, int i7, int[] iArr2) {
        ...
        AbstractC0243g0.d(viewParentH, this.f4545c, i3, i4, i5, i6, i7, iArr3);
        if (iArr != null) {
            this.f4545c.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i8;
            iArr[1] = iArr[1] - i9;
    ...
    public boolean a(float f3, float f4, boolean z3) {
        ...
        return AbstractC0243g0.a(viewParentH, this.f4545c, f3, f4, z3);
    }
    ...
    public boolean b(float f3, float f4) {
        ...
        return AbstractC0243g0.b(viewParentH, this.f4545c, f3, f4);
    }
    ...
    public boolean d(int i3, int i4, int[] iArr, int[] iArr2, int i5) {
        ...
        iArr[0] = 0;
        iArr[1] = 0;
        AbstractC0243g0.c(viewParentH, this.f4545c, i3, i4, iArr, i5);
        if (iArr2 != null) {
            this.f4545c.getLocationInWindow(iArr2);
            iArr2[0] = iArr2[0] - i6;
            iArr2[1] = iArr2[1] - i7;
    ...
    public boolean p(int i3, int i4) {
        ...
        for (ViewParent parent = this.f4545c.getParent(); parent != null; parent = parent.getParent()) {
            if (AbstractC0243g0.f(parent, view, this.f4545c, i3, i4)) {
                n(i4, parent);
                AbstractC0243g0.e(parent, view, this.f4545c, i3, i4);
                return true;
            }
    ...
    public void r(int i3) {
        ...
        if (viewParentH != null) {
            AbstractC0243g0.g(viewParentH, this.f4545c, i3);
            n(i3, null);
        }
    }
}
