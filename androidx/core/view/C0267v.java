...
public final class C0267v {
    ...
    public C0267v(Rect rect, List<Rect> list) {
    ...
    static C0267v f(DisplayCutout displayCutout) {
        if (displayCutout == null) {
            return null;
        }
        return new C0267v(displayCutout);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || C0267v.class != obj.getClass()) {
            return false;
        }
        return p064q.c.a(this.f4668a, ((C0267v) obj).f4668a);
    }
    ...
    public C0267v(androidx.core.graphics.b bVar, Rect rect, Rect rect2, Rect rect3, Rect rect4, androidx.core.graphics.b bVar2) {
        this(a(bVar, rect, rect2, rect3, rect4, bVar2));
    }

    private C0267v(DisplayCutout displayCutout) {
