...
public abstract class AbstractC0237d0 {
    ...
    private static int a(Resources resources, int i3, p064q.i iVar, int i4) {
    ...
    public static int f(Context context, final ViewConfiguration viewConfiguration, int i3, int i4, int i5) {
        ...
        return a(resources, iC, new p064q.i() { // from class: androidx.core.view.b0
            @Override // p064q.i
    ...
    public static int g(Context context, final ViewConfiguration viewConfiguration, int i3, int i4, int i5) {
        ...
        Objects.requireNonNull(viewConfiguration);
        return a(resources, iD, new p064q.i() { // from class: androidx.core.view.c0
            @Override // p064q.i
            public final Object get() {
