...
public abstract class B {
    ...
    public static MenuItem a(MenuItem menuItem, AbstractC0232b abstractC0232b) {
        if (menuItem instanceof p052n.b) {
            return ((p052n.b) menuItem).a(abstractC0232b);
        }
    ...
    public static void b(MenuItem menuItem, char c4, int i3) {
        if (menuItem instanceof p052n.b) {
            ((p052n.b) menuItem).setAlphabeticShortcut(c4, i3);
    ...
    public static void c(MenuItem menuItem, CharSequence charSequence) {
        if (menuItem instanceof p052n.b) {
            ((p052n.b) menuItem).setContentDescription(charSequence);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void d(MenuItem menuItem, ColorStateList colorStateList) {
        if (menuItem instanceof p052n.b) {
            ((p052n.b) menuItem).setIconTintList(colorStateList);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void e(MenuItem menuItem, PorterDuff.Mode mode) {
        if (menuItem instanceof p052n.b) {
            ((p052n.b) menuItem).setIconTintMode(mode);
        } else if (Build.VERSION.SDK_INT >= 26) {
            a.j(menuItem, mode);
        }
    }
    ...
    public static void f(MenuItem menuItem, char c4, int i3) {
        if (menuItem instanceof p052n.b) {
            ((p052n.b) menuItem).setNumericShortcut(c4, i3);
        } else if (Build.VERSION.SDK_INT >= 26) {
            a.k(menuItem, c4, i3);
        }
    }
    ...
    public static void g(MenuItem menuItem, CharSequence charSequence) {
        if (menuItem instanceof p052n.b) {
            ((p052n.b) menuItem).setTooltipText(charSequence);
        } else if (Build.VERSION.SDK_INT >= 26) {
