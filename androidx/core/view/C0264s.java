...
public class C0264s {
    ...
    private final InterfaceC0265t f4659b;
    ...
    public C0264s(Context context, InterfaceC0265t interfaceC0265t) {
        this(context, interfaceC0265t, new b() { // from class: androidx.core.view.q
            @Override // androidx.core.view.C0264s.b
            public final void a(Context context2, int[] iArr, MotionEvent motionEvent, int i3) {
                C0264s.c(context2, iArr, motionEvent, i3);
            }
        }, new a() { // from class: androidx.core.view.r
            @Override // androidx.core.view.C0264s.a
            public final float a(VelocityTracker velocityTracker, MotionEvent motionEvent, int i3) {
                return C0264s.f(velocityTracker, motionEvent, i3);
            }
        });
    }
    ...
    public static void c(Context context, int[] iArr, MotionEvent motionEvent, int i3) {
        ...
        iArr[0] = AbstractC0237d0.g(context, viewConfiguration, motionEvent.getDeviceId(), i3, motionEvent.getSource());
        iArr[1] = AbstractC0237d0.f(context, viewConfiguration, motionEvent.getDeviceId(), i3, motionEvent.getSource());
    }
    ...
    public void g(MotionEvent motionEvent, int i3) {
        ...
        int i4 = iArr[1];
        float fMax = Math.max(-i4, Math.min(fE, i4));
        this.f4663f = this.f4659b.a(fMax) ? fMax : 0.0f;
    }

    C0264s(Context context, InterfaceC0265t interfaceC0265t, b bVar, a aVar) {
        this.f4664g = -1;
        this.f4665h = -1;
        this.f4666i = -1;
        this.f4667j = new int[]{Integer.MAX_VALUE, 0};
        this.f4658a = context;
        this.f4659b = interfaceC0265t;
        this.f4660c = bVar;
        this.f4661d = aVar;
    }
}
