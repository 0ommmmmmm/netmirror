...
public class C0230a {
    ...
    static final class C0066a extends View.AccessibilityDelegate {
        ...
        public AccessibilityNodeProvider getAccessibilityNodeProvider(View view) {
            p068r.w wVarB = this.f4595a.b(view);
            if (wVarB != null) {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            p068r.v vVarQ0 = p068r.v.Q0(accessibilityNodeInfo);
            vVarQ0.G0(Z.H(view));
            vVarQ0.x0(Z.D(view));
            vVarQ0.B0(Z.l(view));
            vVarQ0.L0(Z.z(view));
            ...
            List listC = C0230a.c(view);
            for (int i3 = 0; i3 < listC.size(); i3++) {
                vVarQ0.b((r.v.a) listC.get(i3));
            }
        }
    ...
    static List c(View view) {
        List list = (List) view.getTag(p048m.b.f9731H);
        return list == null ? Collections.emptyList() : list;
    }

    private boolean e(ClickableSpan clickableSpan, View view) {
        if (clickableSpan != null) {
            ClickableSpan[] clickableSpanArrR = p068r.v.r(view.createAccessibilityNodeInfo().getText());
    ...
    private boolean k(int i3, View view) {
        ...
        SparseArray sparseArray = (SparseArray) view.getTag(p048m.b.f9732I);
    ...
    public p068r.w b(View view) {
        ...
        if (accessibilityNodeProvider != null) {
            return new p068r.w(accessibilityNodeProvider);
        }
        return null;
    }
    ...
    public boolean j(View view, int i3, Bundle bundle) {
        ...
        return (zPerformAccessibilityAction || i3 != p048m.b.f9743a || bundle == null) ? zPerformAccessibilityAction : k(bundle.getInt("ACCESSIBILITY_CLICKABLE_SPAN_ID", -1), view);
    }
    ...
    public C0230a(View.AccessibilityDelegate accessibilityDelegate) {
