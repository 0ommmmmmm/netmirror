...
public abstract class a implements View.OnTouchListener {
    ...
    private static class C0069a {
        ...
        private float e(long j3) {
            ...
            long j5 = this.f4733i;
            if (j5 < 0 || j3 < j5) {
                return a.e((j3 - j4) / this.f4725a, 0.0f, 1.0f) * 0.5f;
            }
            float f3 = this.f4734j;
            return (1.0f - f3) + (f3 * a.e((j3 - j5) / this.f4735k, 0.0f, 1.0f));
        }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            ...
            return this.f4724r && this.f4722p;
        }
        this.f4721o = true;
        this.f4719m = false;
        this.f4708b.l(d(0, motionEvent.getX(), view.getWidth(), this.f4710d.getWidth()), d(1, motionEvent.getY(), view.getHeight(), this.f4710d.getHeight()));
        if (!this.f4722p && u()) {
            v();
        }
        if (this.f4724r) {
