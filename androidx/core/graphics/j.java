...
abstract class j {
    ...
    class a implements b {
        ...
        public int a(p.g.b bVar) {
            return bVar.e();
        }

        @Override // androidx.core.graphics.j.b
        /* JADX INFO: renamed from: d, reason: merged with bridge method [inline-methods] */
        public boolean b(p.g.b bVar) {
            return bVar.f();
        }
    }
    ...
    public abstract Typeface a(Context context, androidx.core.content.res.d.c cVar, Resources resources, int i3);

    public abstract Typeface b(Context context, CancellationSignal cancellationSignal, p.g.b[] bVarArr, int i3);
    ...
    protected p.g.b g(p.g.b[] bVarArr, int i3) {
        return (p.g.b) e(bVarArr, i3, new a());
    }
}
