...
public final class RemoteActionCompat implements L.a {
    ...
    public RemoteActionCompat(IconCompat iconCompat, CharSequence charSequence, CharSequence charSequence2, PendingIntent pendingIntent) {
        this.f4369a = (IconCompat) p064q.g.g(iconCompat);
        this.f4370b = (CharSequence) p064q.g.g(charSequence);
        this.f4371c = (CharSequence) p064q.g.g(charSequence2);
        this.f4372d = (PendingIntent) p064q.g.g(pendingIntent);
        this.f4373e = true;
        this.f4374f = true;
    }
