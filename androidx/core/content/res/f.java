...
public abstract class f {
    ...
    private static final class d {
        ...
        public boolean equals(Object obj) {
            ...
            d dVar = (d) obj;
            return this.f4450a.equals(dVar.f4450a) && p064q.c.a(this.f4451b, dVar.f4451b);
        }

        public int hashCode() {
            return p064q.c.b(this.f4450a, this.f4451b);
        }
    }
    ...
    */
    ...
    private static Typeface l(Context context, Resources resources, TypedValue typedValue, int i3, int i4, e eVar, Handler handler, boolean z3, boolean z4) {
        ...
        Typeface typefaceF = androidx.core.graphics.d.f(resources, i3, string, typedValue.assetCookie, i4);
        if (typefaceF != null) {
            if (eVar != null) {
        ...
        try {
            try {
                if (!string.toLowerCase().endsWith(".xml")) {
                    Typeface typefaceD = androidx.core.graphics.d.d(context, resources, i3, string, typedValue.assetCookie, i4);
                    if (eVar != null) {
                        if (typefaceD != null) {
                ...
                androidx.core.content.res.d.b bVarB = androidx.core.content.res.d.b(resources.getXml(i3), resources);
                if (bVarB != null) {
                    return androidx.core.graphics.d.c(context, bVarB, resources, i3, string, typedValue.assetCookie, i4, eVar, handler, z3);
                }
