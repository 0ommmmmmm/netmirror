...
public abstract class d {
    ...
    private static b e(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray typedArrayObtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), p048m.c.f9778h);
        String string = typedArrayObtainAttributes.getString(p048m.c.f9779i);
        String string2 = typedArrayObtainAttributes.getString(p048m.c.f9783m);
        String string3 = typedArrayObtainAttributes.getString(p048m.c.f9784n);
        int resourceId = typedArrayObtainAttributes.getResourceId(p048m.c.f9780j, 0);
        int integer = typedArrayObtainAttributes.getInteger(p048m.c.f9781k, 1);
        int integer2 = typedArrayObtainAttributes.getInteger(p048m.c.f9782l, 500);
        String string4 = typedArrayObtainAttributes.getString(p048m.c.f9785o);
        typedArrayObtainAttributes.recycle();
        if (string != null && string2 != null && string3 != null) {
            while (xmlPullParser.next() != 3) {
                g(xmlPullParser);
            }
            return new e(new p060p.e(string, string2, string3, (List<List<byte[]>>) c(resources, resourceId)), integer, integer2, string4);
        }
        ArrayList arrayList = new ArrayList();
        while (xmlPullParser.next() != 3) {
    ...
    private static C0060d f(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray typedArrayObtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), p048m.c.f9786p);
        int i3 = typedArrayObtainAttributes.getInt(typedArrayObtainAttributes.hasValue(p048m.c.f9795y) ? p048m.c.f9795y : p048m.c.f9788r, 400);
        boolean z3 = 1 == typedArrayObtainAttributes.getInt(typedArrayObtainAttributes.hasValue(p048m.c.f9793w) ? p048m.c.f9793w : p048m.c.f9789s, 0);
        int i4 = typedArrayObtainAttributes.hasValue(p048m.c.f9796z) ? p048m.c.f9796z : p048m.c.f9790t;
        String string = typedArrayObtainAttributes.getString(typedArrayObtainAttributes.hasValue(p048m.c.f9794x) ? p048m.c.f9794x : p048m.c.f9791u);
        int i5 = typedArrayObtainAttributes.getInt(i4, 0);
        int i6 = typedArrayObtainAttributes.hasValue(p048m.c.f9792v) ? p048m.c.f9792v : p048m.c.f9787q;
    ...
    public static final class e implements b {
        ...
        public e(p060p.e eVar, int i3, int i4, String str) {
            this.f4440a = eVar;
            this.f4442c = i3;
            this.f4441b = i4;
            this.f4443d = str;
        ...
        public e(p060p.e eVar, int i3, int i4) {
