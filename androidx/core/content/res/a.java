...
public class a {
    ...
    static void d(int i3, i iVar, float[] fArr, float[] fArr2) {
        ...
        float fPow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, iVar.e()), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((((double) (((double) fAtan2) < 20.14d ? 360.0f + fAtan2 : fAtan2)) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * iVar.g()) * iVar.h()) * ((float) Math.sqrt((f14 * f14) + (f15 * f15)))) / (f17 + 0.305f), 0.9d));
        float fSqrt = ((float) Math.sqrt(((double) fPow4) / 100.0d)) * fPow5;
        float fD = iVar.d() * fSqrt;
        float fSqrt2 = ((float) Math.sqrt((fPow5 * iVar.b()) / (iVar.a() + 4.0f))) * 50.0f;
    ...
    private static a f(float f3, float f4, float f5, i iVar) {
        double d4 = ((double) f3) / 100.0d;
        float fB = (4.0f / iVar.b()) * ((float) Math.sqrt(d4)) * (iVar.a() + 4.0f) * iVar.d();
        float fD = f4 * iVar.d();
        float fSqrt = ((float) Math.sqrt(((f4 / ((float) Math.sqrt(d4))) * iVar.b()) / (iVar.a() + 4.0f))) * 50.0f;
        float f6 = (1.7f * f3) / ((0.007f * f3) + 1.0f);
        float fLog = ((float) Math.log((((double) fD) * 0.0228d) + 1.0d)) * 43.85965f;
        double d5 = (3.1415927f * f5) / 180.0f;
        return new a(f5, f4, f3, fB, fD, fSqrt, f6, fLog * ((float) Math.cos(d5)), fLog * ((float) Math.sin(d5)));
    }
    ...
    int o(i iVar) {
        ...
        float fSignum3 = Math.signum(f10) * (100.0f / iVar.c()) * ((float) Math.pow((float) Math.max(0.0d, (((double) Math.abs(f10)) * 27.13d) / (400.0d - ((double) Math.abs(f10)))), 2.380952380952381d));
        float f11 = fSignum / iVar.i()[0];
        float f12 = fSignum2 / iVar.i()[1];
        float f13 = fSignum3 / iVar.i()[2];
        float[][] fArr = b.f4429b;
        float[] fArr2 = fArr[0];
