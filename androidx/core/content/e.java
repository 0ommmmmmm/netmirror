...
public abstract class e {
    public static int a(Context context, String str, int i3, int i4, String str2) {
        ...
        return ((Process.myUid() != i4 || !p064q.c.a(context.getPackageName(), str2)) ? androidx.core.app.e.b(context, strC, str2) : androidx.core.app.e.a(context, i4, strC, str2)) == 0 ? 0 : -2;
    }
