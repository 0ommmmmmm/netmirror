...
public final class Recreator implements InterfaceC0295j {
    ...
    private final void h(String str) {
        try {
            Class<? extends U> clsAsSubclass = Class.forName(str, false, Recreator.class.getClassLoader()).asSubclass(androidx.savedstate.a.InterfaceC0083a.class);
            h.e(clsAsSubclass, "{\n                Class.…class.java)\n            }");
            try {
                ...
                try {
                    ...
                    h.e(objNewInstance, "{\n                constr…wInstance()\n            }");
                    ((androidx.savedstate.a.InterfaceC0083a) objNewInstance).a(this.f5447a);
                } catch (Exception e4) {
