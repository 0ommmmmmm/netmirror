...
public final class a {
    ...
    private final p040k.b f5450a = new p040k.b();
    ...
    public static final void d(a aVar, l lVar, AbstractC0292g.a aVar2) {
        h.f(aVar, "this$0");
        h.f(lVar, "<anonymous parameter 0>");
        h.f(aVar2, "event");
        if (aVar2 == AbstractC0292g.a.ON_START) {
            aVar.f5455f = true;
        } else if (aVar2 == AbstractC0292g.a.ON_STOP) {
            aVar.f5455f = false;
        }
    }
    ...
    public final void e(AbstractC0292g abstractC0292g) {
        h.f(abstractC0292g, "lifecycle");
        if (this.f5451b) {
            throw new IllegalStateException("SavedStateRegistry was already attached.");
        }
        abstractC0292g.a(new InterfaceC0295j() { // from class: G.b
            @Override // androidx.lifecycle.InterfaceC0295j
            public final void d(l lVar, AbstractC0292g.a aVar) {
