...
public class c extends ViewGroup implements G, F {
    ...
    class d extends Animation {
        ...
        @Override // android.view.animation.Animation
        public void applyTransformation(float f3, Transformation transformation) {
            androidx.swiperefreshlayout.widget.b bVar = c.this.f5506D;
            int i3 = this.f5547b;
            bVar.setAlpha((int) (i3 + ((this.f5548c - i3) * f3)));
        }
    }
    ...
    class f extends Animation {
        ...
        public void applyTransformation(float f3, Transformation transformation) {
            ...
            c cVar2 = c.this;
            int i3 = cVar2.f5542y;
            c.this.setTargetOffsetTopAndBottom((i3 + ((int) ((iAbs - i3) * f3))) - cVar2.f5540w.getTop());
    ...
    public void m(View view, int i3, int i4, int i5, int i6, int i7, int[] iArr) {
        ...
        int i9 = i6 - (iArr[1] - i8);
        int i10 = i9 == 0 ? i6 + this.f5528k[1] : i9;
        if (i10 >= 0 || d()) {
            return;
        }
        float fAbs = this.f5524g + Math.abs(i10);
        this.f5524g = fAbs;
        l(fAbs);
        iArr[1] = iArr[1] + i9;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            setTargetOffsetTopAndBottom(this.f5503A - this.f5540w.getTop());
            ...
            this.f5534q = motionEvent.getY(iFindPointerIndex);
            ...
            int i3 = this.f5536s;
            if (i3 == -1) {
                Log.e(f5501Q, "Got ACTION_MOVE event but don't have an active pointer id.");
                return false;
            }
            int iFindPointerIndex2 = motionEvent.findPointerIndex(i3);
    ...
    void p(float f3) {
        int i3 = this.f5542y;
        setTargetOffsetTopAndBottom((i3 + ((int) ((this.f5503A - i3) * f3))) - this.f5540w.getTop());
    }
