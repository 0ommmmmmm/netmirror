...
public class C0216l extends EditText implements androidx.core.view.K {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final C0209e f4254b;
    ...
    class a {
        ...
        public TextClassifier a() {
            return C0216l.super.getTextClassifier();
        }

        public void b(TextClassifier textClassifier) {
            C0216l.super.setTextClassifier(textClassifier);
        }
    }
    ...
    public C0236d a(C0236d c0236d) {
        return this.f4257e.a(this, c0236d);
    }

    void d(C0217m c0217m) {
        KeyListener keyListener = getKeyListener();
        if (c0217m.b(keyListener)) {
            boolean zIsFocusable = super.isFocusable();
            boolean zIsClickable = super.isClickable();
            boolean zIsLongClickable = super.isLongClickable();
            int inputType = super.getInputType();
            KeyListener keyListenerA = c0217m.a(keyListener);
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        InputConnection inputConnectionA = AbstractC0219o.a(inputConnectionOnCreateInputConnection, editorInfo, this);
        if (inputConnectionA != null && Build.VERSION.SDK_INT <= 30 && (strArrU = androidx.core.view.Z.u(this)) != null) {
            p080u.c.d(editorInfo, strArrU);
            inputConnectionA = p080u.e.c(this, inputConnectionA, editorInfo);
        }
    ...
    public boolean onDragEvent(DragEvent dragEvent) {
        if (AbstractC0227x.a(this, dragEvent)) {
            return true;
        }
    ...
    public C0216l(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, p012d.a.f8659C);
    }
    ...
    public C0216l(Context context, AttributeSet attributeSet, int i3) {
        ...
        C0217m c0217m = new C0217m(this);
        this.f4258f = c0217m;
        c0217m.c(attributeSet, i3);
        d(c0217m);
    }
}
