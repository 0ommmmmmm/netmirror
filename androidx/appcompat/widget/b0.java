...
class b0 extends p084v.c implements View.OnClickListener {
    ...
    private static final class a {
        ...
        public a(View view) {
            ...
            this.f4110e = (ImageView) view.findViewById(p012d.f.f8801q);
        }
    }
    ...
    private CharSequence l(CharSequence charSequence) {
        if (this.f4100u == null) {
            ...
            this.f4095p.getTheme().resolveAttribute(p012d.a.f8671O, typedValue, true);
    ...
    @Override // p084v.a, android.widget.BaseAdapter, android.widget.SpinnerAdapter
    ...
    @Override // p084v.a, android.widget.Adapter
    ...
    @Override // p084v.c, p084v.a
    public View h(Context context, Cursor cursor, ViewGroup viewGroup) {
        View viewH = super.h(context, cursor, viewGroup);
        viewH.setTag(new a(viewH));
        ((ImageView) viewH.findViewById(p012d.f.f8801q)).setImageResource(this.f4097r);
        return viewH;
    }

    @Override // p084v.a, android.widget.BaseAdapter, android.widget.Adapter
