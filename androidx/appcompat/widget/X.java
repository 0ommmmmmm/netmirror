...
public final class X {
    ...
    private p044l.g f4040b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private p044l.h f4041c;
    ...
    private static class a extends p044l.e {
        public a(int i3) {
            super(i3);
        }
    ...
    private synchronized boolean a(Context context, long j3, Drawable drawable) {
        try {
            ...
            p044l.d dVar = (p044l.d) this.f4042d.get(context);
            if (dVar == null) {
                dVar = new p044l.d();
    ...
    private void b(Context context, int i3, ColorStateList colorStateList) {
        ...
        p044l.h hVar = (p044l.h) this.f4039a.get(context);
        if (hVar == null) {
            hVar = new p044l.h();
    ...
    private void c(Context context) {
        ...
        this.f4044f = true;
        Drawable drawableI = i(context, p024g.a.f9414a);
    ...
    private ColorStateList m(Context context, int i3) {
        ...
        if (weakHashMap == null || (hVar = (p044l.h) weakHashMap.get(context)) == null) {
            return null;
        }
    ...
    private Drawable q(Context context, int i3) {
        int next;
        p044l.g gVar = this.f4040b;
        if (gVar == null || gVar.isEmpty()) {
            return null;
        }
        p044l.h hVar = this.f4041c;
        if (hVar != null) {
