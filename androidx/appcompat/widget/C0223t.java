...
class C0223t extends PopupWindow {
    ...
    public C0223t(Context context, AttributeSet attributeSet, int i3) {
        super(context, attributeSet, i3);
        a(context, attributeSet, i3, 0);
    }

    private void a(Context context, AttributeSet attributeSet, int i3, int i4) {
        h0 h0VarU = h0.u(context, attributeSet, p012d.j.f8947Y1, i3, i4);
        if (h0VarU.r(p012d.j.f8956a2)) {
            b(h0VarU.a(p012d.j.f8956a2, false));
        }
        setBackgroundDrawable(h0VarU.f(p012d.j.f8951Z1));
        h0VarU.w();
    }
    ...
    public C0223t(Context context, AttributeSet attributeSet, int i3, int i4) {
