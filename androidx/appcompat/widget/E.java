...
class E {
    ...
    private boolean y() {
        return !(this.f3794i instanceof C0216l);
    }
    ...
    void o(AttributeSet attributeSet, int i3) {
        int resourceId;
        TypedArray typedArrayObtainStyledAttributes = this.f3795j.obtainStyledAttributes(attributeSet, p012d.j.f8983g0, i3, 0);
        TextView textView = this.f3794i;
        androidx.core.view.Z.V(textView, textView.getContext(), p012d.j.f8983g0, attributeSet, typedArrayObtainStyledAttributes, i3, 0);
        if (typedArrayObtainStyledAttributes.hasValue(p012d.j.f9003l0)) {
            this.f3786a = typedArrayObtainStyledAttributes.getInt(p012d.j.f9003l0, 0);
        }
        float dimension = typedArrayObtainStyledAttributes.hasValue(p012d.j.f8999k0) ? typedArrayObtainStyledAttributes.getDimension(p012d.j.f8999k0, -1.0f) : -1.0f;
        float dimension2 = typedArrayObtainStyledAttributes.hasValue(p012d.j.f8991i0) ? typedArrayObtainStyledAttributes.getDimension(p012d.j.f8991i0, -1.0f) : -1.0f;
        float dimension3 = typedArrayObtainStyledAttributes.hasValue(p012d.j.f8987h0) ? typedArrayObtainStyledAttributes.getDimension(p012d.j.f8987h0, -1.0f) : -1.0f;
        if (typedArrayObtainStyledAttributes.hasValue(p012d.j.f8995j0) && (resourceId = typedArrayObtainStyledAttributes.getResourceId(p012d.j.f8995j0, 0)) > 0) {
