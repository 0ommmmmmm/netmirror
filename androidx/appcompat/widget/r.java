...
public class r extends ImageView {
    ...
    private final C0209e f4316b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final C0221q f4317c;
    ...
    protected void drawableStateChanged() {
        ...
        C0209e c0209e = this.f4316b;
        if (c0209e != null) {
            c0209e.b();
        }
        C0221q c0221q = this.f4317c;
        if (c0221q != null) {
            c0221q.c();
        }
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        C0221q c0221q = this.f4317c;
        if (c0221q != null && drawable != null && !this.f4318d) {
            c0221q.h(drawable);
        }
        super.setImageDrawable(drawable);
        C0221q c0221q2 = this.f4317c;
        if (c0221q2 != null) {
            c0221q2.c();
            if (this.f4318d) {
                return;
