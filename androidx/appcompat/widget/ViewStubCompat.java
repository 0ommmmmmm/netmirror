...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet, int i3) {
        ...
        this.f4026b = 0;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, p012d.j.O3, i3, 0);
        this.f4027c = typedArrayObtainStyledAttributes.getResourceId(p012d.j.R3, -1);
        this.f4026b = typedArrayObtainStyledAttributes.getResourceId(p012d.j.Q3, 0);
        setId(typedArrayObtainStyledAttributes.getResourceId(p012d.j.P3, -1));
