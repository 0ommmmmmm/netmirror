...
class P extends ListView {
    ...
    private static class d extends p020f.a {
        ...
        @Override // p020f.a, android.graphics.drawable.Drawable
    ...
    P(Context context, boolean z3) {
        super(context, null, p012d.a.f8658B);
    ...
    public boolean e(MotionEvent motionEvent, int i3) {
        boolean z3;
        boolean z4;
        ...
        if (actionMasked == 1) {
            ...
            if (actionMasked != 2) {
                ...
                if (z3) {
                    if (this.f3822m == null) {
                        this.f3822m = new androidx.core.widget.f(this);
                    }
                    this.f3822m.m(true);
                    this.f3822m.onTouch(this, motionEvent);
                } else {
                    fVar = this.f3822m;
                    if (fVar != null) {
                        fVar.m(false);
        ...
        if (iFindPointerIndex < 0) {
            ...
            if (iPointToPosition == -1) {
                ...
                i(childAt, iPointToPosition, x3, y3);
                if (actionMasked == 1) {
