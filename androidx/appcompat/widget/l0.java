...
public class l0 implements J {
    ...
    class a implements View.OnClickListener {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final p032i.a f4278b;

        a() {
            this.f4278b = new p032i.a(l0.this.f4261a.getContext(), 0, R.id.home, 0, 0, l0.this.f4269i);
        }
    ...
    public l0(Toolbar toolbar, boolean z3) {
        this(toolbar, z3, p012d.h.f8831a, p012d.e.f8756n);
    }
    ...
    public void a(Menu menu, androidx.appcompat.view.menu.j.a aVar) {
        if (this.f4274n == null) {
            C0207c c0207c = new C0207c(this.f4261a.getContext());
            this.f4274n = c0207c;
            c0207c.p(p012d.f.f8791g);
        }
        this.f4274n.k(aVar);
    ...
    @Override // androidx.appcompat.widget.J
    public C0247i0 r(int i3, long j3) {
    ...
    public void setIcon(int i3) {
        setIcon(i3 != 0 ? p016e.a.b(c(), i3) : null);
    }
    ...
    public l0(Toolbar toolbar, boolean z3, int i3, int i4) {
        ...
        h0 h0VarU = h0.u(toolbar.getContext(), null, p012d.j.f8953a, p012d.a.f8676c, 0);
        this.f4277q = h0VarU.f(p012d.j.f9002l);
        if (z3) {
            CharSequence charSequenceO = h0VarU.o(p012d.j.f9026r);
            if (!TextUtils.isEmpty(charSequenceO)) {
                D(charSequenceO);
            }
            CharSequence charSequenceO2 = h0VarU.o(p012d.j.f9018p);
            if (!TextUtils.isEmpty(charSequenceO2)) {
                C(charSequenceO2);
            }
            Drawable drawableF = h0VarU.f(p012d.j.f9010n);
            if (drawableF != null) {
                y(drawableF);
            }
            Drawable drawableF2 = h0VarU.f(p012d.j.f9006m);
            if (drawableF2 != null) {
                setIcon(drawableF2);
            }
            ...
            n(h0VarU.j(p012d.j.f8986h, 0));
            int iM = h0VarU.m(p012d.j.f8982g, 0);
            if (iM != 0) {
                w(LayoutInflater.from(this.f4261a.getContext()).inflate(iM, (ViewGroup) this.f4261a, false));
                n(this.f4262b | 16);
            }
            int iL = h0VarU.l(p012d.j.f8994j, 0);
            if (iL > 0) {
