...
public class A extends Spinner {
    ...
    private static final class c {
        static void a(ThemedSpinnerAdapter themedSpinnerAdapter, Resources.Theme theme) {
            if (p064q.c.a(themedSpinnerAdapter.getDropDownViewTheme(), theme)) {
                return;
            }
    ...
    class d implements h, DialogInterface.OnClickListener {
        ...
        public void m(int i3, int i4) {
            ...
            androidx.appcompat.app.b.a aVar = new androidx.appcompat.app.b.a(A.this.getPopupContext());
    ...
    public void setPopupBackgroundResource(int i3) {
        setPopupBackgroundDrawable(p016e.a.b(getPopupContext(), i3));
    }
    ...
    public A(Context context, int i3) {
        this(context, null, p012d.a.f8669M, i3);
    }
    ...
    public A(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, p012d.a.f8669M);
    }
    ...
    public A(Context context, AttributeSet attributeSet, int i3, int i4, Resources.Theme theme) throws Throwable {
        TypedArray typedArrayObtainStyledAttributes;
        CharSequence[] charSequenceArrP;
        SpinnerAdapter spinnerAdapter;
        super(context, attributeSet, i3);
        this.f3637i = new Rect();
        d0.a(this, getContext());
        h0 h0VarU = h0.u(context, attributeSet, p012d.j.f9053x2, i3, 0);
        this.f3630b = new C0209e(this);
        if (theme != null) {
            this.f3631c = new androidx.appcompat.view.d(context, theme);
        } else {
            int iM = h0VarU.m(p012d.j.f8860C2, 0);
            if (iM != 0) {
                this.f3631c = new androidx.appcompat.view.d(context, iM);
            } else {
                this.f3631c = context;
            }
        }
        ...
        try {
            if (i4 == -1) {
                try {
                    typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f3629j, i3, 0);
                    try {
                        boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(0);
                        r11 = typedArrayObtainStyledAttributes;
                        if (zHasValue) {
                            i4 = typedArrayObtainStyledAttributes.getInt(0, 0);
                            r11 = typedArrayObtainStyledAttributes;
                        }
                    } catch (Exception e4) {
                        e = e4;
                        ...
                        if (i4 != 0) {
                            d dVar = new d();
                            this.f3635g = dVar;
                            dVar.h(h0VarU.n(p012d.j.f8852A2));
                        } else if (i4 == 1) {
                            f fVar = new f(this.f3631c, attributeSet, i3);
                            h0 h0VarU2 = h0.u(this.f3631c, attributeSet, p012d.j.f9053x2, i3, 0);
                            this.f3636h = h0VarU2.l(p012d.j.f8856B2, -2);
                            fVar.i(h0VarU2.f(p012d.j.f9061z2));
                            fVar.h(h0VarU.n(p012d.j.f8852A2));
                            h0VarU2.w();
                            this.f3635g = fVar;
                            this.f3632d = new a(this, fVar);
                        }
                        charSequenceArrP = h0VarU.p(p012d.j.f9057y2);
                        if (charSequenceArrP != null) {
                            ArrayAdapter arrayAdapter = new ArrayAdapter(context, R.layout.simple_spinner_item, charSequenceArrP);
                            arrayAdapter.setDropDownViewResource(p012d.g.f8830t);
                            setAdapter(arrayAdapter);
                        }
                        h0VarU.w();
                        this.f3634f = true;
                        spinnerAdapter = this.f3633e;
                        if (spinnerAdapter != null) {
                            setAdapter(spinnerAdapter);
                            this.f3633e = null;
                        }
                        this.f3630b.e(attributeSet, i3);
                    }
                } catch (Exception e5) {
                    e = e5;
            ...
            if (i4 != 0) {
                d dVar2 = new d();
                this.f3635g = dVar2;
                dVar2.h(h0VarU.n(p012d.j.f8852A2));
            } else if (i4 == 1) {
                f fVar2 = new f(this.f3631c, attributeSet, i3);
                h0 h0VarU3 = h0.u(this.f3631c, attributeSet, p012d.j.f9053x2, i3, 0);
                this.f3636h = h0VarU3.l(p012d.j.f8856B2, -2);
                fVar2.i(h0VarU3.f(p012d.j.f9061z2));
                fVar2.h(h0VarU.n(p012d.j.f8852A2));
                h0VarU3.w();
                this.f3635g = fVar2;
                this.f3632d = new a(this, fVar2);
            }
            charSequenceArrP = h0VarU.p(p012d.j.f9057y2);
            if (charSequenceArrP != null) {
                ArrayAdapter arrayAdapter2 = new ArrayAdapter(context, R.layout.simple_spinner_item, charSequenceArrP);
                arrayAdapter2.setDropDownViewResource(p012d.g.f8830t);
