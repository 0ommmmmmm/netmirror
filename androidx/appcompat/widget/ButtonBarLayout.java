...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f3744d = -1;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, p012d.j.f8902N0);
        androidx.core.view.Z.V(this, context, p012d.j.f8902N0, attributeSet, typedArrayObtainStyledAttributes, 0, 0);
        this.f3742b = typedArrayObtainStyledAttributes.getBoolean(p012d.j.f8906O0, true);
    ...
    private void setStacked(boolean z3) {
        if (this.f3743c != z3) {
            if (!z3 || this.f3742b) {
                ...
                View viewFindViewById = findViewById(p012d.f.f8775G);
