...
public class a0 extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    private class b extends BaseAdapter {
        ...
        public View getView(int i3, View view, ViewGroup viewGroup) {
            if (view == null) {
                return a0.this.d((androidx.appcompat.app.a.b) getItem(i3), true);
            }
            ((d) view).a((androidx.appcompat.app.a.b) getItem(i3));
            return view;
        }
    }
    ...
    private class d extends LinearLayout {
        ...
        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private androidx.appcompat.app.a.b f4083c;
        ...
        public d(Context context, androidx.appcompat.app.a.b bVar, boolean z3) {
            super(context, null, p012d.a.f8678e);
            int[] iArr = {R.attr.background};
            this.f4082b = iArr;
            this.f4083c = bVar;
            h0 h0VarU = h0.u(context, null, iArr, p012d.a.f8678e, 0);
            if (h0VarU.r(0)) {
        ...
        public void c() {
            androidx.appcompat.app.a.b bVar = this.f4083c;
            View viewB = bVar.b();
            if (viewB != null) {
            ...
            if (zIsEmpty) {
                ...
                if (this.f4084d == null) {
                    D d4 = new D(getContext(), null, p012d.a.f8679f);
    ...
    private Spinner b() {
        A a4 = new A(getContext(), null, p012d.a.f8682i);
    ...
    private T c() {
        T t3 = new T(getContext(), null, p012d.a.f8677d);
    ...
    d d(androidx.appcompat.app.a.b bVar, boolean z3) {
