...
public class h0 {
    ...
    public ColorStateList c(int i3) {
        ...
        return (!this.f4228b.hasValue(i3) || (resourceId = this.f4228b.getResourceId(i3, 0)) == 0 || (colorStateListA = p016e.a.a(this.f4227a, resourceId)) == null) ? this.f4228b.getColorStateList(i3) : colorStateListA;
    }
    ...
    public Drawable f(int i3) {
        int resourceId;
        return (!this.f4228b.hasValue(i3) || (resourceId = this.f4228b.getResourceId(i3, 0)) == 0) ? this.f4228b.getDrawable(i3) : p016e.a.b(this.f4227a, resourceId);
    }
    ...
    public Drawable g(int i3) {
        ...
        return C0215k.b().d(this.f4227a, resourceId, true);
    }
    ...
    public Typeface i(int i3, int i4, androidx.core.content.res.f.e eVar) {
