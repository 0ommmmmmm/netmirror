...
public abstract class d0 {
    ...
    public static void a(View view, Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(p012d.j.f9055y0);
        try {
    ...
    static int d(Context context, int i3, float f3) {
        int iC = c(context, i3);
        return androidx.core.graphics.a.g(iC, Math.round(Color.alpha(iC) * f3));
    }
