...
public class Toolbar extends ViewGroup implements InterfaceC0271z {
    ...
    private C0207c f3941L;

    /* JADX INFO: renamed from: M, reason: collision with root package name */
    private f f3942M;

    /* JADX INFO: renamed from: N, reason: collision with root package name */
    private androidx.appcompat.view.menu.j.a f3943N;

    /* JADX INFO: renamed from: O, reason: collision with root package name */
    androidx.appcompat.view.menu.e.a f3944O;
    ...
    class c implements androidx.appcompat.view.menu.e.a {
        ...
        public boolean a(androidx.appcompat.view.menu.e eVar, MenuItem menuItem) {
            androidx.appcompat.view.menu.e.a aVar = Toolbar.this.f3944O;
    ...
    public static class i extends p088w.a {
    ...
    private void b(List list, int i3) {
        ...
        int childCount = getChildCount();
        int iA = AbstractC0268w.a(i3, getLayoutDirection());
        list.clear();
        if (!z3) {
    ...
    private void c(View view, boolean z3) {
        ...
        gVarGenerateLayoutParams.f3982b = 1;
    ...
    private void m() {
        if (this.f3953e == null) {
            this.f3953e = new C0220p(getContext(), null, p012d.a.f8672P);
            g gVarGenerateDefaultLayoutParams = generateDefaultLayoutParams();
    ...
    private int r(int i3) {
        ...
        int iA = AbstractC0268w.a(i3, layoutDirection) & 7;
        if (iA == 1 || iA == 3 || iA == 5) {
            return iA;
        }
    ...
    public void M(androidx.appcompat.view.menu.e eVar, C0207c c0207c) {
        ...
        c0207c.G(true);
        if (eVar != null) {
            eVar.c(c0207c, this.f3959k);
            eVar.c(this.f3942M, this.f3959k);
        } else {
            c0207c.d(this.f3959k, null);
            this.f3942M.d(this.f3959k, null);
            c0207c.f(true);
            this.f3942M.f(true);
        }
        this.f3950b.setPopupTheme(this.f3960l);
        this.f3950b.setPresenter(c0207c);
        this.f3941L = c0207c;
        S();
    }
    ...
    C0207c getOuterActionMenuPresenter() {
        return this.f3941L;
    }
    ...
    void h() {
        if (this.f3957i == null) {
            C0220p c0220p = new C0220p(getContext(), null, p012d.a.f8672P);
            this.f3957i = c0220p;
            c0220p.setImageDrawable(this.f3955g);
    ...
    protected void onLayout(boolean z3, int i3, int i4, int i5, int i6) {
        ...
        iArr[1] = 0;
        iArr[0] = 0;
        int iT = androidx.core.view.Z.t(this);
        int iMin2 = iT >= 0 ? Math.min(iT, i6 - i4) : 0;
        if (Q(this.f3953e)) {
            if (z5) {
                iF = F(this.f3953e, i26, iArr, iMin2);
                iE = paddingLeft;
            } else {
                iE = E(this.f3953e, paddingLeft, iArr, iMin2);
            }
            if (Q(this.f3957i)) {
                if (z5) {
                    iF = F(this.f3957i, iF, iArr, iMin2);
                } else {
                    iE = E(this.f3957i, iE, iArr, iMin2);
                }
            }
            if (Q(this.f3950b)) {
                if (z5) {
                    iE = E(this.f3950b, iE, iArr, iMin2);
                } else {
                    iF = F(this.f3950b, iF, iArr, iMin2);
                }
            }
            int currentContentInsetLeft = getCurrentContentInsetLeft();
            int currentContentInsetRight = getCurrentContentInsetRight();
            iArr[0] = Math.max(0, currentContentInsetLeft - iE);
            iArr[1] = Math.max(0, currentContentInsetRight - (i26 - iF));
            iMax = Math.max(iE, currentContentInsetLeft);
            iMin = Math.min(iF, i26 - currentContentInsetRight);
            if (Q(this.f3958j)) {
                if (z5) {
                    iMin = F(this.f3958j, iMin, iArr, iMin2);
                } else {
                    iMax = E(this.f3958j, iMax, iArr, iMin2);
                }
            }
            if (Q(this.f3954f)) {
                if (z5) {
                    iMin = F(this.f3954f, iMin, iArr, iMin2);
                } else {
                    iMax = E(this.f3954f, iMax, iArr, iMin2);
                }
            }
            zQ = Q(this.f3951c);
            zQ2 = Q(this.f3952d);
            if (zQ) {
                g gVar3 = (g) this.f3951c.getLayoutParams();
                measuredHeight = ((ViewGroup.MarginLayoutParams) gVar3).topMargin + this.f3951c.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) gVar3).bottomMargin;
            } else {
                measuredHeight = 0;
            }
            if (zQ2) {
                g gVar4 = (g) this.f3952d.getLayoutParams();
                measuredHeight += ((ViewGroup.MarginLayoutParams) gVar4).topMargin + this.f3952d.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) gVar4).bottomMargin;
            }
            if (!zQ || zQ2) {
                if (zQ) {
                    textView = this.f3951c;
                } else {
                    textView = this.f3952d;
                }
                if (zQ2) {
                    textView2 = this.f3952d;
                } else {
                    textView2 = this.f3951c;
                }
                gVar = (g) textView.getLayoutParams();
                gVar2 = (g) textView2.getLayoutParams();
                z4 = (!zQ && this.f3951c.getMeasuredWidth() > 0) || (zQ2 && this.f3952d.getMeasuredWidth() > 0);
                i7 = this.f3972x & 112;
                i8 = paddingLeft;
                if (i7 == 48) {
                    paddingTop = getPaddingTop() + ((ViewGroup.MarginLayoutParams) gVar).topMargin + this.f3967s;
                } else if (i7 != 80) {
                    ...
                    if (iMax2 < i16 + i17) {
                        ...
                        i18 = (((height - paddingBottom) - measuredHeight) - iMax2) - paddingTop2;
                    ...
                    paddingTop = (((height - paddingBottom) - ((ViewGroup.MarginLayoutParams) gVar2).bottomMargin) - this.f3968t) - measuredHeight;
                }
                if (z5) {
                    if (z4) {
                        i13 = this.f3965q;
                    ...
                    if (zQ) {
                        g gVar5 = (g) this.f3951c.getLayoutParams();
                        int measuredWidth = iMin - this.f3951c.getMeasuredWidth();
                        int measuredHeight2 = this.f3951c.getMeasuredHeight() + paddingTop;
                        this.f3951c.layout(measuredWidth, paddingTop, iMin, measuredHeight2);
                        i14 = measuredWidth - this.f3966r;
                        paddingTop = measuredHeight2 + ((ViewGroup.MarginLayoutParams) gVar5).bottomMargin;
                    } else {
                        i14 = iMin;
                    }
                    if (zQ2) {
                        int i28 = paddingTop + ((ViewGroup.MarginLayoutParams) ((g) this.f3952d.getLayoutParams())).topMargin;
                        this.f3952d.layout(iMin - this.f3952d.getMeasuredWidth(), i28, iMin, this.f3952d.getMeasuredHeight() + i28);
                        i15 = iMin - this.f3966r;
                    } else {
                        i15 = iMin;
                    }
                    if (z4) {
                    ...
                    if (zQ) {
                        g gVar6 = (g) this.f3951c.getLayoutParams();
                        int measuredWidth2 = this.f3951c.getMeasuredWidth() + iMax;
                        int measuredHeight3 = this.f3951c.getMeasuredHeight() + paddingTop;
                        this.f3951c.layout(iMax, paddingTop, measuredWidth2, measuredHeight3);
                        i11 = measuredWidth2 + this.f3966r;
                        paddingTop = measuredHeight3 + ((ViewGroup.MarginLayoutParams) gVar6).bottomMargin;
                    } else {
                        i11 = iMax;
                    }
                    if (zQ2) {
                        int i30 = paddingTop + ((ViewGroup.MarginLayoutParams) ((g) this.f3952d.getLayoutParams())).topMargin;
                        int measuredWidth3 = this.f3952d.getMeasuredWidth() + iMax;
                        this.f3952d.layout(iMax, i30, measuredWidth3, this.f3952d.getMeasuredHeight() + i30);
                        i12 = measuredWidth3 + this.f3966r;
                    } else {
                        i12 = iMax;
                    }
                    if (z4) {
                ...
                b(this.f3934E, 3);
                size = this.f3934E.size();
                iE2 = iMax;
                for (i21 = i10; i21 < size; i21++) {
                    iE2 = E((View) this.f3934E.get(i21), iE2, iArr, iMin2);
                }
                i22 = iMin2;
                b(this.f3934E, 5);
                size2 = this.f3934E.size();
                for (i23 = i10; i23 < size2; i23++) {
                    iMin = F((View) this.f3934E.get(i23), iMin, iArr, i22);
                }
                b(this.f3934E, 1);
                int iW = w(this.f3934E, iArr);
                i24 = (i8 + (((width - i8) - paddingRight) / 2)) - (iW / 2);
                i25 = iW + i24;
                if (i24 >= iE2) {
                    if (i25 > iMin) {
                        iE2 = i24 - (i25 - iMin);
                ...
                size3 = this.f3934E.size();
                while (i10 < size3) {
                    iE2 = E((View) this.f3934E.get(i10), iE2, iArr, i22);
                    i10++;
                }
                this.f3934E.clear();
            }
            ...
            b(this.f3934E, 1);
            int iW2 = w(this.f3934E, iArr);
            i24 = (i8 + (((width - i8) - paddingRight) / 2)) - (iW2 / 2);
            i25 = iW2 + i24;
            if (i24 >= iE2) {
                if (i25 > iMin) {
                    iE2 = i24 - (i25 - iMin);
        ...
        iArr[1] = Math.max(0, currentContentInsetRight2 - (i26 - iF));
        iMax = Math.max(iE, currentContentInsetLeft2);
        iMin = Math.min(iF, i26 - currentContentInsetRight2);
        if (Q(this.f3958j)) {
            if (z5) {
                iMin = F(this.f3958j, iMin, iArr, iMin2);
            } else {
        ...
        zQ2 = Q(this.f3952d);
        if (zQ) {
            g gVar7 = (g) this.f3951c.getLayoutParams();
            measuredHeight = ((ViewGroup.MarginLayoutParams) gVar7).topMargin + this.f3951c.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) gVar7).bottomMargin;
        } else {
            measuredHeight = 0;
        }
        if (zQ2) {
            g gVar8 = (g) this.f3952d.getLayoutParams();
            measuredHeight += ((ViewGroup.MarginLayoutParams) gVar8).topMargin + this.f3952d.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) gVar8).bottomMargin;
        }
        if (zQ) {
            if (zQ) {
                textView = this.f3951c;
            ...
            if (z5) {
                ...
                if (zQ) {
                    g gVar9 = (g) this.f3951c.getLayoutParams();
                    int measuredWidth4 = iMin - this.f3951c.getMeasuredWidth();
                    int measuredHeight4 = this.f3951c.getMeasuredHeight() + paddingTop;
                    this.f3951c.layout(measuredWidth4, paddingTop, iMin, measuredHeight4);
                    i14 = measuredWidth4 - this.f3966r;
                    paddingTop = measuredHeight4 + ((ViewGroup.MarginLayoutParams) gVar9).bottomMargin;
                } else {
                    i14 = iMin;
                }
                if (zQ2) {
                    int i211 = paddingTop + ((ViewGroup.MarginLayoutParams) ((g) this.f3952d.getLayoutParams())).topMargin;
                    this.f3952d.layout(iMin - this.f3952d.getMeasuredWidth(), i211, iMin, this.f3952d.getMeasuredHeight() + i211);
                    i15 = iMin - this.f3966r;
                } else {
                    i15 = iMin;
                }
                ...
                if (zQ) {
                    g gVar10 = (g) this.f3951c.getLayoutParams();
                    int measuredWidth5 = this.f3951c.getMeasuredWidth() + iMax;
                    int measuredHeight5 = this.f3951c.getMeasuredHeight() + paddingTop;
                    this.f3951c.layout(iMax, paddingTop, measuredWidth5, measuredHeight5);
                    i11 = measuredWidth5 + this.f3966r;
                    paddingTop = measuredHeight5 + ((ViewGroup.MarginLayoutParams) gVar10).bottomMargin;
                } else {
                    i11 = iMax;
                }
                if (zQ2) {
                    int i31 = paddingTop + ((ViewGroup.MarginLayoutParams) ((g) this.f3952d.getLayoutParams())).topMargin;
                    int measuredWidth6 = this.f3952d.getMeasuredWidth() + iMax;
                    this.f3952d.layout(iMax, i31, measuredWidth6, this.f3952d.getMeasuredHeight() + i31);
                    i12 = measuredWidth6 + this.f3966r;
                } else {
                    i12 = iMax;
                }
                if (z4) {
            ...
            if (z5) {
                ...
                if (zQ) {
                    g gVar11 = (g) this.f3951c.getLayoutParams();
                    int measuredWidth7 = iMin - this.f3951c.getMeasuredWidth();
                    int measuredHeight6 = this.f3951c.getMeasuredHeight() + paddingTop;
                    this.f3951c.layout(measuredWidth7, paddingTop, iMin, measuredHeight6);
                    i14 = measuredWidth7 - this.f3966r;
                    paddingTop = measuredHeight6 + ((ViewGroup.MarginLayoutParams) gVar11).bottomMargin;
                } else {
                    i14 = iMin;
                }
                if (zQ2) {
                    int i214 = paddingTop + ((ViewGroup.MarginLayoutParams) ((g) this.f3952d.getLayoutParams())).topMargin;
                    this.f3952d.layout(iMin - this.f3952d.getMeasuredWidth(), i214, iMin, this.f3952d.getMeasuredHeight() + i214);
                    i15 = iMin - this.f3966r;
                } else {
                    i15 = iMin;
                }
                ...
                if (zQ) {
                    g gVar12 = (g) this.f3951c.getLayoutParams();
                    int measuredWidth8 = this.f3951c.getMeasuredWidth() + iMax;
                    int measuredHeight7 = this.f3951c.getMeasuredHeight() + paddingTop;
                    this.f3951c.layout(iMax, paddingTop, measuredWidth8, measuredHeight7);
                    i11 = measuredWidth8 + this.f3966r;
                    paddingTop = measuredHeight7 + ((ViewGroup.MarginLayoutParams) gVar12).bottomMargin;
                } else {
                    i11 = iMax;
                }
                if (zQ2) {
                    int i32 = paddingTop + ((ViewGroup.MarginLayoutParams) ((g) this.f3952d.getLayoutParams())).topMargin;
                    int measuredWidth9 = this.f3952d.getMeasuredWidth() + iMax;
                    this.f3952d.layout(iMax, i32, measuredWidth9, this.f3952d.getMeasuredHeight() + i32);
                    i12 = measuredWidth9 + this.f3966r;
                } else {
                    i12 = iMax;
                }
                if (z4) {
        ...
        b(this.f3934E, 1);
        int iW3 = w(this.f3934E, iArr);
        i24 = (i8 + (((width - i8) - paddingRight) / 2)) - (iW3 / 2);
        i25 = iW3 + i24;
        if (i24 >= iE2) {
            if (i25 > iMin) {
                iE2 = i24 - (i25 - iMin);
    ...
    public g generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        ...
        if (layoutParams instanceof androidx.appcompat.app.a.C0051a) {
            return new g((androidx.appcompat.app.a.C0051a) layoutParams);
        }
    ...
    public void setCollapseIcon(int i3) {
        setCollapseIcon(p016e.a.b(getContext(), i3));
    }
    ...
    public void setLogo(int i3) {
        setLogo(p016e.a.b(getContext(), i3));
    }
    ...
    public void setNavigationIcon(int i3) {
        setNavigationIcon(p016e.a.b(getContext(), i3));
    }
    ...
    public static class g extends androidx.appcompat.app.a.C0051a {
        ...
        public g(g gVar) {
            super((androidx.appcompat.app.a.C0051a) gVar);
            this.f3982b = 0;
            this.f3982b = gVar.f3982b;
        }

        public g(androidx.appcompat.app.a.C0051a c0051a) {
            super(c0051a);
            this.f3982b = 0;
        }
    ...
    public Toolbar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, p012d.a.f8673Q);
    }
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i3) {
        ...
        this.f3939J = new a();
        this.f3949T = new b();
        h0 h0VarU = h0.u(getContext(), attributeSet, p012d.j.f8972d3, i3, 0);
        androidx.core.view.Z.V(this, context, p012d.j.f8972d3, attributeSet, h0VarU.q(), i3, 0);
        this.f3961m = h0VarU.m(p012d.j.F3, 0);
        this.f3962n = h0VarU.m(p012d.j.w3, 0);
        this.f3972x = h0VarU.k(p012d.j.f8977e3, this.f3972x);
        this.f3963o = h0VarU.k(p012d.j.f3, 48);
        int iD = h0VarU.d(p012d.j.z3, 0);
        iD = h0VarU.r(p012d.j.E3) ? h0VarU.d(p012d.j.E3, iD) : iD;
        this.f3968t = iD;
        this.f3967s = iD;
        this.f3966r = iD;
        this.f3965q = iD;
        int iD2 = h0VarU.d(p012d.j.C3, -1);
        if (iD2 >= 0) {
            this.f3965q = iD2;
        }
        int iD3 = h0VarU.d(p012d.j.B3, -1);
        if (iD3 >= 0) {
            this.f3966r = iD3;
        }
        int iD4 = h0VarU.d(p012d.j.D3, -1);
        if (iD4 >= 0) {
            this.f3967s = iD4;
        }
        int iD5 = h0VarU.d(p012d.j.A3, -1);
        if (iD5 >= 0) {
            this.f3968t = iD5;
        }
        this.f3964p = h0VarU.e(p012d.j.q3, -1);
        int iD6 = h0VarU.d(p012d.j.m3, Integer.MIN_VALUE);
        int iD7 = h0VarU.d(p012d.j.i3, Integer.MIN_VALUE);
        int iE = h0VarU.e(p012d.j.k3, 0);
        int iE2 = h0VarU.e(p012d.j.l3, 0);
        i();
        this.f3969u.e(iE, iE2);
        if (iD6 != Integer.MIN_VALUE || iD7 != Integer.MIN_VALUE) {
            this.f3969u.g(iD6, iD7);
        }
        this.f3970v = h0VarU.d(p012d.j.n3, Integer.MIN_VALUE);
        this.f3971w = h0VarU.d(p012d.j.j3, Integer.MIN_VALUE);
        this.f3955g = h0VarU.f(p012d.j.h3);
        this.f3956h = h0VarU.o(p012d.j.g3);
        CharSequence charSequenceO = h0VarU.o(p012d.j.y3);
        if (!TextUtils.isEmpty(charSequenceO)) {
            setTitle(charSequenceO);
        }
        CharSequence charSequenceO2 = h0VarU.o(p012d.j.v3);
        if (!TextUtils.isEmpty(charSequenceO2)) {
            setSubtitle(charSequenceO2);
        }
        this.f3959k = getContext();
        setPopupTheme(h0VarU.m(p012d.j.u3, 0));
        Drawable drawableF = h0VarU.f(p012d.j.t3);
        if (drawableF != null) {
            setNavigationIcon(drawableF);
        }
        CharSequence charSequenceO3 = h0VarU.o(p012d.j.s3);
        if (!TextUtils.isEmpty(charSequenceO3)) {
            setNavigationContentDescription(charSequenceO3);
        }
        Drawable drawableF2 = h0VarU.f(p012d.j.o3);
        if (drawableF2 != null) {
            setLogo(drawableF2);
        }
        CharSequence charSequenceO4 = h0VarU.o(p012d.j.p3);
        if (!TextUtils.isEmpty(charSequenceO4)) {
            setLogoDescription(charSequenceO4);
        }
        if (h0VarU.r(p012d.j.G3)) {
            setTitleTextColor(h0VarU.c(p012d.j.G3));
        }
        if (h0VarU.r(p012d.j.x3)) {
            setSubtitleTextColor(h0VarU.c(p012d.j.x3));
        }
        if (h0VarU.r(p012d.j.r3)) {
            z(h0VarU.m(p012d.j.r3, 0));
        }
        h0VarU.w();
    }
}
