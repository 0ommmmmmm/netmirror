...
class q0 {
    ...
    q0(Context context) {
        ...
        this.f4309a = context;
        View viewInflate = LayoutInflater.from(context).inflate(p012d.g.f8829s, (ViewGroup) null);
        this.f4310b = viewInflate;
        this.f4311c = (TextView) viewInflate.findViewById(p012d.f.f8803s);
        ...
        layoutParams.windowAnimations = p012d.i.f8845a;
    ...
    private void a(View view, int i3, int i4, boolean z3, WindowManager.LayoutParams layoutParams) {
        ...
        int dimensionPixelOffset = this.f4309a.getResources().getDimensionPixelOffset(p012d.d.f8721m);
        if (view.getWidth() < dimensionPixelOffset) {
            i3 = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.f4309a.getResources().getDimensionPixelOffset(p012d.d.f8720l);
        ...
        int dimensionPixelOffset3 = this.f4309a.getResources().getDimensionPixelOffset(z3 ? p012d.d.f8723o : p012d.d.f8722n);
        View viewB = b(view);
        if (viewB == null) {
