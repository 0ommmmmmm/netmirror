...
public class c0 extends CompoundButton {
    ...
    static class b extends androidx.emoji2.text.f.AbstractC0072f {
    ...
    private C0218n getEmojiTextViewHelper() {
        if (this.f4158Q == null) {
            this.f4158Q = new C0218n(this);
        }
        return this.f4158Q;
    }
    ...
    private Layout i(CharSequence charSequence) {
        TextPaint textPaint = this.f4151J;
    ...
    private void k() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (string == null) {
                string = getResources().getString(p012d.h.f8832b);
            }
    ...
    private void l() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (string == null) {
                string = getResources().getString(p012d.h.f8833c);
            }
            androidx.core.view.Z.l0(this, string);
        }
    }
    ...
    public void m(Context context, int i3) {
        ...
        ColorStateList colorStateListC = h0VarS.c(p012d.j.f8940W2);
        if (colorStateListC != null) {
            this.f4152K = colorStateListC;
        } else {
            this.f4152K = getTextColors();
        }
        int iE = h0VarS.e(p012d.j.f8928T2, 0);
        if (iE != 0) {
            float f3 = iE;
        ...
        o(h0VarS.j(p012d.j.f8932U2, -1), h0VarS.j(p012d.j.f8936V2, -1));
        if (h0VarS.a(p012d.j.f8962b3, false)) {
            this.f4155N = new p028h.a(getContext());
        } else {
            this.f4155N = null;
        }
        setTextOnInternal(this.f4175p);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        float f3;
        this.f4184y.addMovement(motionEvent);
        int actionMasked = motionEvent.getActionMasked();
        if (actionMasked == 0) {
            float x3 = motionEvent.getX();
            float y3 = motionEvent.getY();
            if (isEnabled() && h(x3, y3)) {
                this.f4180u = 1;
                this.f4182w = x3;
                this.f4183x = y3;
            }
            ...
            if (i3 == 1) {
                ...
                if (Math.abs(x4 - this.f4182w) > this.f4181v || Math.abs(y4 - this.f4183x) > this.f4181v) {
                    this.f4180u = 2;
                ...
                float f4 = x5 - this.f4182w;
                if (thumbScrollRange != 0) {
                    f3 = f4 / thumbScrollRange;
                } else {
                    f3 = f4 > 0.0f ? 1.0f : -1.0f;
                }
                if (s0.b(this)) {
                    f3 = -f3;
                }
                float f5 = f(this.f4142A + f3, 0.0f, 1.0f);
                if (f5 != this.f4142A) {
                    this.f4182w = x5;
                    setThumbPosition(f5);
                }
    ...
    public void setThumbResource(int i3) {
        setThumbDrawable(p016e.a.b(getContext(), i3));
    }
    ...
    public void setTrackResource(int i3) {
        setTrackDrawable(p016e.a.b(getContext(), i3));
    }
    ...
    public c0(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, p012d.a.f8670N);
    }
    ...
    public c0(Context context, AttributeSet attributeSet, int i3) {
        ...
        h0 h0VarU = h0.u(context, attributeSet, p012d.j.f8864D2, i3, 0);
        androidx.core.view.Z.V(this, context, p012d.j.f8864D2, attributeSet, h0VarU.q(), i3, 0);
        Drawable drawableF = h0VarU.f(p012d.j.f8876G2);
        this.f4161b = drawableF;
        if (drawableF != null) {
            drawableF.setCallback(this);
        }
        Drawable drawableF2 = h0VarU.f(p012d.j.f8912P2);
        this.f4166g = drawableF2;
        if (drawableF2 != null) {
            drawableF2.setCallback(this);
        }
        setTextOnInternal(h0VarU.o(p012d.j.f8868E2));
        setTextOffInternal(h0VarU.o(p012d.j.f8872F2));
        this.f4179t = h0VarU.a(p012d.j.f8880H2, true);
        this.f4171l = h0VarU.e(p012d.j.f8900M2, 0);
        this.f4172m = h0VarU.e(p012d.j.f8888J2, 0);
        this.f4173n = h0VarU.e(p012d.j.f8892K2, 0);
        this.f4174o = h0VarU.a(p012d.j.f8884I2, false);
        ColorStateList colorStateListC = h0VarU.c(p012d.j.f8904N2);
        if (colorStateListC != null) {
            this.f4162c = colorStateListC;
            this.f4164e = true;
        }
        PorterDuff.Mode modeD = O.d(h0VarU.j(p012d.j.f8908O2, -1), null);
        ...
        ColorStateList colorStateListC2 = h0VarU.c(p012d.j.f8916Q2);
        if (colorStateListC2 != null) {
            this.f4167h = colorStateListC2;
            this.f4169j = true;
        }
        PorterDuff.Mode modeD2 = O.d(h0VarU.j(p012d.j.f8920R2, -1), null);
        ...
        int iM = h0VarU.m(p012d.j.f8896L2, 0);
        if (iM != 0) {
            m(context, iM);
        }
        C c4 = new C(this);
