...
class C0229z extends C0224u {
    ...
    @Override // androidx.appcompat.widget.C0224u
    void c(AttributeSet attributeSet, int i3) {
        super.c(attributeSet, i3);
        h0 h0VarU = h0.u(this.f4339d.getContext(), attributeSet, p012d.j.f8925T, i3, 0);
        SeekBar seekBar = this.f4339d;
        androidx.core.view.Z.V(seekBar, seekBar.getContext(), p012d.j.f8925T, attributeSet, h0VarU.q(), i3, 0);
        Drawable drawableG = h0VarU.g(p012d.j.f8929U);
        if (drawableG != null) {
            this.f4339d.setThumb(drawableG);
        }
        j(h0VarU.f(p012d.j.f8933V));
        if (h0VarU.r(p012d.j.f8941X)) {
            this.f4342g = O.d(h0VarU.j(p012d.j.f8941X, -1), this.f4342g);
            this.f4344i = true;
        }
        if (h0VarU.r(p012d.j.f8937W)) {
            this.f4341f = h0VarU.c(p012d.j.f8937W);
            this.f4343h = true;
        }
        h0VarU.w();
        f();
