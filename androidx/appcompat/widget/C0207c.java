...
class C0207c extends androidx.appcompat.view.menu.a implements AbstractC0232b.a {
    ...
    private class a extends androidx.appcompat.view.menu.i {
        public a(Context context, androidx.appcompat.view.menu.m mVar, View view) {
            super(context, mVar, view, false, p012d.a.f8686m);
            if (!((androidx.appcompat.view.menu.g) mVar.getItem()).l()) {
                View view2 = C0207c.this.f4116l;
                f(view2 == null ? (View) ((androidx.appcompat.view.menu.a) C0207c.this).f3471j : view2);
            }
            j(C0207c.this.f4114D);
        }
    ...
    private class RunnableC0055c implements Runnable {
        ...
        public void run() {
            if (((androidx.appcompat.view.menu.a) C0207c.this).f3465d != null) {
                ((androidx.appcompat.view.menu.a) C0207c.this).f3465d.d();
            }
            View view = (View) ((androidx.appcompat.view.menu.a) C0207c.this).f3471j;
            if (view != null && view.getWindowToken() != null && this.f4133b.m()) {
                C0207c.this.f4130z = this.f4133b;
            }
            C0207c.this.f4112B = null;
        }
    }
    ...
    private class d extends r implements ActionMenuView.a {
        ...
        class a extends S {
            ...
            final /* synthetic */ C0207c f4136k;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(View view, C0207c c0207c) {
                super(view);
                this.f4136k = c0207c;
            }
        ...
        public d(Context context) {
            super(context, null, p012d.a.f8685l);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
            m0.a(this, getContentDescription());
            setOnTouchListener(new a(this, C0207c.this));
        }
    ...
    private class e extends androidx.appcompat.view.menu.i {
        public e(Context context, androidx.appcompat.view.menu.e eVar, View view, boolean z3) {
            super(context, eVar, view, z3, p012d.a.f8686m);
            h(8388613);
            j(C0207c.this.f4114D);
        }
        ...
        protected void e() {
            if (((androidx.appcompat.view.menu.a) C0207c.this).f3465d != null) {
                ((androidx.appcompat.view.menu.a) C0207c.this).f3465d.close();
            }
            C0207c.this.f4130z = null;
            super.e();
        }
    }
    ...
    private class f implements androidx.appcompat.view.menu.j.a {
        ...
        public void c(androidx.appcompat.view.menu.e eVar, boolean z3) {
            ...
            androidx.appcompat.view.menu.j.a aVarM = C0207c.this.m();
            if (aVarM != null) {
                aVarM.c(eVar, z3);
            }
        }
        ...
        public boolean d(androidx.appcompat.view.menu.e eVar) {
            if (eVar == ((androidx.appcompat.view.menu.a) C0207c.this).f3465d) {
                return false;
            }
            C0207c.this.f4115E = ((androidx.appcompat.view.menu.m) eVar).getItem().getItemId();
            androidx.appcompat.view.menu.j.a aVarM = C0207c.this.m();
            if (aVarM != null) {
                return aVarM.d(eVar);
            }
    ...
    public C0207c(Context context) {
        super(context, p012d.g.f8813c, p012d.g.f8812b);
    ...
    public void f(boolean z3) {
        ...
        if (eVar != null) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                AbstractC0232b abstractC0232bB = ((androidx.appcompat.view.menu.g) arrayListS.get(i3)).b();
                if (abstractC0232bB != null) {
                    abstractC0232bB.i(this);
                }
            }
        }
    ...
    public boolean h() {
        ...
        ?? r3;
        C0207c c0207c = this;
        androidx.appcompat.view.menu.e eVar = c0207c.f3465d;
        View view = null;
        ?? r4 = 0;
        if (eVar != null) {
            arrayListE = eVar.E();
        ...
        int i4 = c0207c.f4123s;
        int i5 = c0207c.f4122r;
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(0, 0);
        ViewGroup viewGroup = (ViewGroup) c0207c.f3471j;
        boolean z3 = false;
        int i6 = 0;
        int i7 = 0;
        for (int i8 = 0; i8 < size; i8++) {
            androidx.appcompat.view.menu.g gVar = (androidx.appcompat.view.menu.g) arrayListE.get(i8);
            if (gVar.o()) {
                i6++;
            } else if (gVar.n()) {
                i7++;
            ...
            if (c0207c.f4127w && gVar.isActionViewExpanded()) {
                i4 = 0;
            }
        }
        if (c0207c.f4119o && (z3 || i7 + i6 > i4)) {
            i4--;
        }
        int i9 = i4 - i6;
        SparseBooleanArray sparseBooleanArray = c0207c.f4129y;
        sparseBooleanArray.clear();
        if (c0207c.f4125u) {
            int i10 = c0207c.f4128x;
            iJ = i5 / i10;
            i3 = i10 + ((i5 % i10) / iJ);
        } else {
            i3 = 0;
        ...
        ?? r5 = c0207c;
        while (i11 < size) {
            ?? r15 = (androidx.appcompat.view.menu.g) arrayListE.get(i11);
            if (r15.o()) {
                View viewN = r5.n(r15, view, viewGroup);
                if (r5.f4125u) {
                    iJ -= ActionMenuView.J(viewN, i3, iJ, iMakeMeasureSpec, r4);
                } else {
                ...
                boolean z5 = (i9 > 0 || z4) && i5 > 0 && (!r5.f4125u || iJ > 0);
                boolean z6 = z5;
                if (z5) {
                    View viewN2 = r5.n(r15, null, viewGroup);
                    if (r5.f4125u) {
                ...
                if (z5 && groupId2 != 0) {
                    ...
                    for (int i13 = 0; i13 < i11; i13++) {
                        androidx.appcompat.view.menu.g gVar2 = (androidx.appcompat.view.menu.g) arrayListE.get(i13);
