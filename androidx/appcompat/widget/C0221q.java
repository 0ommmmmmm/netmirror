...
public class C0221q {
    ...
    private boolean a(Drawable drawable) {
        ...
        C0215k.i(drawable, f0Var, this.f4304a.getDrawableState());
        return true;
    }
    ...
    void c() {
        ...
        if (drawable != null) {
            ...
            if (f0Var2 != null) {
                C0215k.i(drawable, f0Var2, this.f4304a.getDrawableState());
            }
        }
    }
    ...
    public void g(AttributeSet attributeSet, int i3) {
        int iM;
        h0 h0VarU = h0.u(this.f4304a.getContext(), attributeSet, p012d.j.f8909P, i3, 0);
        ImageView imageView = this.f4304a;
        androidx.core.view.Z.V(imageView, imageView.getContext(), p012d.j.f8909P, attributeSet, h0VarU.q(), i3, 0);
        try {
            Drawable drawable = this.f4304a.getDrawable();
            if (drawable == null && (iM = h0VarU.m(p012d.j.f8913Q, -1)) != -1 && (drawable = p016e.a.b(this.f4304a.getContext(), iM)) != null) {
                this.f4304a.setImageDrawable(drawable);
            }
            if (drawable != null) {
                O.a(drawable);
            }
            if (h0VarU.r(p012d.j.f8917R)) {
                androidx.core.widget.e.c(this.f4304a, h0VarU.c(p012d.j.f8917R));
            }
            if (h0VarU.r(p012d.j.f8921S)) {
                androidx.core.widget.e.d(this.f4304a, O.d(h0VarU.j(p012d.j.f8921S, -1), null));
            }
        } finally {
            h0VarU.w();
        }
    ...
    public void i(int i3) {
        if (i3 != 0) {
            Drawable drawableB = p016e.a.b(this.f4304a.getContext(), i3);
            if (drawableB != null) {
                O.a(drawableB);
            }
