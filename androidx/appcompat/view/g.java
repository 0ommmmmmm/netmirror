    ...
    private class b {
        ...
        private void i(MenuItem menuItem) {
            ...
            if (this.f3412r >= 2) {
                ...
                } else if (menuItem instanceof p032i.c) {
                    ((p032i.c) menuItem).h(true);
                }
            }
            ...
            AbstractC0232b abstractC0232b = this.f3389A;
            if (abstractC0232b != null) {
                B.a(menuItem, abstractC0232b);
            }
        ...
        public void f(AttributeSet attributeSet) {
            TypedArray typedArrayObtainStyledAttributes = g.this.f3384c.obtainStyledAttributes(attributeSet, j.f9016o1);
            this.f3396b = typedArrayObtainStyledAttributes.getResourceId(j.f9024q1, 0);
            this.f3397c = typedArrayObtainStyledAttributes.getInt(j.f9032s1, 0);
            this.f3398d = typedArrayObtainStyledAttributes.getInt(j.f9036t1, 0);
            this.f3399e = typedArrayObtainStyledAttributes.getInt(j.f9040u1, 0);
            this.f3400f = typedArrayObtainStyledAttributes.getBoolean(j.f9028r1, true);
            this.f3401g = typedArrayObtainStyledAttributes.getBoolean(j.f9020p1, true);
            typedArrayObtainStyledAttributes.recycle();
        }

        public void g(AttributeSet attributeSet) {
            h0 h0VarT = h0.t(g.this.f3384c, attributeSet, j.f9044v1);
            this.f3403i = h0VarT.m(j.f9056y1, 0);
            this.f3404j = (h0VarT.j(j.f8855B1, this.f3397c) & (-65536)) | (h0VarT.j(j.f8859C1, this.f3398d) & 65535);
            this.f3405k = h0VarT.o(j.f8863D1);
            this.f3406l = h0VarT.o(j.f8867E1);
            this.f3407m = h0VarT.m(j.f9048w1, 0);
            this.f3408n = c(h0VarT.n(j.f8871F1));
            this.f3409o = h0VarT.j(j.f8899M1, 4096);
            this.f3410p = c(h0VarT.n(j.f8875G1));
            this.f3411q = h0VarT.j(j.f8915Q1, 4096);
            if (h0VarT.r(j.f8879H1)) {
                this.f3412r = h0VarT.a(j.f8879H1, false) ? 1 : 0;
            } else {
                this.f3412r = this.f3399e;
            }
            this.f3413s = h0VarT.a(j.f9060z1, false);
            this.f3414t = h0VarT.a(j.f8851A1, this.f3400f);
            this.f3415u = h0VarT.a(j.f9052x1, this.f3401g);
            this.f3416v = h0VarT.j(j.f8919R1, -1);
            this.f3420z = h0VarT.n(j.f8883I1);
            this.f3417w = h0VarT.m(j.f8887J1, 0);
            this.f3418x = h0VarT.n(j.f8895L1);
            String strN = h0VarT.n(j.f8891K1);
            this.f3419y = strN;
            boolean z3 = strN != null;
            if (z3 && this.f3417w == 0 && this.f3418x == null) {
                this.f3389A = (AbstractC0232b) e(strN, g.f3381f, g.this.f3383b);
            } else {
                if (z3) {
            ...
            this.f3390B = h0VarT.o(j.f8903N1);
            this.f3391C = h0VarT.o(j.f8923S1);
            if (h0VarT.r(j.f8911P1)) {
                this.f3393E = O.d(h0VarT.j(j.f8911P1, -1), this.f3393E);
            } else {
                this.f3393E = null;
            }
            if (h0VarT.r(j.f8907O1)) {
                this.f3392D = h0VarT.c(j.f8907O1);
            } else {
                this.f3392D = null;
            }
            h0VarT.w();
            ...
            if (eventType != 2) {
                if (eventType == 3) {
                    ...
                    if (z4 && name2.equals(str)) {
                        ...
                        if (!bVar.d()) {
                            AbstractC0232b abstractC0232b = bVar.f3389A;
                            if (abstractC0232b == null || !abstractC0232b.a()) {
                                bVar.a();
                            } else {
                                bVar.b();
                            }
