...
final class l extends h implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, j, View.OnKeyListener {
    ...
    private static final int f3604w = p012d.g.f8823m;
    ...
    public l(Context context, e eVar, View view, int i3, int i4, boolean z3) {
        ...
        this.f3609g = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(p012d.d.f8712d));
        this.f3616n = view;
    ...
    private boolean z() {
        ...
        if (this.f3624v && this.f3606d.x() != null) {
            FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.f3605c).inflate(p012d.g.f8822l, (ViewGroup) listViewG, false);
