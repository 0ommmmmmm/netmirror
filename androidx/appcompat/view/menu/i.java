...
public class i {
    ...
    public i(Context context, e eVar) {
        this(context, eVar, null, false, p012d.a.f8664H, 0);
    }
    ...
    private h a() {
        ...
        h bVar = Math.min(point.x, point.y) >= this.f3591a.getResources().getDimensionPixelSize(p012d.d.f8711c) ? new b(this.f3591a, this.f3596f, this.f3594d, this.f3595e, this.f3593c) : new l(this.f3591a, this.f3592b, this.f3596f, this.f3594d, this.f3595e, this.f3593c);
        bVar.l(this.f3592b);
        bVar.u(this.f3602l);
        bVar.p(this.f3596f);
        bVar.k(this.f3599i);
    ...
    private void l(int i3, int i4, boolean z3, boolean z4) {
        ...
        hVarC.v(z4);
        if (z3) {
            if ((AbstractC0268w.a(this.f3597g, this.f3596f.getLayoutDirection()) & 7) == 5) {
    ...
    public i(Context context, e eVar, View view) {
        this(context, eVar, view, false, p012d.a.f8664H, 0);
    }
