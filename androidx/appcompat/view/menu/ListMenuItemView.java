...
public class ListMenuItemView extends LinearLayout implements k.a, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, p012d.a.f8661E);
    }
    ...
    private void d() {
        CheckBox checkBox = (CheckBox) getInflater().inflate(p012d.g.f8818h, (ViewGroup) this, false);
        this.f3450f = checkBox;
        b(checkBox);
    }

    private void f() {
        ImageView imageView = (ImageView) getInflater().inflate(p012d.g.f8819i, (ViewGroup) this, false);
        this.f3447c = imageView;
        c(imageView, 0);
    }

    private void g() {
        RadioButton radioButton = (RadioButton) getInflater().inflate(p012d.g.f8821k, (ViewGroup) this, false);
    ...
    protected void onFinishInflate() {
        ...
        TextView textView = (TextView) findViewById(p012d.f.f8781M);
        this.f3449e = textView;
        int i3 = this.f3456l;
        if (i3 != -1) {
            textView.setTextAppearance(this.f3457m, i3);
        }
        this.f3451g = (TextView) findViewById(p012d.f.f8774F);
        ImageView imageView = (ImageView) findViewById(p012d.f.f8777I);
        this.f3452h = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(this.f3459o);
        }
        this.f3453i = (ImageView) findViewById(p012d.f.f8802r);
        this.f3454j = (LinearLayout) findViewById(p012d.f.f8796l);
    }
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i3) {
        ...
        h0 h0VarU = h0.u(getContext(), attributeSet, p012d.j.f8927T1, i3, 0);
        this.f3455k = h0VarU.f(p012d.j.f8935V1);
        this.f3456l = h0VarU.m(p012d.j.f8931U1, -1);
        this.f3458n = h0VarU.a(p012d.j.f8939W1, false);
        this.f3457m = context;
        this.f3459o = h0VarU.f(p012d.j.f8943X1);
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(null, new int[]{R.attr.divider}, p012d.a.f8658B, 0);
