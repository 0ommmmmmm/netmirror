...
final class b extends h implements j, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int f3473C = p012d.g.f8815e;
    ...
    public b(Context context, View view, int i3, int i4, boolean z3) {
        ...
        this.f3477d = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(p012d.d.f8712d));
    ...
    private int E(int i3) {
        ...
        if (this.f3491r == 1) {
            return (iArr[0] + listViewA.getWidth()) + i3 > rect.right ? 0 : 1;
        }
    ...
    private void F(e eVar) {
        ...
        if (dVar == null && this.f3497x && eVar.x() != null) {
            FrameLayout frameLayout = (FrameLayout) layoutInflaterFrom.inflate(p012d.g.f8822l, (ViewGroup) listViewG, false);
    ...
    public void p(View view) {
        if (this.f3489p != view) {
            this.f3489p = view;
            this.f3488o = AbstractC0268w.a(this.f3487n, view.getLayoutDirection());
        }
    }
    ...
    public void s(int i3) {
        if (this.f3487n != i3) {
            this.f3487n = i3;
            this.f3488o = AbstractC0268w.a(i3, this.f3489p.getLayoutDirection());
        }
    }
