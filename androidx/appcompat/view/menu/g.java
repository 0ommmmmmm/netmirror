...
public final class g implements p052n.b {

    /* JADX INFO: renamed from: A, reason: collision with root package name */
    private View f3558A;

    /* JADX INFO: renamed from: B, reason: collision with root package name */
    private AbstractC0232b f3559B;
    ...
    class a implements AbstractC0232b.InterfaceC0067b {
        a() {
        }

        @Override // androidx.core.view.AbstractC0232b.InterfaceC0067b
    ...
    @Override // p052n.b
    public p052n.b a(AbstractC0232b abstractC0232b) {
        AbstractC0232b abstractC0232b2 = this.f3559B;
        if (abstractC0232b2 != null) {
            abstractC0232b2.h();
        }
        this.f3558A = null;
        this.f3559B = abstractC0232b;
        this.f3576n.L(true);
        AbstractC0232b abstractC0232b3 = this.f3559B;
        if (abstractC0232b3 != null) {
            abstractC0232b3.j(new a());
        }
        return this;
    }
    ...
    public View getActionView() {
        ...
        AbstractC0232b abstractC0232b = this.f3559B;
        if (abstractC0232b == null) {
            return null;
        }
        View viewD = abstractC0232b.d(this);
        this.f3558A = viewD;
        return viewD;
    }
    ...
    public Drawable getIcon() {
        ...
        Drawable drawableB = p016e.a.b(this.f3576n.u(), this.f3575m);
        this.f3575m = 0;
    ...
    String h() {
        ...
        if (ViewConfiguration.get(this.f3576n.u()).hasPermanentMenuKey()) {
            sb.append(resources.getString(p012d.h.f8843m));
        }
        int i3 = this.f3576n.H() ? this.f3573k : this.f3571i;
        d(sb, i3, 65536, resources.getString(p012d.h.f8839i));
        d(sb, i3, 4096, resources.getString(p012d.h.f8835e));
        d(sb, i3, 2, resources.getString(p012d.h.f8834d));
        d(sb, i3, 1, resources.getString(p012d.h.f8840j));
        d(sb, i3, 4, resources.getString(p012d.h.f8842l));
        d(sb, i3, 8, resources.getString(p012d.h.f8838h));
        if (cG == '\b') {
            sb.append(resources.getString(p012d.h.f8836f));
        } else if (cG == '\n') {
            sb.append(resources.getString(p012d.h.f8837g));
        } else if (cG != ' ') {
            sb.append(cG);
        } else {
            sb.append(resources.getString(p012d.h.f8841k));
        }
        return sb.toString();
    }
    ...
    public boolean isVisible() {
        AbstractC0232b abstractC0232b = this.f3559B;
        if (abstractC0232b == null || !abstractC0232b.g()) {
            return (this.f3587y & 8) == 0;
        }
        return (this.f3587y & 8) == 0 && this.f3559B.b();
    }
    ...
    public boolean j() {
        ...
        if (this.f3558A == null && (abstractC0232b = this.f3559B) != null) {
            this.f3558A = abstractC0232b.d(this);
        }
    ...
    public boolean k() {
        ...
        AbstractC0232b abstractC0232b = this.f3559B;
        return abstractC0232b != null && abstractC0232b.e();
    }
    ...
    public p052n.b setActionView(int i3) {
    ...
    public p052n.b setActionView(View view) {
        int i3;
        this.f3558A = view;
        this.f3559B = null;
    ...
    public p052n.b setShowAsActionFlags(int i3) {
        setShowAsAction(i3);
        return this;
    }
    ...
    @Override // android.view.MenuItem
    public p052n.b setContentDescription(CharSequence charSequence) {
    ...
    @Override // android.view.MenuItem
    public p052n.b setTooltipText(CharSequence charSequence) {
