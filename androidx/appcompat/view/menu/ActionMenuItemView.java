...
public class ActionMenuItemView extends D implements k.a, View.OnClickListener, ActionMenuView.a {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i3) {
        ...
        this.f3437o = u();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, p012d.j.f9042v, i3, 0);
        this.f3439q = typedArrayObtainStyledAttributes.getDimensionPixelSize(p012d.j.f9046w, 0);
