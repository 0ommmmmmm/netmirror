...
class AlertController {
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, p012d.j.f8966c2);
            this.f3105c = typedArrayObtainStyledAttributes.getDimensionPixelOffset(p012d.j.f8971d2, -1);
            this.f3104b = typedArrayObtainStyledAttributes.getDimensionPixelOffset(p012d.j.f8976e2, -1);
        }
    }
    ...
    class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (view == alertController.f3092o && (message3 = alertController.f3094q) != null) {
                messageObtain = Message.obtain(message3);
            } else if (view != alertController.f3096s || (message2 = alertController.f3098u) == null) {
                messageObtain = (view != alertController.f3100w || (message = alertController.f3102y) == null) ? null : Message.obtain(message);
            } else {
    ...
    public AlertController(Context context, r rVar, Window window) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, p012d.j.f8869F, p012d.a.f8688o, 0);
        this.f3068J = typedArrayObtainStyledAttributes.getResourceId(p012d.j.f8873G, 0);
        this.f3069K = typedArrayObtainStyledAttributes.getResourceId(p012d.j.f8881I, 0);
        this.f3070L = typedArrayObtainStyledAttributes.getResourceId(p012d.j.f8889K, 0);
        this.f3071M = typedArrayObtainStyledAttributes.getResourceId(p012d.j.f8893L, 0);
        this.f3072N = typedArrayObtainStyledAttributes.getResourceId(p012d.j.f8901N, 0);
        this.f3073O = typedArrayObtainStyledAttributes.getResourceId(p012d.j.f8885J, 0);
        this.f3074P = typedArrayObtainStyledAttributes.getBoolean(p012d.j.f8897M, true);
        this.f3081d = typedArrayObtainStyledAttributes.getDimensionPixelSize(p012d.j.f8877H, 0);
    ...
    private int i() {
        ...
        return this.f3075Q == 1 ? i3 : this.f3068J;
    }

    private void o(ViewGroup viewGroup, View view, int i3, int i4) {
        View viewFindViewById = this.f3080c.findViewById(p012d.f.f8806v);
        View viewFindViewById2 = this.f3080c.findViewById(p012d.f.f8805u);
        Z.k0(view, i3, i4);
    ...
    private void u(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.f3080c.findViewById(p012d.f.f8807w);
    ...
    private void v(ViewGroup viewGroup) {
        ...
        FrameLayout frameLayout = (FrameLayout) this.f3080c.findViewById(p012d.f.f8798n);
    ...
    private void w(ViewGroup viewGroup) {
        if (this.f3065G != null) {
            ...
            this.f3080c.findViewById(p012d.f.f8783O).setVisibility(8);
            return;
        }
        ...
        TextView textView = (TextView) this.f3080c.findViewById(p012d.f.f8794j);
    ...
    private void x() {
        ...
        View viewFindViewById3 = this.f3080c.findViewById(p012d.f.f8804t);
        View viewFindViewById4 = viewFindViewById3.findViewById(p012d.f.f8784P);
        View viewFindViewById5 = viewFindViewById3.findViewById(p012d.f.f8797m);
        View viewFindViewById6 = viewFindViewById3.findViewById(p012d.f.f8795k);
        ViewGroup viewGroup = (ViewGroup) viewFindViewById3.findViewById(p012d.f.f8799o);
        v(viewGroup);
        View viewFindViewById7 = viewGroup.findViewById(p012d.f.f8784P);
        View viewFindViewById8 = viewGroup.findViewById(p012d.f.f8797m);
        View viewFindViewById9 = viewGroup.findViewById(p012d.f.f8795k);
        ...
        if (!z5 && viewGroupH2 != null && (viewFindViewById2 = viewGroupH2.findViewById(p012d.f.f8779K)) != null) {
        ...
        if (z4 != 0) {
            ...
            View viewFindViewById10 = (this.f3083f == null && this.f3084g == null) ? null : viewGroupH.findViewById(p012d.f.f8782N);
            if (viewFindViewById10 != null) {
                viewFindViewById10.setVisibility(0);
            }
        } else if (viewGroupH2 != null && (viewFindViewById = viewGroupH2.findViewById(p012d.f.f8780L)) != null) {
    ...
    private static boolean y(Context context) {
        ...
        context.getTheme().resolveAttribute(p012d.a.f8687n, typedValue, true);
