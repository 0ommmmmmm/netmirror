...
public class r extends androidx.activity.i implements d {
    ...
    private final AbstractC0269x.a f3286f;
    ...
    private static int j(Context context, int i3) {
        ...
        context.getTheme().resolveAttribute(p012d.a.f8657A, typedValue, true);
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        return AbstractC0269x.e(this.f3286f, getWindow().getDecorView(), this, keyEvent);
    }
    ...
    public r(Context context, int i3) {
        ...
        this.f3286f = new AbstractC0269x.a() { // from class: androidx.appcompat.app.q
