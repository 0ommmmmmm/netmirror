...
import androidx.core.view.AbstractC0269x;
import androidx.core.view.AbstractC0270y;
import androidx.core.view.C0247i0;
import androidx.core.view.C0251k0;
...
class h extends androidx.appcompat.app.f implements androidx.appcompat.view.menu.e.a, LayoutInflater.Factory2 {
    ...
    private static final p044l.g f3185k0 = new p044l.g();
    ...
    class b implements androidx.core.view.I {
        ...
        public C0257n0 a(View view, C0257n0 c0257n0) {
            int iK = c0257n0.k();
            int iF1 = h.this.f1(c0257n0, null);
            if (iK != iF1) {
                c0257n0 = c0257n0.p(c0257n0.i(), iF1, c0257n0.j(), c0257n0.h());
            }
            return Z.M(view, c0257n0);
        }
    }
    ...
    class d implements Runnable {
        ...
        class a extends C0251k0 {
            a() {
            }

            @Override // androidx.core.view.C0251k0, androidx.core.view.InterfaceC0249j0
    ...
    class g implements androidx.appcompat.view.b.a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private androidx.appcompat.view.b.a f3248a;
    ...
    class l extends androidx.appcompat.view.i {
        ...
        final ActionMode e(ActionMode.Callback callback) {
            androidx.appcompat.view.f.a aVar = new androidx.appcompat.view.f.a(h.this.f3226l, callback);
    ...
    private class p extends ContentFrameLayout {
        ...
        public void setBackgroundResource(int i3) {
            setBackgroundDrawable(p016e.a.b(getContext(), i3));
        }
    }
    ...
    protected static final class q {
        ...
        androidx.appcompat.view.menu.k a(androidx.appcompat.view.menu.j.a aVar) {
            ...
            if (this.f3273k == null) {
                androidx.appcompat.view.menu.c cVar = new androidx.appcompat.view.menu.c(this.f3274l, p012d.g.f8820j);
                this.f3273k = cVar;
                cVar.k(aVar);
        ...
        void d(Context context) {
            ...
            themeNewTheme.resolveAttribute(p012d.a.f8674a, typedValue, true);
            int i3 = typedValue.resourceId;
            if (i3 != 0) {
                themeNewTheme.applyStyle(i3, true);
            }
            themeNewTheme.resolveAttribute(p012d.a.f8663G, typedValue, true);
            int i4 = typedValue.resourceId;
            if (i4 != 0) {
                themeNewTheme.applyStyle(i4, true);
            } else {
                themeNewTheme.applyStyle(p012d.i.f8846b, true);
            }
            androidx.appcompat.view.d dVar = new androidx.appcompat.view.d(context, 0);
            dVar.getTheme().setTo(themeNewTheme);
            this.f3274l = dVar;
            TypedArray typedArrayObtainStyledAttributes = dVar.obtainStyledAttributes(p012d.j.f9055y0);
            this.f3264b = typedArrayObtainStyledAttributes.getResourceId(p012d.j.f8854B0, 0);
            this.f3268f = typedArrayObtainStyledAttributes.getResourceId(p012d.j.f8850A0, 0);
    ...
    private boolean I0(int i3, KeyEvent keyEvent) {
        ...
        boolean zF = true;
        q qVarT0 = t0(i3, true);
        if (i3 != 0 || (i4 = this.f3233s) == null || !i4.h() || ViewConfiguration.get(this.f3226l).hasPermanentMenuKey()) {
            boolean z3 = qVarT0.f3277o;
            if (z3 || qVarT0.f3276n) {
                c0(qVarT0, true);
                zF = z3;
            } else if (qVarT0.f3275m) {
                if (qVarT0.f3280r) {
                    qVarT0.f3275m = false;
                    zP0 = P0(qVarT0, keyEvent);
                } else {
                    zP0 = true;
                }
                if (zP0) {
        ...
        } else if (this.f3233s.b()) {
            zF = this.f3233s.f();
        } else if (this.f3207S || !P0(qVarT0, keyEvent)) {
            zF = false;
        } else {
            zF = this.f3233s.g();
        }
        if (zF) {
            AudioManager audioManager = (AudioManager) this.f3226l.getApplicationContext().getSystemService("audio");
    ...
    private void M0(q qVar, KeyEvent keyEvent) {
        int i3;
        ViewGroup.LayoutParams layoutParams;
        if (qVar.f3277o || this.f3207S) {
            return;
        }
        if (qVar.f3263a == 0 && (this.f3226l.getResources().getConfiguration().screenLayout & 15) == 4) {
            return;
        }
        Window.Callback callbackV0 = v0();
        if (callbackV0 != null && !callbackV0.onMenuOpened(qVar.f3263a, qVar.f3272j)) {
            c0(qVar, true);
            return;
        }
        WindowManager windowManager = (WindowManager) this.f3226l.getSystemService("window");
        if (windowManager != null && P0(qVar, keyEvent)) {
            ViewGroup viewGroup = qVar.f3269g;
            if (viewGroup != null && !qVar.f3279q) {
                View view = qVar.f3271i;
                if (view != null && (layoutParams = view.getLayoutParams()) != null && layoutParams.width == -1) {
                    i3 = -1;
                }
                qVar.f3276n = false;
                WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(i3, -2, qVar.f3266d, qVar.f3267e, 1002, 8519680, -3);
                layoutParams2.gravity = qVar.f3265c;
                layoutParams2.windowAnimations = qVar.f3268f;
                windowManager.addView(qVar.f3269g, layoutParams2);
                qVar.f3277o = true;
                if (qVar.f3263a == 0) {
                    d1();
                }
            ...
            if (viewGroup == null) {
                if (!y0(qVar) || qVar.f3269g == null) {
                    return;
                }
            } else if (qVar.f3279q && viewGroup.getChildCount() > 0) {
                qVar.f3269g.removeAllViews();
            }
            if (!x0(qVar) || !qVar.b()) {
                qVar.f3279q = true;
                return;
            }
            ViewGroup.LayoutParams layoutParams3 = qVar.f3270h.getLayoutParams();
            if (layoutParams3 == null) {
                layoutParams3 = new ViewGroup.LayoutParams(-2, -2);
            }
            qVar.f3269g.setBackgroundResource(qVar.f3264b);
            ViewParent parent = qVar.f3270h.getParent();
            if (parent instanceof ViewGroup) {
                ((ViewGroup) parent).removeView(qVar.f3270h);
            }
            qVar.f3269g.addView(qVar.f3270h, layoutParams3);
            if (!qVar.f3270h.hasFocus()) {
                qVar.f3270h.requestFocus();
            }
            i3 = -2;
            qVar.f3276n = false;
            WindowManager.LayoutParams layoutParams4 = new WindowManager.LayoutParams(i3, -2, qVar.f3266d, qVar.f3267e, 1002, 8519680, -3);
            layoutParams4.gravity = qVar.f3265c;
            layoutParams4.windowAnimations = qVar.f3268f;
            windowManager.addView(qVar.f3269g, layoutParams4);
            qVar.f3277o = true;
            if (qVar.f3263a == 0) {
                d1();
            }
    ...
    private void Q0(boolean z3) {
        ...
        q qVarT1 = t0(0, true);
        androidx.appcompat.view.menu.e eVar = qVarT1.f3272j;
        if (eVar == null || qVarT1.f3280r || !callbackV0.onPreparePanel(0, qVarT1.f3271i, eVar)) {
            return;
        }
        callbackV0.onMenuOpened(108, qVarT1.f3272j);
        this.f3233s.g();
    }
    ...
    private void U() {
        ...
        TypedArray typedArrayObtainStyledAttributes = this.f3226l.obtainStyledAttributes(p012d.j.f9055y0);
        typedArrayObtainStyledAttributes.getValue(p012d.j.f8890K0, contentFrameLayout.getMinWidthMajor());
        typedArrayObtainStyledAttributes.getValue(p012d.j.f8894L0, contentFrameLayout.getMinWidthMinor());
        if (typedArrayObtainStyledAttributes.hasValue(p012d.j.f8882I0)) {
            typedArrayObtainStyledAttributes.getValue(p012d.j.f8882I0, contentFrameLayout.getFixedWidthMajor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(p012d.j.f8886J0)) {
            typedArrayObtainStyledAttributes.getValue(p012d.j.f8886J0, contentFrameLayout.getFixedWidthMinor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(p012d.j.f8874G0)) {
            typedArrayObtainStyledAttributes.getValue(p012d.j.f8874G0, contentFrameLayout.getFixedHeightMajor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(p012d.j.f8878H0)) {
            typedArrayObtainStyledAttributes.getValue(p012d.j.f8878H0, contentFrameLayout.getFixedHeightMinor());
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    private void b1(Configuration configuration) {
        ...
        if (activity instanceof androidx.lifecycle.l) {
            if (((androidx.lifecycle.l) activity).t().b().b(AbstractC0292g.b.CREATED)) {
    ...
    private boolean c1(int i3, androidx.core.os.e eVar, boolean z3) {
        boolean z4;
        Configuration configurationD0 = d0(this.f3226l, i3, eVar, null, false);
        int iP0 = p0(this.f3226l);
        Configuration configuration = this.f3208T;
        if (configuration == null) {
            configuration = this.f3226l.getResources().getConfiguration();
        }
        int i4 = configuration.uiMode & 48;
        int i5 = configurationD0.uiMode & 48;
        androidx.core.os.e eVarS0 = s0(configuration);
        androidx.core.os.e eVarS1 = eVar == null ? null : s0(configurationD0);
        int i6 = i4 != i5 ? 512 : 0;
        if (eVarS1 != null && !eVarS0.equals(eVarS1)) {
            i6 |= 8196;
        }
        boolean z5 = true;
        if (((~iP0) & i6) != 0 && z3 && this.f3205Q && (f3188n0 || this.f3206R)) {
            Object obj = this.f3225k;
            if (!(obj instanceof Activity) || ((Activity) obj).isChild()) {
                z4 = false;
            } else {
                if (Build.VERSION.SDK_INT >= 31 && (i6 & 8192) != 0) {
                    ((Activity) this.f3225k).getWindow().getDecorView().setLayoutDirection(configurationD0.getLayoutDirection());
                }
                androidx.core.app.b.k((Activity) this.f3225k);
                z4 = true;
            }
        } else {
            z4 = false;
        ...
        if (z4 || i6 == 0) {
            ...
            e1(i5, eVarS1, (i6 & iP0) == i6, null);
        }
        if (z5) {
            Object obj2 = this.f3225k;
            if (obj2 instanceof androidx.appcompat.app.c) {
                if ((i6 & 512) != 0) {
                    ((androidx.appcompat.app.c) obj2).i0(i3);
                }
                if ((i6 & 4) != 0) {
                    ((androidx.appcompat.app.c) this.f3225k).h0(eVar);
                }
            }
        }
        if (eVarS1 != null) {
            T0(s0(this.f3226l.getResources().getConfiguration()));
        }
        return z5;
    }
    ...
    private ViewGroup e0() {
        ViewGroup viewGroup;
        TypedArray typedArrayObtainStyledAttributes = this.f3226l.obtainStyledAttributes(p012d.j.f9055y0);
        if (!typedArrayObtainStyledAttributes.hasValue(p012d.j.f8862D0)) {
            typedArrayObtainStyledAttributes.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (typedArrayObtainStyledAttributes.getBoolean(p012d.j.f8898M0, false)) {
            I(1);
        } else if (typedArrayObtainStyledAttributes.getBoolean(p012d.j.f8862D0, false)) {
            I(108);
        }
        if (typedArrayObtainStyledAttributes.getBoolean(p012d.j.f8866E0, false)) {
            I(109);
        }
        if (typedArrayObtainStyledAttributes.getBoolean(p012d.j.f8870F0, false)) {
            I(10);
        }
        this.f3199K = typedArrayObtainStyledAttributes.getBoolean(p012d.j.f9059z0, false);
        typedArrayObtainStyledAttributes.recycle();
        l0();
        this.f3227m.getDecorView();
        LayoutInflater layoutInflaterFrom = LayoutInflater.from(this.f3226l);
        if (this.f3200L) {
            viewGroup = this.f3198J ? (ViewGroup) layoutInflaterFrom.inflate(p012d.g.f8825o, (ViewGroup) null) : (ViewGroup) layoutInflaterFrom.inflate(p012d.g.f8824n, (ViewGroup) null);
        } else if (this.f3199K) {
            viewGroup = (ViewGroup) layoutInflaterFrom.inflate(p012d.g.f8816f, (ViewGroup) null);
            this.f3197I = false;
            this.f3196H = false;
        } else if (this.f3196H) {
            TypedValue typedValue = new TypedValue();
            this.f3226l.getTheme().resolveAttribute(p012d.a.f8680g, typedValue, true);
            viewGroup = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new androidx.appcompat.view.d(this.f3226l, typedValue.resourceId) : this.f3226l).inflate(p012d.g.f8826p, (ViewGroup) null);
            I i3 = (I) viewGroup.findViewById(p012d.f.f8800p);
            this.f3233s = i3;
        ...
        if (this.f3233s == null) {
            this.f3192D = (TextView) viewGroup.findViewById(p012d.f.f8781M);
        }
        s0.c(viewGroup);
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(p012d.f.f8786b);
    ...
    private void g1(View view) {
        view.setBackgroundColor((Z.B(view) & 8192) != 0 ? androidx.core.content.a.b(this.f3226l, p012d.c.f8702b) : androidx.core.content.a.b(this.f3226l, p012d.c.f8701a));
    }
    ...
    private boolean z0(q qVar) {
        ...
        if ((i3 == 0 || i3 == 108) && this.f3233s != null) {
            ...
            theme.resolveAttribute(p012d.a.f8680g, typedValue, true);
            if (typedValue.resourceId != 0) {
                themeNewTheme = context.getResources().newTheme();
                themeNewTheme.setTo(theme);
                themeNewTheme.applyStyle(typedValue.resourceId, true);
                themeNewTheme.resolveAttribute(p012d.a.f8681h, typedValue, true);
            } else {
                theme.resolveAttribute(p012d.a.f8681h, typedValue, true);
                themeNewTheme = null;
            }
            if (typedValue.resourceId != 0) {
    ...
    public void A() {
        if (this.f3225k instanceof Activity) {
            androidx.appcompat.app.f.G(this);
        }
        if (this.f3215a0) {
            this.f3227m.getDecorView().removeCallbacks(this.f3217c0);
        }
        ...
        if (this.f3209U != -100) {
            ...
            if ((obj instanceof Activity) && ((Activity) obj).isChangingConfigurations()) {
                f3185k0.put(this.f3225k.getClass().getName(), Integer.valueOf(this.f3209U));
            } else {
                f3185k0.remove(this.f3225k.getClass().getName());
            }
        } else {
            f3185k0.remove(this.f3225k.getClass().getName());
        }
    ...
    public void N(OnBackInvokedDispatcher onBackInvokedDispatcher) {
        ...
        OnBackInvokedDispatcher onBackInvokedDispatcher2 = this.f3223i0;
        if (onBackInvokedDispatcher2 != null && (onBackInvokedCallback = this.f3224j0) != null) {
        ...
        if (onBackInvokedDispatcher == null) {
            ...
            if (!(obj instanceof Activity) || ((Activity) obj).getWindow() == null) {
                this.f3223i0 = onBackInvokedDispatcher;
            } else {
                this.f3223i0 = k.a((Activity) this.f3225k);
            }
        } else {
            this.f3223i0 = onBackInvokedDispatcher;
        }
    ...
    public androidx.appcompat.view.b X0(androidx.appcompat.view.b.a aVar) {
    ...
    androidx.appcompat.view.b Y0(androidx.appcompat.view.b.a aVar) {
        ...
        if (bVarW != null) {
            ...
            if (this.f3237w == null) {
                if (this.f3199K) {
                    ...
                    PopupWindow popupWindow = new PopupWindow(dVar, (AttributeSet) null, p012d.a.f8683j);
                    ...
                    dVar.getTheme().resolveAttribute(p012d.a.f8675b, typedValue, true);
                    ...
                    ViewStubCompat viewStubCompat = (ViewStubCompat) this.f3191C.findViewById(p012d.f.f8792h);
            ...
            if (this.f3237w != null) {
                ...
                if (aVar.d(eVar, eVar.e())) {
                    ...
                    if (U0()) {
                        ...
                        C0247i0 c0247i0B = Z.c(this.f3237w).b(1.0f);
                        this.f3240z = c0247i0B;
                        c0247i0B.h(new e());
                    } else {
    ...
    public View f0(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (this.f3221g0 == null) {
            TypedArray typedArrayObtainStyledAttributes = this.f3226l.obtainStyledAttributes(p012d.j.f9055y0);
            String string = typedArrayObtainStyledAttributes.getString(p012d.j.f8858C0);
            typedArrayObtainStyledAttributes.recycle();
            if (string == null) {
                this.f3221g0 = new s();
            } else {
    ...
    final int f1(C0257n0 c0257n0, Rect rect) {
        int iK;
        boolean z3;
        boolean z4;
        if (c0257n0 != null) {
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (this.f3237w.isShown()) {
                ...
                if (c0257n0 == null) {
                    ...
                    rect2.set(c0257n0.i(), c0257n0.k(), c0257n0.j(), c0257n0.h());
                }
                s0.a(this.f3191C, rect2, rect3);
                int i3 = rect2.top;
                int i4 = rect2.left;
                int i5 = rect2.right;
                C0257n0 c0257n0Y = Z.y(this.f3191C);
                int i6 = c0257n0Y == null ? 0 : c0257n0Y.i();
                int iJ = c0257n0Y == null ? 0 : c0257n0Y.j();
    ...
    boolean h0(KeyEvent keyEvent) {
        View decorView;
        Object obj = this.f3225k;
        if (((obj instanceof AbstractC0269x.a) || (obj instanceof androidx.appcompat.app.r)) && (decorView = this.f3227m.getDecorView()) != null && AbstractC0269x.d(decorView, keyEvent)) {
            return true;
        }
    ...
    public Context i(Context context) {
        ...
        androidx.appcompat.view.d dVar = new androidx.appcompat.view.d(context, p012d.i.f8847c);
        dVar.a(configurationD0);
        try {
            if (context.getTheme() != null) {
                androidx.core.content.res.f.C0061f.a(dVar.getTheme());
            }
    ...
    void i0(int i3) {
        q qVarT0;
        q qVarT1 = t0(i3, true);
        if (qVarT1.f3272j != null) {
            Bundle bundle = new Bundle();
            qVarT1.f3272j.R(bundle);
            if (bundle.size() > 0) {
                qVarT1.f3281s = bundle;
            }
            qVarT1.f3272j.e0();
            qVarT1.f3272j.clear();
        }
    ...
    public void u() {
        ...
        if (layoutInflaterFrom.getFactory() == null) {
            AbstractC0270y.a(layoutInflaterFrom, this);
        } else {
