...
public class k extends AbstractC0393g {
    ...
    public void a(View view, String str, ReadableArray readableArray) {
        ...
        switch (str) {
            case "clearElementsHighlights":
                ((l) this.f7478a).clearElementsHighlights(view);
                break;
            case "highlightTraceUpdates":
                ((l) this.f7478a).highlightTraceUpdates(view, readableArray.getArray(0));
                break;
            case "highlightElements":
                ((l) this.f7478a).highlightElements(view, readableArray.getArray(0));
                break;
        }
    }
