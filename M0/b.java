...
public class b implements c {
    ...
    public O0.e f(j jVar, int i3, o oVar, I0.d dVar, ColorSpace colorSpace) {
        p005b0.a aVarA = this.f873d.a(jVar, dVar.f397h, null, i3, colorSpace);
        try {
            X0.b.a(null, aVarA);
            k.g(aVarA);
            O0.e eVarI = O0.e.I(aVarA, oVar, jVar.N(), jVar.s0());
    ...
    public O0.e g(j jVar, I0.d dVar) {
        p005b0.a aVarB = this.f873d.b(jVar, dVar.f397h, null, dVar.f400k);
        try {
            X0.b.a(null, aVarB);
            k.g(aVarB);
            O0.e eVarI = O0.e.I(aVarB, O0.n.f1480d, jVar.N(), jVar.s0());
            eVarI.A("is_rounded", false);
            return eVarI;
        } finally {
            p005b0.a.D(aVarB);
