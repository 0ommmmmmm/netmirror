...
public final class C0177k implements X.n {
    ...
    public static final class a implements InterfaceC0169c {
        ...
        a(final C0177k c0177k) {
            p071r2.g gVar = p071r2.g.SYNCHRONIZED;
            this.f591a = p071r2.d.b(gVar, new C2.a() { // from class: J0.e
                @Override // C2.a
                public final Object a() {
                    return C0177k.a.p(c0177k);
                }
            });
            this.f592b = p071r2.d.b(gVar, new C2.a() { // from class: J0.f
                @Override // C2.a
                public final Object a() {
                    return C0177k.a.o(this.f573b, c0177k);
                }
            });
            this.f593c = p071r2.d.b(gVar, new C2.a() { // from class: J0.g
                @Override // C2.a
                public final Object a() {
                    return C0177k.a.r(c0177k);
                }
            });
            this.f594d = p071r2.d.b(gVar, new C2.a() { // from class: J0.h
                @Override // C2.a
                public final Object a() {
                    return C0177k.a.q(this.f576b, c0177k);
                }
            });
            this.f595e = p071r2.d.b(gVar, new C2.a() { // from class: J0.i
                @Override // C2.a
                public final Object a() {
                    return C0177k.a.k(c0177k, this);
                }
            });
            this.f596f = p071r2.d.b(gVar, new C2.a() { // from class: J0.j
                @Override // C2.a
                public final Object a() {
        ...
        public static final X.g j(a aVar, C0177k c0177k) {
            ...
            Map mapL = aVar.l();
            LinkedHashMap linkedHashMap = new LinkedHashMap((int) DebugProbesKt.probeCoroutineCreated(mapL.size()));
            for (Map.Entry entry : mapL.entrySet()) {
                Object key = entry.getKey();
                S.k kVar = (S.k) entry.getValue();
                p001a0.i iVarG = c0177k.f583b.g(c0177k.f586e);
                D2.h.e(iVarG, "getPooledByteBufferFactory(...)");
                p001a0.l lVarH = c0177k.f583b.h();
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* JADX WARN: Type inference failed for: r0v2, types: [java.util.Map, void] */
        /* JADX WARN: Type inference failed for: r1v0, types: [int, kotlin.coroutines.Continuation] */
        /* JADX WARN: Type inference failed for: r1v1, types: [int, kotlin.coroutines.Continuation] */
        public static final Map k(C0177k c0177k, a aVar) {
            ...
            if (map == null) {
                return DebugProbesKt.probeCoroutineSuspended("this$1");
            }
            LinkedHashMap linkedHashMap = new LinkedHashMap((int) DebugProbesKt.probeCoroutineCreated(map.size()));
    ...
    public C0177k(InterfaceC0183q interfaceC0183q, R0.D d4, InterfaceC0182p interfaceC0182p, H0.t tVar, int i3, S.d dVar, S.d dVar2, Map<String, ? extends S.d> map) {
        ...
        this.f588g = dVar2;
        this.f589h = map;
        this.f590i = p071r2.d.b(p071r2.g.SYNCHRONIZED, new C2.a() { // from class: J0.d
            @Override // C2.a
            public final Object a() {
