...
public final class z {
    ...
    private final double f10150a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final double f10151b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final double f10152c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final double f10153d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private final double f10154e;
    ...
    public static final class a {
        ...
        private final i b(double d4, double d5) {
            double dAtan;
            double dAtan2;
            if (d4 < 1.0E-9d) {
            ...
            return new i(Double.valueOf(Math.rint(dAtan * 57.29577951308232d)), Double.valueOf(Math.rint(dAtan2 * 57.29577951308232d)));
        }
        ...
        public final z a(MotionEvent motionEvent) {
            ...
            i iVarB = b(axisValue, d4);
            return new z(((Number) iVarB.c()).doubleValue(), ((Number) iVarB.d()).doubleValue(), axisValue, d4, pressure);
        }
    ...
    public final ReadableMap b() {
        ...
        writableMapCreateMap.putDouble("tiltX", this.f10150a);
        writableMapCreateMap.putDouble("tiltY", this.f10151b);
        writableMapCreateMap.putDouble("altitudeAngle", this.f10152c);
        writableMapCreateMap.putDouble("azimuthAngle", this.f10153d);
        writableMapCreateMap.putDouble("pressure", this.f10154e);
    ...
    public boolean equals(Object obj) {
        ...
        z zVar = (z) obj;
        return Double.compare(this.f10150a, zVar.f10150a) == 0 && Double.compare(this.f10151b, zVar.f10151b) == 0 && Double.compare(this.f10152c, zVar.f10152c) == 0 && Double.compare(this.f10153d, zVar.f10153d) == 0 && Double.compare(this.f10154e, zVar.f10154e) == 0;
    }

    public int hashCode() {
        return (((((((Double.hashCode(this.f10150a) * 31) + Double.hashCode(this.f10151b)) * 31) + Double.hashCode(this.f10152c)) * 31) + Double.hashCode(this.f10153d)) * 31) + Double.hashCode(this.f10154e);
    }

    public String toString() {
        return "StylusData(tiltX=" + this.f10150a + ", tiltY=" + this.f10151b + ", altitudeAngle=" + this.f10152c + ", azimuthAngle=" + this.f10153d + ", pressure=" + this.f10154e + ")";
    }
