...
public final class l {
    ...
    private final l g(SSLSocket sSLSocket, boolean z3) throws CloneNotSupportedException {
        ...
        if (this.f1174d != null) {
            ...
            enabledProtocols = N2.c.B(enabledProtocols2, this.f1174d, p083u2.a.b());
        } else {
    ...
    public final List d() {
        ...
        return AbstractC0492n.e0(arrayList);
    }
    ...
    public final boolean e(SSLSocket sSLSocket) {
        ...
        if (strArr != null && !N2.c.r(strArr, sSLSocket.getEnabledProtocols(), p083u2.a.b())) {
            return false;
        }
