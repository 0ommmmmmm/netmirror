...
public final class t implements Iterable, E2.a {
    ...
    public static final class b {
        ...
        public final t h(String... strArr) throws CloneNotSupportedException {
            ...
            H2.a aVarH = H2.d.h(AbstractC0486h.p(strArr2), 2);
            int iA = aVarH.a();
            int iB = aVarH.b();
            int iC = aVarH.c();
            if (iC < 0 ? iA >= iB : iA <= iB) {
    ...
    public final a e() {
        a aVar = new a();
        AbstractC0492n.u(aVar.g(), this.f1225b);
        return aVar;
    }
    ...
    public Iterator iterator() {
        int size = size();
        p071r2.i[] iVarArr = new p071r2.i[size];
        for (int i3 = 0; i3 < size; i3++) {
            iVarArr[i3] = p071r2.n.a(b(i3), h(i3));
        }
        return D2.b.a(iVarArr);
    }
