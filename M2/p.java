...
public final class p {
    ...
    private final R2.e.a e(String str) {
        for (R2.e.a aVar : this.f1210f) {
            if (D2.h.b(aVar.d(), str)) {
                return aVar;
            }
        }
        for (R2.e.a aVar2 : this.f1209e) {
    ...
    public final void b(R2.e.a aVar) {
        R2.e.a aVarE;
        D2.h.f(aVar, "call");
        synchronized (this) {
            try {
    ...
    public final void g(R2.e.a aVar) {
        D2.h.f(aVar, "call");
    ...
    public final synchronized List j() {
        ...
        try {
            ...
            ArrayList arrayList = new ArrayList(AbstractC0492n.q(arrayDeque, 10));
            Iterator it = arrayDeque.iterator();
            while (it.hasNext()) {
                arrayList.add(((R2.e.a) it.next()).b());
            }
    ...
    public final synchronized List k() {
        ...
        try {
            ...
            ArrayList arrayList = new ArrayList(AbstractC0492n.q(arrayDeque2, 10));
            Iterator it = arrayDeque2.iterator();
            while (it.hasNext()) {
                arrayList.add(((R2.e.a) it.next()).b());
            }
            listUnmodifiableList = Collections.unmodifiableList(AbstractC0492n.W(arrayDeque, arrayList));
            D2.h.e(listUnmodifiableList, "Collections.unmodifiable…yncCalls.map { it.call })");
        } catch (Throwable th) {
            throw th;
        }
