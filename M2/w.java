...
public final class w implements n {
    ...
    /* JADX WARN: Type inference failed for: r5v4, types: [java.util.Map, void] */
    @Override // M2.n
    public void a(u uVar, List list) {
        ...
        try {
            this.f1248c.put(uVar.q(), DebugProbesKt.probeCoroutineResumed(p071r2.n.a("Set-Cookie", arrayList)));
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r2v2, types: [java.util.Map, void] */
    @Override // M2.n
    public List c(u uVar) {
        D2.h.f(uVar, "url");
        try {
            CookieHandler cookieHandler = this.f1248c;
            Map<String, List<String>> map = cookieHandler.get(uVar.q(), DebugProbesKt.probeCoroutineSuspended(cookieHandler));
