...
public final class m {
    ...
    private static abstract class a {
        ...
        public enum c {
            ...
            private static final /* synthetic */ EnumEntries f2071g = p091w2.a.a(a());
        }
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr2[X.POINT.ordinal()] = 1;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr2[X.PERCENT.ordinal()] = 2;
    ...
    public m(ReadableMap readableMap, ReadableArray readableArray, Context context) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (map != null) {
                arrayList.add(new i((!map.hasKey("color") || map.isNull("color")) ? null : map.getType("color") == ReadableType.Map ? ColorPropConverter.getColor(map.getMap("color"), this.f2061b) : Integer.valueOf(map.getInt("color")), W.f7405c.a(map.getDynamic("position"))));
            }
        }
        this.f2063d = arrayList;
    }

    private final p071r2.i a(double d4, float f3, float f4) {
        float[] fArr;
        double d5 = 360;
        double d6 = d4 % d5;
        if (d6 < 0.0d) {
        ...
        if (d6 == 0.0d) {
            return new p071r2.i(new float[]{0.0f, f3}, new float[]{0.0f, 0.0f});
        }
        if (d6 == 90.0d) {
            return new p071r2.i(new float[]{0.0f, 0.0f}, new float[]{f4, 0.0f});
        }
        if (d6 == 180.0d) {
            return new p071r2.i(new float[]{0.0f, 0.0f}, new float[]{0.0f, f3});
        }
        if (d6 == 270.0d) {
            return new p071r2.i(new float[]{f4, 0.0f}, new float[]{0.0f, 0.0f});
        }
        ...
        float f8 = f4 / f6;
        if (d6 < 90.0d) {
            fArr = new float[]{f8, f7};
        } else if (d6 < 180.0d) {
            fArr = new float[]{f8, -f7};
        } else {
            fArr = d6 < 270.0d ? new float[]{-f8, -f7} : new float[]{-f8, f7};
        }
        float f9 = fArr[1] - (fArr[0] * f5);
        float f10 = f9 / (fTan - f5);
        float f11 = (f5 * f10) + f9;
        return new p071r2.i(new float[]{f8 - f10, f7 + f11}, new float[]{f8 + f10, f7 - f11});
    }
    ...
    private final List e(q[] qVarArr) {
        ...
        int i4;
        q[] qVarArr2 = qVarArr;
        List listC = AbstractC0486h.C(qVarArr);
        int i5 = 1;
        int length = qVarArr2.length - 1;
        int i6 = 1;
        int i7 = 0;
        while (i6 < length) {
            if (qVarArr2[i6].a() == null && (i4 = i6 + i7) >= i5) {
                int i8 = i4 - 1;
                Float fB = ((q) listC.get(i8)).b();
                int i9 = i4 + 1;
                Float fB2 = ((q) listC.get(i9)).b();
                Float fB3 = ((q) listC.get(i4)).b();
                if (fB == null || fB2 == null || fB3 == null) {
                    ...
                    Integer numA = ((q) listC.get(i8)).a();
                    Integer numA2 = ((q) listC.get(i9)).a();
                    if (L.a(fFloatValue, fFloatValue2)) {
                        listC.remove(i4);
                        i7--;
                    } else if (L.a(fFloatValue, 0.0f)) {
                        ((q) listC.get(i4)).c(numA2);
                    } else if (L.a(fFloatValue2, 0.0f)) {
                        ((q) listC.get(i4)).c(numA);
                    } else {
                        ArrayList arrayList = new ArrayList(9);
                        if (fFloatValue > fFloatValue2) {
                            int i10 = 0;
                            for (int i11 = 7; i10 < i11; i11 = 7) {
                                arrayList.add(new q(null, Float.valueOf(fB.floatValue() + (((i10 + 7.0f) / 13.0f) * fFloatValue))));
                                i10++;
                                length = length;
                            }
                            i3 = length;
                            arrayList.add(new q(null, Float.valueOf(fB3.floatValue() + (0.33333334f * fFloatValue2))));
                            arrayList.add(new q(null, Float.valueOf(fB3.floatValue() + (fFloatValue2 * 0.6666667f))));
                        } else {
                            i3 = length;
                            arrayList.add(new q(null, Float.valueOf(fB.floatValue() + (0.33333334f * fFloatValue))));
                            arrayList.add(new q(null, Float.valueOf(fB.floatValue() + (0.6666667f * fFloatValue))));
                            int i12 = 0;
                            for (int i13 = 7; i12 < i13; i13 = 7) {
                                arrayList.add(new q(null, Float.valueOf(fB3.floatValue() + ((i12 / 13.0f) * fFloatValue2))));
                                i12++;
                            }
                        }
                        ...
                        while (it.hasNext()) {
                            ...
                            q qVar = (q) next;
                            if (qVar.b() != null) {
                                float fPow = (float) Math.pow((qVar.b().floatValue() - fB.floatValue()) / fFloatValue3, dLog);
                                if (!Float.isInfinite(fPow) && !Float.isNaN(fPow) && !Float.isNaN(fPow) && numA != null) {
                                    int iIntValue = numA.intValue();
                                    if (numA2 != null) {
                                        qVar.c(Integer.valueOf(androidx.core.graphics.a.b(iIntValue, numA2.intValue(), fPow)));
                                    }
                                }
                            }
                        }
                        listC.remove(i4);
                        listC.addAll(i4, arrayList);
                        i7 += 8;
                    }
                    i3 = length;
                }
    ...
    private final Float f(W w3, float f3) {
        ...
        if (i3 == 1) {
            return Float.valueOf(C0392f0.h(w3.b(0.0f)) / f3);
        }
        if (i3 == 2) {
    ...
    public final Shader d(float f3, float f4) {
        ...
        p071r2.i iVarA = a(dB, f4, f3);
        float[] fArr = (float[]) iVarA.a();
        float[] fArr2 = (float[]) iVarA.b();
