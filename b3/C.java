...
public final class C extends l {
    ...
    private final transient byte[][] f5603g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private final transient int[] f5604h;
    ...
    public byte m(int i3) {
        AbstractC0301f.b(B()[C().length - 1], i3, 1L);
        int iB = c3.e.b(this, i3);
    ...
    public boolean q(int i3, byte[] bArr, int i4, int i5) {
        ...
        while (i3 < i6) {
            ...
            int i9 = B()[C().length + iB];
            int iMin = Math.min(i6, i8 + i7) - i3;
            if (!AbstractC0301f.a(C()[iB], i9 + (i3 - i7), bArr, i4, iMin)) {
                return false;
            }
            i4 += iMin;
            i3 += iMin;
    ...
    public byte[] y() {
        ...
        while (i3 < length) {
            ...
            int i7 = B()[i3];
            int i8 = i7 - i4;
            AbstractC0486h.e(C()[i3], bArr, i5, i6, i6 + i8);
            i5 += i8;
            i3++;
            i4 = i7;
        }
