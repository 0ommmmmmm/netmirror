...
public final class z implements k {
    ...
    @Override // b3.k
    public byte[] H() {
        this.f5671b.T(this.f5673d);
        return this.f5671b.H();
    }
    ...
    public boolean J() {
        ...
        return this.f5671b.J() && this.f5673d.x(this.f5671b, (long) 8192) == -1;
    }
    ...
    public int K(w wVar) throws EOFException {
        ...
        do {
            int iD = c3.a.d(this.f5671b, wVar, true);
            if (iD != -2) {
                if (iD == -1) {
                    break;
                }
                this.f5671b.s(wVar.e()[iD].v());
                return iD;
            }
        } while (this.f5673d.x(this.f5671b, 8192) != -1);
        return -1;
    }
    ...
    public String W(long j3) throws EOFException {
        ...
        long jI = i(b4, 0L, j4);
        if (jI != -1) {
            return c3.a.c(this.f5671b, jI);
        }
        if (j4 < Long.MAX_VALUE && v(j4) && this.f5671b.a0(j4 - 1) == ((byte) 13) && v(1 + j4) && this.f5671b.a0(j4) == b4) {
            return c3.a.c(this.f5671b, j4);
        }
        i iVar = new i();
        i iVar2 = this.f5671b;
        iVar2.D(iVar, 0L, Math.min(32, iVar2.F0()));
        throw new EOFException("\\n not found: limit=" + Math.min(this.f5671b.F0(), j3) + " content=" + iVar.z0().k() + "…");
    }

    @Override // b3.k
    public short Y() throws EOFException {
        g0(2L);
        return this.f5671b.Y();
    }
    ...
    public long i(byte b4, long j3, long j4) {
        ...
        while (j3 < j4) {
            long jC0 = this.f5671b.c0(b4, j3, j4);
            if (jC0 != -1) {
                return jC0;
            }
            long jF0 = this.f5671b.F0();
            if (jF0 >= j4 || this.f5673d.x(this.f5671b, 8192) == -1) {
                return -1L;
            }
            j3 = Math.max(j3, jF0);
        }
    ...
    public String p0(Charset charset) {
        ...
        this.f5671b.T(this.f5673d);
        return this.f5671b.p0(charset);
    }

    public short q() throws EOFException {
        g0(2L);
        return this.f5671b.B0();
    }
    ...
    public byte r0() throws EOFException {
        g0(1L);
        return this.f5671b.r0();
    }

    @Override // java.nio.channels.ReadableByteChannel
    public int read(ByteBuffer byteBuffer) {
        D2.h.f(byteBuffer, "sink");
        if (this.f5671b.F0() == 0 && this.f5673d.x(this.f5671b, 8192) == -1) {
            return -1;
        }
        return this.f5671b.read(byteBuffer);
    }
    ...
    public void s(long j3) throws EOFException {
        ...
        while (j3 > 0) {
            ...
            long jMin = Math.min(j3, this.f5671b.F0());
            this.f5671b.s(jMin);
            j3 -= jMin;
        }
    }
    ...
    public boolean v(long j3) {
        ...
        while (this.f5671b.F0() < j3) {
            if (this.f5673d.x(this.f5671b, 8192) == -1) {
                return false;
            }
        }
        return true;
    ...
    public long x(i iVar, long j3) {
        ...
        return this.f5671b.x(iVar, Math.min(j3, this.f5671b.F0()));
    }
    ...
    public static final class a extends InputStream {
        ...
        public int available() throws IOException {
            ...
            return (int) Math.min(zVar.f5671b.F0(), Integer.MAX_VALUE);
        }
        ...
        public int read() throws IOException {
            ...
            if (zVar.f5671b.F0() == 0) {
                z zVar2 = z.this;
                if (zVar2.f5673d.x(zVar2.f5671b, 8192) == -1) {
                    return -1;
                }
            }
            return z.this.f5671b.r0() & 255;
        }
        ...
        public int read(byte[] bArr, int i3, int i4) throws IOException {
            ...
            if (!z.this.f5672c) {
                ...
                if (z.this.f5671b.F0() == 0) {
                    z zVar = z.this;
                    if (zVar.f5673d.x(zVar.f5671b, 8192) == -1) {
                        return -1;
                    }
                }
                return z.this.f5671b.w0(bArr, i3, i4);
            }
            throw new IOException("closed");
        }
    }
