...
public class l implements Serializable, Comparable {
    ...
    private transient int f5641b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private transient String f5642c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final byte[] f5643d;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public static final a f5640f = new a(null);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final l f5639e = new l(new byte[0]);
    ...
    public static final class a {
        ...
        public final l b(String str) {
            ...
            byte[] bArrA = AbstractC0296a.a(str);
            if (bArrA != null) {
                return new l(bArrA);
            }
            return null;
        ...
        public final l e(String str) {
            ...
            l lVar = new l(AbstractC0300e.a(str));
            lVar.s(str);
            return lVar;
        }
        ...
        public final l g(byte[] bArr, int i3, int i4) {
            ...
            return new l(AbstractC0486h.i(bArr, i3, i4 + i3));
        }
    ...
    public String a() {
        return AbstractC0296a.c(g(), null, 1, null);
    }
    ...
    */
    ...
    public boolean q(int i3, byte[] bArr, int i4, int i5) {
        D2.h.f(bArr, "other");
        return i3 >= 0 && i3 <= g().length - i5 && i4 >= 0 && i4 <= bArr.length - i5 && AbstractC0301f.a(g(), i3, bArr, i4, i5);
    }
    ...
    public String toString() {
        ...
        if (iC == -1) {
            ...
            sb.append(" hex=");
            if (64 <= g().length) {
                sb.append((64 == g().length ? this : new l(AbstractC0486h.i(g(), 0, 64))).k());
                sb.append("…]");
                return sb.toString();
            }
    ...
    public String z() {
        ...
        String strB = AbstractC0300e.b(l());
        s(strB);
        return strB;
    }
}
