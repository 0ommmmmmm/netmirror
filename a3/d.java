...
public final class d implements H, a3.g.a {

    /* JADX INFO: renamed from: A, reason: collision with root package name */
    public static final b f2875A = new b(null);

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    private static final List f2876z = AbstractC0492n.b(A.HTTP_1_1);
    ...
    public final void n(D d4, R2.c cVar) throws ProtocolException {
        ...
        String strC1 = D.c0(d4, "Upgrade", null, 2, null);
        if (!o.n("websocket", strC1, true)) {
            throw new ProtocolException("Expected 'Upgrade' header value 'websocket' but was '" + strC1 + '\'');
        }
        String strC2 = D.c0(d4, "Sec-WebSocket-Accept", null, 2, null);
        String strA = l.f5640f.e(this.f2877a + "258EAFA5-E914-47DA-95CA-C5AB0DC85B11").t().a();
        if (D2.h.b(strA, strC2)) {
            if (cVar == null) {
                throw new ProtocolException("Web Socket exchange missing: bad interceptor?");
            }
            return;
        }
        throw new ProtocolException("Expected 'Sec-WebSocket-Accept' header value '" + strA + "' but was '" + strC2 + '\'');
    }
    ...
    public final boolean x() throws Throwable {
        ...
        synchronized (this) {
            try {
                ...
                a3.h hVar2 = this.f2881e;
                Object objPoll2 = this.f2885i.poll();
                l lVar = (l) objPoll2;
                if (lVar == null) {
                    objPoll = this.f2886j.poll();
                    rVar4.f189b = objPoll;
                    if (objPoll instanceof a) {
                        int i3 = this.f2889m;
                        pVar.f187b = i3;
                        rVar5.f189b = this.f2890n;
                        if (i3 != -1) {
                            r3 = objPoll2;
                            rVar6.f189b = this.f2884h;
                            this.f2884h = null;
                            rVar7.f189b = this.f2880d;
                            this.f2880d = null;
                            rVar8.f189b = this.f2881e;
                            this.f2881e = null;
                            this.f2882f.n();
                            r3 = i3;
                            r3 = objPoll2;
                            ...
                            r3 = objPoll2;
                            long jA = ((a) obj).a();
                            Q2.d dVar = this.f2882f;
                            String str = this.f2883g + " cancel";
                            r4 = 1;
                            rVar = rVar8;
                            rVar2 = rVar7;
                            dVar.i(new h(str, true, str, true, this, hVar2, lVar, rVar4, pVar, rVar5, rVar6, rVar2, rVar), TimeUnit.MILLISECONDS.toNanos(jA));
                        }
                    } else {
                        rVar = rVar8;
                        rVar2 = rVar7;
                ...
                r3 = objPoll2;
                r4 = objPoll;
                p071r2.r rVar9 = p071r2.r.f10603a;
                try {
                    if (lVar == 0) {
                        a3.h hVar3 = hVar2;
                        Object obj2 = rVar4.f189b;
                        if (obj2 instanceof c) {
                            ...
                            c cVar = (c) obj2;
                            D2.h.c(hVar3);
                            hVar3.o(cVar.b(), cVar.a());
                            synchronized (this) {
                                this.f2887k -= (long) cVar.a().v();
                            }
                            AbstractC0048d abstractC0048d2 = (AbstractC0048d) r7.f189b;
                            if (abstractC0048d2 != null) {
                                N2.c.j(abstractC0048d2);
                            }
                            a3.g gVar2 = (a3.g) r6.f189b;
                            if (gVar2 != null) {
                                N2.c.j(gVar2);
                            }
                            a3.h hVar4 = (a3.h) r5.f189b;
                            if (hVar4 != null) {
                                N2.c.j(hVar4);
                            }
                            throw th;
                        ...
                        try {
                            ...
                            a aVar = (a) obj2;
                            D2.h.c(hVar3);
                            hVar3.a(aVar.b(), aVar.c());
                            r rVar10 = rVar6;
                            try {
                                AbstractC0048d abstractC0048d3 = (AbstractC0048d) rVar10.f189b;
                                rVar3 = rVar10;
                                if (abstractC0048d3 != null) {
                                    I i4 = this.f2897u;
                                    int i5 = pVar.f187b;
                                    String str2 = (String) rVar5.f189b;
                                    D2.h.c(str2);
                                    i4.a(this, i5, str2);
                                    rVar3 = rVar10;
                                }
                        ...
                        abstractC0048d = (AbstractC0048d) rVar3.f189b;
                        if (abstractC0048d != null) {
                            N2.c.j(abstractC0048d);
                        }
                        gVar = (a3.g) rVar2.f189b;
                        if (gVar != null) {
                            N2.c.j(gVar);
                        }
                        hVar = (a3.h) rVar.f189b;
                        if (hVar != null) {
                            return true;
                        }
                        N2.c.j(hVar);
