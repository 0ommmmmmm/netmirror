...
public class a {
    ...
    String b() throws IllegalAccessException, InvocationTargetException {
        Object objInvoke = Class.forName("com.google.android.gms.iid.InstanceID").getDeclaredMethod("getInstance", Context.class).invoke(null, this.f9486a.getApplicationContext());
        return (String) objInvoke.getClass().getMethod("getId", new Class[0]).invoke(objInvoke, new Object[0]);
    }

    String c() {
        return RNDeviceModule.getRNDISharedPreferences(this.f9486a).getString("instanceId", "unknown");
    }
    ...
    void f(String str) {
        SharedPreferences.Editor editorEdit = RNDeviceModule.getRNDISharedPreferences(this.f9486a).edit();
