...
final class d implements InputFilter {
    ...
    private androidx.emoji2.text.f.AbstractC0072f f11b;

    private static class a extends androidx.emoji2.text.f.AbstractC0072f {
    ...
    private androidx.emoji2.text.f.AbstractC0072f a() {
        if (this.f11b == null) {
