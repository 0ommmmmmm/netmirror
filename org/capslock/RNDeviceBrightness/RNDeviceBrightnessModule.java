...
public class RNDeviceBrightnessModule extends ReactContextBaseJavaModule {
    ...
    class a implements Runnable {
        ...
        public void run() {
            WindowManager.LayoutParams attributes = this.f10210b.getWindow().getAttributes();
            attributes.screenBrightness = this.f10211c;
            this.f10210b.getWindow().setAttributes(attributes);
        }
    }
